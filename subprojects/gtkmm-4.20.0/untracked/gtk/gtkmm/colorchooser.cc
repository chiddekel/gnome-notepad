...
extern "C" {
static void ColorChooser_signal_color_activated_connect_callback(GtkColorChooser* self, const GdkRGBA* p0,void* data)
{
  using namespace Gtk;
...
{
  "color-activated",
  (GCallback) &ColorChooser_signal_color_activated_connect_callback,
  (GCallback) &ColorChooser_signal_color_activated_connect_callback
};


using ColorChooser_signal_color_activated_functype = void (*)(GtkColorChooser* self, const GdkRGBA* p0);
ColorChooser_signal_color_activated_functype ColorChooser_signal_color_activated_funcptr;
extern "C" {
static void ColorChooser_signal_color_activated_default_callback(GtkColorChooser* self, const GdkRGBA* p0)
{
  ColorChooser_signal_color_activated_funcptr( self, p0);
}
} // extern "C"
} // anonymous namespace
...
void ColorChooser_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->color_activated = &ColorChooser_signal_color_activated_default_callback;
  ColorChooser_signal_color_activated_funcptr = &color_activated_callback;
}
