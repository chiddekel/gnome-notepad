...
extern "C" {
static void GestureDrag_signal_drag_begin_connect_callback(GtkGestureDrag* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "drag-begin",
  (GCallback) &GestureDrag_signal_drag_begin_connect_callback,
  (GCallback) &GestureDrag_signal_drag_begin_connect_callback
};


extern "C" {
static void GestureDrag_signal_drag_update_connect_callback(GtkGestureDrag* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(double, double)>;
...
{
  "drag-update",
  (GCallback) &GestureDrag_signal_drag_update_connect_callback,
  (GCallback) &GestureDrag_signal_drag_update_connect_callback
};


extern "C" {
static void GestureDrag_signal_drag_end_connect_callback(GtkGestureDrag* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(double, double)>;
...
{
  "drag-end",
  (GCallback) &GestureDrag_signal_drag_end_connect_callback,
  (GCallback) &GestureDrag_signal_drag_end_connect_callback
};
