...
extern "C" {
static GdkContentProvider* DragSource_signal_prepare_connect_callback(GtkDragSource* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "prepare",
  (GCallback) &DragSource_signal_prepare_connect_callback,
  (GCallback) &DragSource_signal_prepare_notify_callback
};


extern "C" {
static void DragSource_signal_drag_begin_connect_callback(GtkDragSource* self, GdkDrag* p0,void* data)
{
  using namespace Gtk;
...
{
  "drag-begin",
  (GCallback) &DragSource_signal_drag_begin_connect_callback,
  (GCallback) &DragSource_signal_drag_begin_connect_callback
};


extern "C" {
static void DragSource_signal_drag_end_connect_callback(GtkDragSource* self, GdkDrag* p0,gboolean p1,void* data)
{
  using namespace Gtk;
...
{
  "drag-end",
  (GCallback) &DragSource_signal_drag_end_connect_callback,
  (GCallback) &DragSource_signal_drag_end_connect_callback
};


extern "C" {
static gboolean DragSource_signal_drag_cancel_connect_callback(GtkDragSource* self, GdkDrag* p0,GdkDragCancelReason p1,void* data)
{
  using namespace Gtk;
...
{
  "drag-cancel",
  (GCallback) &DragSource_signal_drag_cancel_connect_callback,
