...
void CenterLayout::set_shrink_center_last(bool shrink_center_last)
{
  gtk_center_layout_set_shrink_center_last(gobj(), static_cast<int>(shrink_center_last));
}

bool CenterLayout::get_shrink_center_last() const
{
  return gtk_center_layout_get_shrink_center_last(const_cast<GtkCenterLayout*>(gobj()));
}


Glib::PropertyProxy< bool > CenterLayout::property_shrink_center_last() 
{
  return Glib::PropertyProxy< bool >(this, "shrink-center-last");
}

Glib::PropertyProxy_ReadOnly< bool > CenterLayout::property_shrink_center_last() const
{
