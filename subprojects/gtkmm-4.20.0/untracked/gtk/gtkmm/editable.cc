...
extern "C" {
static void Editable_signal_insert_text_connect_callback(GtkEditable* self, const char* text,int length,int* position,void* data)
{
  using namespace Gtk;
...
{
  "insert_text",
  (GCallback) &Editable_signal_insert_text_connect_callback,
  (GCallback) &Editable_signal_insert_text_connect_callback
};


using Editable_signal_insert_text_functype = void (*)(GtkEditable* self, const char* text, int length, int* position);
Editable_signal_insert_text_functype Editable_signal_insert_text_funcptr;
extern "C" {
static void Editable_signal_insert_text_default_callback(GtkEditable* self, const char* text, int length, int* position)
{
  Editable_signal_insert_text_funcptr(    self, text, length, position);
}
} // extern "C"


extern "C" {
static void Editable_signal_delete_text_connect_callback(GtkEditable* self, gint p0,gint p1,void* data)
{
  using namespace Gtk;
...
{
  "delete_text",
  (GCallback) &Editable_signal_delete_text_connect_callback,
  (GCallback) &Editable_signal_delete_text_connect_callback
};


using Editable_signal_delete_text_functype = void (*)(GtkEditable* self, gint p0, gint p1);
Editable_signal_delete_text_functype Editable_signal_delete_text_funcptr;
extern "C" {
static void Editable_signal_delete_text_default_callback(GtkEditable* self, gint p0, gint p1)
{
  Editable_signal_delete_text_funcptr( self, p0, p1);
}
} // extern "C"
...
using Editable_signal_changed_functype = void (*)(GtkEditable* self);
Editable_signal_changed_functype Editable_signal_changed_funcptr;
extern "C" {
static void Editable_signal_changed_default_callback(GtkEditable* self)
{
  Editable_signal_changed_funcptr( self);
}
} // extern "C"
using Editable_do_insert_text_vfunc_functype = void (*)(GtkEditable* self, const char* text, int length, int* position);
Editable_do_insert_text_vfunc_functype Editable_do_insert_text_vfunc_funcptr;
extern "C" {
static void Editable_do_insert_text_vfunc_c_callback(GtkEditable* self, const char* text, int length, int* position)
{
  Editable_do_insert_text_vfunc_funcptr(    self, text, length, position);
}
} // extern "C"
using Editable_do_delete_text_vfunc_functype = void (*)(GtkEditable* self, int start_pos, int end_pos);
Editable_do_delete_text_vfunc_functype Editable_do_delete_text_vfunc_funcptr;
extern "C" {
static void Editable_do_delete_text_vfunc_c_callback(GtkEditable* self, int start_pos, int end_pos)
{
  Editable_do_delete_text_vfunc_funcptr( self, start_pos, end_pos);
}
} // extern "C"
using Editable_get_text_vfunc_functype = const char* (*)(GtkEditable* self);
Editable_get_text_vfunc_functype Editable_get_text_vfunc_funcptr;
extern "C" {
static const char* Editable_get_text_vfunc_c_callback(GtkEditable* self)
{
  return Editable_get_text_vfunc_funcptr( self);
}
} // extern "C"
using Editable_set_selection_bounds_vfunc_functype = void (*)(GtkEditable* self, int start_pos, int end_pos);
Editable_set_selection_bounds_vfunc_functype Editable_set_selection_bounds_vfunc_funcptr;
extern "C" {
static void Editable_set_selection_bounds_vfunc_c_callback(GtkEditable* self, int start_pos, int end_pos)
{
  Editable_set_selection_bounds_vfunc_funcptr( self, start_pos, end_pos);
}
} // extern "C"
using Editable_get_selection_bounds_vfunc_functype = gboolean (*)(GtkEditable* self, int* start_pos, int* end_pos);
Editable_get_selection_bounds_vfunc_functype Editable_get_selection_bounds_vfunc_funcptr;
extern "C" {
static gboolean Editable_get_selection_bounds_vfunc_c_callback(GtkEditable* self, int* start_pos, int* end_pos)
{
  return Editable_get_selection_bounds_vfunc_funcptr( self, start_pos, end_pos);
}
} // extern "C"
} // anonymous namespace
...
void Editable_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->do_insert_text = &Editable_do_insert_text_vfunc_c_callback;
  Editable_do_insert_text_vfunc_funcptr = &do_insert_text_vfunc_callback;
  klass->do_delete_text = &Editable_do_delete_text_vfunc_c_callback;
  Editable_do_delete_text_vfunc_funcptr = &do_delete_text_vfunc_callback;
  klass->get_text = &Editable_get_text_vfunc_c_callback;
  Editable_get_text_vfunc_funcptr = &get_text_vfunc_callback;
  klass->set_selection_bounds = &Editable_set_selection_bounds_vfunc_c_callback;
  Editable_set_selection_bounds_vfunc_funcptr = &set_selection_bounds_vfunc_callback;
  klass->get_selection_bounds = &Editable_get_selection_bounds_vfunc_c_callback;
  Editable_get_selection_bounds_vfunc_funcptr = &get_selection_bounds_vfunc_callback;

  klass->insert_text = &Editable_signal_insert_text_default_callback;
  Editable_signal_insert_text_funcptr = &insert_text_callback;
  klass->delete_text = &Editable_signal_delete_text_default_callback;
  Editable_signal_delete_text_funcptr = &delete_text_callback;
  klass->changed = &Editable_signal_changed_default_callback;
  Editable_signal_changed_funcptr = &changed_callback;
}
