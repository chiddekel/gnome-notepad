...
GraphicsOffloadEnabled Video::get_graphics_offload() const
{
  return static_cast<GraphicsOffloadEnabled>(gtk_video_get_graphics_offload(const_cast<GtkVideo*>(gobj())));
}

void Video::set_graphics_offload(GraphicsOffloadEnabled enabled)
{
  gtk_video_set_graphics_offload(gobj(), static_cast<GtkGraphicsOffloadEnabled>(enabled));
}
...
Glib::PropertyProxy< GraphicsOffloadEnabled > Video::property_graphics_offload() 
{
  return Glib::PropertyProxy< GraphicsOffloadEnabled >(this, "graphics-offload");
}

Glib::PropertyProxy_ReadOnly< GraphicsOffloadEnabled > Video::property_graphics_offload() const
{
  return Glib::PropertyProxy_ReadOnly< GraphicsOffloadEnabled >(this, "graphics-offload");
}
