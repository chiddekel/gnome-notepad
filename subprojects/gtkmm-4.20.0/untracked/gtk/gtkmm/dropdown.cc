...
static const Glib::SignalProxyInfo DropDown_signal_activate_info =
{
  "activate",
...
void DropDown::set_header_factory(const Glib::RefPtr<ListItemFactory>& factory)
{
  gtk_drop_down_set_header_factory(gobj(), Glib::unwrap(factory));
}

Glib::RefPtr<ListItemFactory> DropDown::get_header_factory()
{
  auto retvalue = Glib::wrap(gtk_drop_down_get_header_factory(gobj()));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}

Glib::RefPtr<const ListItemFactory> DropDown::get_header_factory() const
{
  return const_cast<DropDown*>(this)->get_header_factory();
}
...
void DropDown::set_search_match_mode(StringFilter::MatchMode search_match_mode)
{
  gtk_drop_down_set_search_match_mode(gobj(), static_cast<GtkStringFilterMatchMode>(search_match_mode));
}

StringFilter::MatchMode DropDown::get_search_match_mode() const
{
  return static_cast<StringFilter::MatchMode>(gtk_drop_down_get_search_match_mode(const_cast<GtkDropDown*>(gobj())));
}


Glib::SignalProxy<void()> DropDown::signal_activate()
{
  return Glib::SignalProxy<void() >(this, &DropDown_signal_activate_info);
}
...
Glib::PropertyProxy< Glib::RefPtr<ListItemFactory> > DropDown::property_header_factory() 
{
  return Glib::PropertyProxy< Glib::RefPtr<ListItemFactory> >(this, "header-factory");
}

Glib::PropertyProxy_ReadOnly< Glib::RefPtr<ListItemFactory> > DropDown::property_header_factory() const
{
...
static_assert(Glib::Traits::ValueCompatibleWithWrapProperty<StringFilter::MatchMode>::value,
  "Type StringFilter::MatchMode cannot be used in _WRAP_PROPERTY. "
  "There is no suitable template specialization of Glib::Value<>.");

Glib::PropertyProxy< StringFilter::MatchMode > DropDown::property_search_match_mode() 
{
  return Glib::PropertyProxy< StringFilter::MatchMode >(this, "search-match-mode");
}

Glib::PropertyProxy_ReadOnly< StringFilter::MatchMode > DropDown::property_search_match_mode() const
{
  return Glib::PropertyProxy_ReadOnly< StringFilter::MatchMode >(this, "search-match-mode");
}
