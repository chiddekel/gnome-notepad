...
extern "C" {
static void Gesture_signal_begin_connect_callback(GtkGesture* self, GdkEventSequence* p0,void* data)
{
  using namespace Gtk;
...
{
  "begin",
  (GCallback) &Gesture_signal_begin_connect_callback,
  (GCallback) &Gesture_signal_begin_connect_callback
};


extern "C" {
static void Gesture_signal_end_connect_callback(GtkGesture* self, GdkEventSequence* p0,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(Gdk::EventSequence*)>;
...
{
  "end",
  (GCallback) &Gesture_signal_end_connect_callback,
  (GCallback) &Gesture_signal_end_connect_callback
};


extern "C" {
static void Gesture_signal_update_connect_callback(GtkGesture* self, GdkEventSequence* p0,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(Gdk::EventSequence*)>;
...
{
  "update",
  (GCallback) &Gesture_signal_update_connect_callback,
  (GCallback) &Gesture_signal_update_connect_callback
};


extern "C" {
static void Gesture_signal_cancel_connect_callback(GtkGesture* self, GdkEventSequence* p0,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(Gdk::EventSequence*)>;
...
{
  "cancel",
  (GCallback) &Gesture_signal_cancel_connect_callback,
  (GCallback) &Gesture_signal_cancel_connect_callback
};


extern "C" {
static void Gesture_signal_sequence_state_changed_connect_callback(GtkGesture* self, GdkEventSequence* p0,GtkEventSequenceState p1,void* data)
{
  using namespace Gtk;
...
static const Glib::SignalProxyInfo Gesture_signal_sequence_state_changed_info =
{
  ...
  (GCallback) &Gesture_signal_sequence_state_changed_connect_callback,
  (GCallback) &Gesture_signal_sequence_state_changed_connect_callback
};
