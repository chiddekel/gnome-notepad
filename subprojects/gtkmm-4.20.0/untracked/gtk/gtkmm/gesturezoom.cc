...
extern "C" {
static void GestureZoom_signal_scale_changed_connect_callback(GtkGestureZoom* self, gdouble p0,void* data)
{
  using namespace Gtk;
...
{
  "scale-changed",
  (GCallback) &GestureZoom_signal_scale_changed_connect_callback,
  (GCallback) &GestureZoom_signal_scale_changed_connect_callback
};
