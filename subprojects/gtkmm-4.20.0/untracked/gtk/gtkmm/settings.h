...
/** Whether to play any event sounds at all.
   ...
   * 
   * Deprecated: 4.20: Use `Gtk::CssProvider` properties instead
   *
   * Default value: <tt>false</tt>
   *
   * @return A PropertyProxy that allows you to get or set the value of the property,
...
/** How GTK font rendering is set up.
   ...
   * styles can be set with the Gtk::CssProvider::property_prefers_color_scheme()
   * property.
   * 
   * @newin{4,20}
   *
   * Default value: Gtk::InterfaceColorScheme::UNSUPPORTED
   *
   * @return A PropertyProxy that allows you to get or set the value of the property,
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< InterfaceColorScheme > property_gtk_interface_color_scheme() ;
...
/** The color scheme used for rendering the user interface.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< InterfaceColorScheme > property_gtk_interface_color_scheme() const;

  /** The level of contrast to use for the user interface.
   * 
   * This setting communicates the system-wide preference.
   * The contrast level that is actually used when applying CSS
   * styles can be set with the Gtk::CssProvider::property_prefers_contrast()
   * property.
   * 
   * @newin{4,20}
   *
   * Default value: Gtk::InterfaceContrast::UNSUPPORTED
   *
   * @return A PropertyProxy that allows you to get or set the value of the property,
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< InterfaceContrast > property_gtk_interface_contrast() ;
...
/** The level of contrast to use for the user interface.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< InterfaceContrast > property_gtk_interface_contrast() const;
