...
extern "C" {
static void CellArea_signal_apply_attributes_connect_callback(GtkCellArea* self, GtkTreeModel* p0,GtkTreeIter* p1,gboolean p2,gboolean p3,void* data)
{
  using namespace Gtk;
...
{
  "apply-attributes",
  (GCallback) &CellArea_signal_apply_attributes_connect_callback,
  (GCallback) &CellArea_signal_apply_attributes_connect_callback
};


using CellArea_signal_apply_attributes_functype = void (*)(GtkCellArea* self, GtkTreeModel* p0, GtkTreeIter* p1, gboolean p2, gboolean p3);
CellArea_signal_apply_attributes_functype CellArea_signal_apply_attributes_funcptr;
extern "C" {
static void CellArea_signal_apply_attributes_default_callback(GtkCellArea* self, GtkTreeModel* p0, GtkTreeIter* p1, gboolean p2, gboolean p3)
{
  CellArea_signal_apply_attributes_funcptr( self, p0, p1, p2, p3);
}
} // extern "C"


extern "C" {
static void CellArea_signal_add_editable_connect_callback(GtkCellArea* self, GtkCellRenderer* p0,GtkCellEditable* p1,GdkRectangle* p2,const gchar* p3,void* data)
{
  using namespace Gtk;
...
{
  "add-editable",
  (GCallback) &CellArea_signal_add_editable_connect_callback,
  (GCallback) &CellArea_signal_add_editable_connect_callback
};


extern "C" {
static void CellArea_signal_remove_editable_connect_callback(GtkCellArea* self, GtkCellRenderer* p0,GtkCellEditable* p1,void* data)
{
  using namespace Gtk;
...
{
  "remove-editable",
  (GCallback) &CellArea_signal_remove_editable_connect_callback,
  (GCallback) &CellArea_signal_remove_editable_connect_callback
};


extern "C" {
static void CellArea_signal_focus_changed_connect_callback(GtkCellArea* self, GtkCellRenderer* p0,const gchar* p1,void* data)
{
  using namespace Gtk;
...
{
  "focus-changed",
  (GCallback) &CellArea_signal_focus_changed_connect_callback,
  (GCallback) &CellArea_signal_focus_changed_connect_callback
};


using CellArea_snapshot_vfunc_functype = void (*)(GtkCellArea* self, GtkCellAreaContext* context, GtkWidget* widget, GtkSnapshot* snapshot, const GdkRectangle* background_area, const GdkRectangle* cell_area, GtkCellRendererState flags, gboolean paint_focus);
CellArea_snapshot_vfunc_functype CellArea_snapshot_vfunc_funcptr;
extern "C" {
static void CellArea_snapshot_vfunc_c_callback(GtkCellArea* self, GtkCellAreaContext* context, GtkWidget* widget, GtkSnapshot* snapshot, const GdkRectangle* background_area, const GdkRectangle* cell_area, GtkCellRendererState flags, gboolean paint_focus)
{
  CellArea_snapshot_vfunc_funcptr( self, context, widget, snapshot, background_area, cell_area, flags, paint_focus);
}
} // extern "C"
using CellArea_get_request_mode_vfunc_functype = GtkSizeRequestMode (*)(GtkCellArea* self);
CellArea_get_request_mode_vfunc_functype CellArea_get_request_mode_vfunc_funcptr;
extern "C" {
static GtkSizeRequestMode CellArea_get_request_mode_vfunc_c_callback(GtkCellArea* self)
{
  return CellArea_get_request_mode_vfunc_funcptr( self);
}
} // extern "C"
using CellArea_get_preferred_width_vfunc_functype = void (*)(GtkCellArea* self, GtkCellAreaContext* context, GtkWidget* widget, gint* minimum_width, gint* natural_width);
CellArea_get_preferred_width_vfunc_functype CellArea_get_preferred_width_vfunc_funcptr;
extern "C" {
static void CellArea_get_preferred_width_vfunc_c_callback(GtkCellArea* self, GtkCellAreaContext* context, GtkWidget* widget, gint* minimum_width, gint* natural_width)
{
  CellArea_get_preferred_width_vfunc_funcptr( self, context, widget, minimum_width, natural_width);
}
} // extern "C"
using CellArea_get_preferred_height_for_width_vfunc_functype = void (*)(GtkCellArea* self, GtkCellAreaContext* context, GtkWidget* widget, gint width, gint* minimum_height, gint* natural_height);
CellArea_get_preferred_height_for_width_vfunc_functype CellArea_get_preferred_height_for_width_vfunc_funcptr;
extern "C" {
static void CellArea_get_preferred_height_for_width_vfunc_c_callback(GtkCellArea* self, GtkCellAreaContext* context, GtkWidget* widget, gint width, gint* minimum_height, gint* natural_height)
{
  CellArea_get_preferred_height_for_width_vfunc_funcptr( self, context, widget, width, minimum_height, natural_height);
}
} // extern "C"
using CellArea_get_preferred_height_vfunc_functype = void (*)(GtkCellArea* self, GtkCellAreaContext* context, GtkWidget* widget, gint* minimum_height, gint* natural_height);
CellArea_get_preferred_height_vfunc_functype CellArea_get_preferred_height_vfunc_funcptr;
extern "C" {
static void CellArea_get_preferred_height_vfunc_c_callback(GtkCellArea* self, GtkCellAreaContext* context, GtkWidget* widget, gint* minimum_height, gint* natural_height)
{
  CellArea_get_preferred_height_vfunc_funcptr( self, context, widget, minimum_height, natural_height);
}
} // extern "C"
using CellArea_get_preferred_width_for_height_vfunc_functype = void (*)(GtkCellArea* self, GtkCellAreaContext* context, GtkWidget* widget, gint height, gint* minimum_width, gint* natural_width);
CellArea_get_preferred_width_for_height_vfunc_functype CellArea_get_preferred_width_for_height_vfunc_funcptr;
extern "C" {
static void CellArea_get_preferred_width_for_height_vfunc_c_callback(GtkCellArea* self, GtkCellAreaContext* context, GtkWidget* widget, gint height, gint* minimum_width, gint* natural_width)
{
  CellArea_get_preferred_width_for_height_vfunc_funcptr( self, context, widget, height, minimum_width, natural_width);
}
} // extern "C"
} // anonymous namespace
...
void CellArea_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->snapshot = &CellArea_snapshot_vfunc_c_callback;
  CellArea_snapshot_vfunc_funcptr = &snapshot_vfunc_callback;
  klass->get_request_mode = &CellArea_get_request_mode_vfunc_c_callback;
  CellArea_get_request_mode_vfunc_funcptr = &get_request_mode_vfunc_callback;
  klass->get_preferred_width = &CellArea_get_preferred_width_vfunc_c_callback;
  CellArea_get_preferred_width_vfunc_funcptr = &get_preferred_width_vfunc_callback;
  klass->get_preferred_height_for_width = &CellArea_get_preferred_height_for_width_vfunc_c_callback;
  CellArea_get_preferred_height_for_width_vfunc_funcptr = &get_preferred_height_for_width_vfunc_callback;
  klass->get_preferred_height = &CellArea_get_preferred_height_vfunc_c_callback;
  CellArea_get_preferred_height_vfunc_funcptr = &get_preferred_height_vfunc_callback;
  klass->get_preferred_width_for_height = &CellArea_get_preferred_width_for_height_vfunc_c_callback;
  CellArea_get_preferred_width_for_height_vfunc_funcptr = &get_preferred_width_for_height_vfunc_callback;

  klass->apply_attributes = &CellArea_signal_apply_attributes_default_callback;
  CellArea_signal_apply_attributes_funcptr = &apply_attributes_callback;
}
