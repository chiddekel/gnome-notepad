...
void SortListModel::set_section_sorter(const Glib::RefPtr<Sorter>& sorter)
{
  gtk_sort_list_model_set_section_sorter(gobj(), Glib::unwrap(sorter));
}

Glib::RefPtr<Sorter> SortListModel::get_section_sorter()
{
  auto retvalue = Glib::wrap(gtk_sort_list_model_get_section_sorter(gobj()));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}

Glib::RefPtr<const Sorter> SortListModel::get_section_sorter() const
{
  return const_cast<SortListModel*>(this)->get_section_sorter();
}
...
Glib::PropertyProxy< Glib::RefPtr<Sorter> > SortListModel::property_section_sorter() 
{
  return Glib::PropertyProxy< Glib::RefPtr<Sorter> >(this, "section-sorter");
}

Glib::PropertyProxy_ReadOnly< Glib::RefPtr<Sorter> > SortListModel::property_section_sorter() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::RefPtr<Sorter> >(this, "section-sorter");
}
