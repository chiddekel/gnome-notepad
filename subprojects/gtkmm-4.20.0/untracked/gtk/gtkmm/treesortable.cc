...
using TreeSortable_signal_sort_column_changed_functype = void (*)(GtkTreeSortable* self);
TreeSortable_signal_sort_column_changed_functype TreeSortable_signal_sort_column_changed_funcptr;
extern "C" {
static void TreeSortable_signal_sort_column_changed_default_callback(GtkTreeSortable* self)
{
  TreeSortable_signal_sort_column_changed_funcptr( self);
}
} // extern "C"
using TreeSortable_get_sort_column_id_vfunc_functype = gboolean (*)(GtkTreeSortable* self, int* sort_column_id, GtkSortType* order);
TreeSortable_get_sort_column_id_vfunc_functype TreeSortable_get_sort_column_id_vfunc_funcptr;
extern "C" {
static gboolean TreeSortable_get_sort_column_id_vfunc_c_callback(GtkTreeSortable* self, int* sort_column_id, GtkSortType* order)
{
  return TreeSortable_get_sort_column_id_vfunc_funcptr( self, sort_column_id, order);
}
} // extern "C"
using TreeSortable_set_sort_column_id_vfunc_functype = void (*)(GtkTreeSortable* self, int sort_column_id, GtkSortType order);
TreeSortable_set_sort_column_id_vfunc_functype TreeSortable_set_sort_column_id_vfunc_funcptr;
extern "C" {
static void TreeSortable_set_sort_column_id_vfunc_c_callback(GtkTreeSortable* self, int sort_column_id, GtkSortType order)
{
  TreeSortable_set_sort_column_id_vfunc_funcptr( self, sort_column_id, order);
}
} // extern "C"
using TreeSortable_set_sort_func_vfunc_functype = void (*)(GtkTreeSortable* self, int sort_column_id, GtkTreeIterCompareFunc func, gpointer data, GDestroyNotify destroy);
TreeSortable_set_sort_func_vfunc_functype TreeSortable_set_sort_func_vfunc_funcptr;
extern "C" {
static void TreeSortable_set_sort_func_vfunc_c_callback(GtkTreeSortable* self, int sort_column_id, GtkTreeIterCompareFunc func, gpointer data, GDestroyNotify destroy)
{
  TreeSortable_set_sort_func_vfunc_funcptr( self, sort_column_id, func, data, destroy);
}
} // extern "C"
using TreeSortable_set_default_sort_func_vfunc_functype = void (*)(GtkTreeSortable* self, GtkTreeIterCompareFunc func, gpointer data, GDestroyNotify destroy);
TreeSortable_set_default_sort_func_vfunc_functype TreeSortable_set_default_sort_func_vfunc_funcptr;
extern "C" {
static void TreeSortable_set_default_sort_func_vfunc_c_callback(GtkTreeSortable* self, GtkTreeIterCompareFunc func, gpointer data, GDestroyNotify destroy)
{
  TreeSortable_set_default_sort_func_vfunc_funcptr( self, func, data, destroy);
}
} // extern "C"
using TreeSortable_has_default_sort_func_vfunc_functype = gboolean (*)(GtkTreeSortable* self);
TreeSortable_has_default_sort_func_vfunc_functype TreeSortable_has_default_sort_func_vfunc_funcptr;
extern "C" {
static gboolean TreeSortable_has_default_sort_func_vfunc_c_callback(GtkTreeSortable* self)
{
  return TreeSortable_has_default_sort_func_vfunc_funcptr( self);
}
} // extern "C"
using TreeSortable_sort_column_changed_vfunc_functype = void (*)(GtkTreeSortable* self);
TreeSortable_sort_column_changed_vfunc_functype TreeSortable_sort_column_changed_vfunc_funcptr;
extern "C" {
static void TreeSortable_sort_column_changed_vfunc_c_callback(GtkTreeSortable* self)
{
  TreeSortable_sort_column_changed_vfunc_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void TreeSortable_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->get_sort_column_id = &TreeSortable_get_sort_column_id_vfunc_c_callback;
  TreeSortable_get_sort_column_id_vfunc_funcptr = &get_sort_column_id_vfunc_callback;
  klass->set_sort_column_id = &TreeSortable_set_sort_column_id_vfunc_c_callback;
  TreeSortable_set_sort_column_id_vfunc_funcptr = &set_sort_column_id_vfunc_callback;
  klass->set_sort_func = &TreeSortable_set_sort_func_vfunc_c_callback;
  TreeSortable_set_sort_func_vfunc_funcptr = &set_sort_func_vfunc_callback;
  klass->set_default_sort_func = &TreeSortable_set_default_sort_func_vfunc_c_callback;
  TreeSortable_set_default_sort_func_vfunc_funcptr = &set_default_sort_func_vfunc_callback;
  klass->has_default_sort_func = &TreeSortable_has_default_sort_func_vfunc_c_callback;
  TreeSortable_has_default_sort_func_vfunc_funcptr = &has_default_sort_func_vfunc_callback;
  klass->sort_column_changed = &TreeSortable_sort_column_changed_vfunc_c_callback;
  TreeSortable_sort_column_changed_vfunc_funcptr = &sort_column_changed_vfunc_callback;

  klass->sort_column_changed = &TreeSortable_signal_sort_column_changed_default_callback;
  TreeSortable_signal_sort_column_changed_funcptr = &sort_column_changed_callback;
}
