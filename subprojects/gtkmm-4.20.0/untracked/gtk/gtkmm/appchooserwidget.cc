...
extern "C" {
static void AppChooserWidget_signal_application_selected_connect_callback(GtkAppChooserWidget* self, GAppInfo* p0,void* data)
{
  using namespace Gtk;
...
static const Glib::SignalProxyInfo AppChooserWidget_signal_application_selected_info =
{
  ...
  (GCallback) &AppChooserWidget_signal_application_selected_connect_callback,
  (GCallback) &AppChooserWidget_signal_application_selected_connect_callback
};


extern "C" {
static void AppChooserWidget_signal_application_activated_connect_callback(GtkAppChooserWidget* self, GAppInfo* p0,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(const Glib::RefPtr<Gio::AppInfo>&)>;
...
static const Glib::SignalProxyInfo AppChooserWidget_signal_application_activated_info =
{
  ...
  (GCallback) &AppChooserWidget_signal_application_activated_connect_callback,
  (GCallback) &AppChooserWidget_signal_application_activated_connect_callback
};
