...
extern "C" {
static void Notebook_signal_switch_page_connect_callback(GtkNotebook* self, GtkWidget* p0,guint p1,void* data)
{
  using namespace Gtk;
...
{
  "switch_page",
  (GCallback) &Notebook_signal_switch_page_connect_callback,
  (GCallback) &Notebook_signal_switch_page_connect_callback
};


extern "C" {
static void Notebook_signal_page_reordered_connect_callback(GtkNotebook* self, GtkWidget* p0,guint p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(Widget*, guint)>;
...
{
  "page_reordered",
  (GCallback) &Notebook_signal_page_reordered_connect_callback,
  (GCallback) &Notebook_signal_page_reordered_connect_callback
};


extern "C" {
static void Notebook_signal_page_removed_connect_callback(GtkNotebook* self, GtkWidget* p0,guint p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(Widget*, guint)>;
...
{
  "page_removed",
  (GCallback) &Notebook_signal_page_removed_connect_callback,
  (GCallback) &Notebook_signal_page_removed_connect_callback
};


extern "C" {
static void Notebook_signal_page_added_connect_callback(GtkNotebook* self, GtkWidget* p0,guint p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(Widget*, guint)>;
...
{
  "page_added",
  (GCallback) &Notebook_signal_page_added_connect_callback,
  (GCallback) &Notebook_signal_page_added_connect_callback
};
