...
public:
  ...
  /** Switches to @a day's year and month and selects its day.
   * 
   * @newin{4,20}
   * 
   * @param day A `Glib::DateTime` representing the day to select.
   */
  void set_date(const Glib::DateTime& day);
   ...
   * 
   * @return The `Glib::DateTime` representing the selected date.
   */
   ...
   */
  Glib::PropertyProxy< Glib::DateTime > property_date() ;
...
/** The selected date.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< Glib::DateTime > property_date() const;
