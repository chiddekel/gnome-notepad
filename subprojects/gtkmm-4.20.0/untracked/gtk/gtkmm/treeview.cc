...
extern "C" {
static void TreeView_signal_row_activated_connect_callback(GtkTreeView* self, GtkTreePath* p0,GtkTreeViewColumn* p1,void* data)
{
  using namespace Gtk;
...
{
  "row-activated",
  (GCallback) &TreeView_signal_row_activated_connect_callback,
  (GCallback) &TreeView_signal_row_activated_connect_callback
};


extern "C" {
static gboolean TreeView_signal_test_expand_row_connect_callback(GtkTreeView* self, GtkTreeIter* p0,GtkTreePath* p1,void* data)
{
  using namespace Gtk;
...
{
  "test-expand-row",
  (GCallback) &TreeView_signal_test_expand_row_connect_callback,
  (GCallback) &TreeView_signal_test_expand_row_notify_callback
};


extern "C" {
static gboolean TreeView_signal_test_collapse_row_connect_callback(GtkTreeView* self, GtkTreeIter* p0,GtkTreePath* p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<bool(const TreeModel::iterator&, const TreeModel::Path&)>;
...
{
  "test-collapse-row",
  (GCallback) &TreeView_signal_test_collapse_row_connect_callback,
  (GCallback) &TreeView_signal_test_collapse_row_notify_callback
};


extern "C" {
static void TreeView_signal_row_expanded_connect_callback(GtkTreeView* self, GtkTreeIter* p0,GtkTreePath* p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(const TreeModel::iterator&, const TreeModel::Path&)>;
...
{
  "row-expanded",
  (GCallback) &TreeView_signal_row_expanded_connect_callback,
  (GCallback) &TreeView_signal_row_expanded_connect_callback
};


extern "C" {
static void TreeView_signal_row_collapsed_connect_callback(GtkTreeView* self, GtkTreeIter* p0,GtkTreePath* p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(const TreeModel::iterator&, const TreeModel::Path&)>;
...
{
  "row-collapsed",
  (GCallback) &TreeView_signal_row_collapsed_connect_callback,
  (GCallback) &TreeView_signal_row_collapsed_connect_callback
};
