...
using ComboBox_signal_changed_functype = void (*)(GtkComboBox* self);
ComboBox_signal_changed_functype ComboBox_signal_changed_funcptr;
extern "C" {
static void ComboBox_signal_changed_default_callback(GtkComboBox* self)
{
  ComboBox_signal_changed_funcptr( self);
}
} // extern "C"


extern "C" {
static gchar* ComboBox_signal_format_entry_text_connect_callback(GtkComboBox* self, const gchar* p0,void* data)
{
  using namespace Gtk;
...
{
  "format-entry-text",
  (GCallback) &ComboBox_signal_format_entry_text_connect_callback,
  (GCallback) &ComboBox_signal_format_entry_text_notify_callback
};


using ComboBox_signal_format_entry_text_functype = gchar* (*)(GtkComboBox* self, const gchar* p0);
ComboBox_signal_format_entry_text_functype ComboBox_signal_format_entry_text_funcptr;
extern "C" {
static gchar* ComboBox_signal_format_entry_text_default_callback(GtkComboBox* self, const gchar* p0)
{
  return ComboBox_signal_format_entry_text_funcptr( self, p0);
}
} // extern "C"
} // anonymous namespace
...
void ComboBox_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->changed = &ComboBox_signal_changed_default_callback;
  ComboBox_signal_changed_funcptr = &changed_callback;
  klass->format_entry_text = &ComboBox_signal_format_entry_text_default_callback;
  ComboBox_signal_format_entry_text_funcptr = &format_entry_text_callback;
}
