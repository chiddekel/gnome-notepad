...
// static
GType Glib::Value<Gtk::ListTabBehavior>::value_type()
{
  return gtk_list_tab_behavior_get_type();
}

// static
GType Glib::Value<Gtk::ListScrollFlags>::value_type()
{
  return gtk_list_scroll_flags_get_type();
}

// static
GType Glib::Value<Gtk::GraphicsOffloadEnabled>::value_type()
{
  return gtk_graphics_offload_enabled_get_type();
}

// static
GType Glib::Value<Gtk::FontRendering>::value_type()
{
  return gtk_font_rendering_get_type();
}

// static
GType Glib::Value<Gtk::InterfaceColorScheme>::value_type()
{
  return gtk_interface_color_scheme_get_type();
}

// static
GType Glib::Value<Gtk::InterfaceContrast>::value_type()
{
