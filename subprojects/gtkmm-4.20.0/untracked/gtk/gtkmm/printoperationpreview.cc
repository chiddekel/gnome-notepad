...
extern "C" {
static void PrintOperationPreview_signal_ready_connect_callback(GtkPrintOperationPreview* self, GtkPrintContext* p0,void* data)
{
  using namespace Gtk;
...
{
  "ready",
  (GCallback) &PrintOperationPreview_signal_ready_connect_callback,
  (GCallback) &PrintOperationPreview_signal_ready_connect_callback
};


using PrintOperationPreview_signal_ready_functype = void (*)(GtkPrintOperationPreview* self, GtkPrintContext* p0);
PrintOperationPreview_signal_ready_functype PrintOperationPreview_signal_ready_funcptr;
extern "C" {
static void PrintOperationPreview_signal_ready_default_callback(GtkPrintOperationPreview* self, GtkPrintContext* p0)
{
  PrintOperationPreview_signal_ready_funcptr( self, p0);
}
} // extern "C"


extern "C" {
static void PrintOperationPreview_signal_got_page_size_connect_callback(GtkPrintOperationPreview* self, GtkPrintContext* p0,GtkPageSetup* p1,void* data)
{
  using namespace Gtk;
...
{
  "got_page_size",
  (GCallback) &PrintOperationPreview_signal_got_page_size_connect_callback,
  (GCallback) &PrintOperationPreview_signal_got_page_size_connect_callback
};


using PrintOperationPreview_signal_got_page_size_functype = void (*)(GtkPrintOperationPreview* self, GtkPrintContext* p0, GtkPageSetup* p1);
PrintOperationPreview_signal_got_page_size_functype PrintOperationPreview_signal_got_page_size_funcptr;
extern "C" {
static void PrintOperationPreview_signal_got_page_size_default_callback(GtkPrintOperationPreview* self, GtkPrintContext* p0, GtkPageSetup* p1)
{
  PrintOperationPreview_signal_got_page_size_funcptr( self, p0, p1);
}
} // extern "C"
using PrintOperationPreview_render_page_vfunc_functype = void (*)(GtkPrintOperationPreview* self, gint page_nr);
PrintOperationPreview_render_page_vfunc_functype PrintOperationPreview_render_page_vfunc_funcptr;
extern "C" {
static void PrintOperationPreview_render_page_vfunc_c_callback(GtkPrintOperationPreview* self, gint page_nr)
{
  PrintOperationPreview_render_page_vfunc_funcptr( self, page_nr);
}
} // extern "C"
using PrintOperationPreview_end_preview_vfunc_functype = void (*)(GtkPrintOperationPreview* self);
PrintOperationPreview_end_preview_vfunc_functype PrintOperationPreview_end_preview_vfunc_funcptr;
extern "C" {
static void PrintOperationPreview_end_preview_vfunc_c_callback(GtkPrintOperationPreview* self)
{
  PrintOperationPreview_end_preview_vfunc_funcptr( self);
}
} // extern "C"
using PrintOperationPreview_is_selected_vfunc_functype = gboolean (*)(GtkPrintOperationPreview* self, gint page_nr);
PrintOperationPreview_is_selected_vfunc_functype PrintOperationPreview_is_selected_vfunc_funcptr;
extern "C" {
static gboolean PrintOperationPreview_is_selected_vfunc_c_callback(GtkPrintOperationPreview* self, gint page_nr)
{
  return PrintOperationPreview_is_selected_vfunc_funcptr( self, page_nr);
}
} // extern "C"
} // anonymous namespace
...
void PrintOperationPreview_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->render_page = &PrintOperationPreview_render_page_vfunc_c_callback;
  PrintOperationPreview_render_page_vfunc_funcptr = &render_page_vfunc_callback;
  klass->end_preview = &PrintOperationPreview_end_preview_vfunc_c_callback;
  PrintOperationPreview_end_preview_vfunc_funcptr = &end_preview_vfunc_callback;
  klass->is_selected = &PrintOperationPreview_is_selected_vfunc_c_callback;
  PrintOperationPreview_is_selected_vfunc_funcptr = &is_selected_vfunc_callback;

  klass->ready = &PrintOperationPreview_signal_ready_default_callback;
  PrintOperationPreview_signal_ready_funcptr = &ready_callback;
  klass->got_page_size = &PrintOperationPreview_signal_got_page_size_default_callback;
  PrintOperationPreview_signal_got_page_size_funcptr = &got_page_size_callback;
}
