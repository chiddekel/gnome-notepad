...
extern "C" {
static gboolean EventControllerKey_signal_key_pressed_connect_callback(GtkEventControllerKey* self, guint p0,guint p1,GdkModifierType p2,void* data)
{
  using namespace Gtk;
...
{
  "key-pressed",
  (GCallback) &EventControllerKey_signal_key_pressed_connect_callback,
  (GCallback) &EventControllerKey_signal_key_pressed_notify_callback
};


extern "C" {
static void EventControllerKey_signal_key_released_connect_callback(GtkEventControllerKey* self, guint p0,guint p1,GdkModifierType p2,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(guint, guint, Gdk::ModifierType)>;
...
{
  "key-released",
  (GCallback) &EventControllerKey_signal_key_released_connect_callback,
  (GCallback) &EventControllerKey_signal_key_released_connect_callback
};


extern "C" {
static gboolean EventControllerKey_signal_modifiers_connect_callback(GtkEventControllerKey* self, GdkModifierType p0,void* data)
{
  using namespace Gtk;
...
{
  "modifiers",
  (GCallback) &EventControllerKey_signal_modifiers_connect_callback,
