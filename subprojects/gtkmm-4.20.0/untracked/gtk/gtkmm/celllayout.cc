...
namespace
{
using CellLayout_pack_start_vfunc_functype = void (*)(GtkCellLayout* self, GtkCellRenderer* cell, gboolean expand);
CellLayout_pack_start_vfunc_functype CellLayout_pack_start_vfunc_funcptr;
extern "C" {
static void CellLayout_pack_start_vfunc_c_callback(GtkCellLayout* self, GtkCellRenderer* cell, gboolean expand)
{
  CellLayout_pack_start_vfunc_funcptr( self, cell, expand);
}
} // extern "C"
using CellLayout_pack_end_vfunc_functype = void (*)(GtkCellLayout* self, GtkCellRenderer* cell, gboolean expand);
CellLayout_pack_end_vfunc_functype CellLayout_pack_end_vfunc_funcptr;
extern "C" {
static void CellLayout_pack_end_vfunc_c_callback(GtkCellLayout* self, GtkCellRenderer* cell, gboolean expand)
{
  CellLayout_pack_end_vfunc_funcptr( self, cell, expand);
}
} // extern "C"
using CellLayout_clear_vfunc_functype = void (*)(GtkCellLayout* self);
CellLayout_clear_vfunc_functype CellLayout_clear_vfunc_funcptr;
extern "C" {
static void CellLayout_clear_vfunc_c_callback(GtkCellLayout* self)
{
  CellLayout_clear_vfunc_funcptr( self);
}
} // extern "C"
using CellLayout_add_attribute_vfunc_functype = void (*)(GtkCellLayout* self, GtkCellRenderer* cell, const gchar* attribute, gint column);
CellLayout_add_attribute_vfunc_functype CellLayout_add_attribute_vfunc_funcptr;
extern "C" {
static void CellLayout_add_attribute_vfunc_c_callback(GtkCellLayout* self, GtkCellRenderer* cell, const gchar* attribute, gint column)
{
  CellLayout_add_attribute_vfunc_funcptr( self, cell, attribute, column);
}
} // extern "C"
using CellLayout_clear_attributes_vfunc_functype = void (*)(GtkCellLayout* self, GtkCellRenderer* cell);
CellLayout_clear_attributes_vfunc_functype CellLayout_clear_attributes_vfunc_funcptr;
extern "C" {
static void CellLayout_clear_attributes_vfunc_c_callback(GtkCellLayout* self, GtkCellRenderer* cell)
{
  CellLayout_clear_attributes_vfunc_funcptr( self, cell);
}
} // extern "C"
using CellLayout_reorder_vfunc_functype = void (*)(GtkCellLayout* self, GtkCellRenderer* cell, gint position);
CellLayout_reorder_vfunc_functype CellLayout_reorder_vfunc_funcptr;
extern "C" {
static void CellLayout_reorder_vfunc_c_callback(GtkCellLayout* self, GtkCellRenderer* cell, gint position)
{
  CellLayout_reorder_vfunc_funcptr( self, cell, position);
}
} // extern "C"
} // anonymous namespace
...
void CellLayout_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->pack_start = &CellLayout_pack_start_vfunc_c_callback;
  CellLayout_pack_start_vfunc_funcptr = &pack_start_vfunc_callback;
  klass->pack_end = &CellLayout_pack_end_vfunc_c_callback;
  CellLayout_pack_end_vfunc_funcptr = &pack_end_vfunc_callback;
  klass->clear = &CellLayout_clear_vfunc_c_callback;
  CellLayout_clear_vfunc_funcptr = &clear_vfunc_callback;
  klass->add_attribute = &CellLayout_add_attribute_vfunc_c_callback;
  CellLayout_add_attribute_vfunc_funcptr = &add_attribute_vfunc_callback;
  klass->clear_attributes = &CellLayout_clear_attributes_vfunc_c_callback;
  CellLayout_clear_attributes_vfunc_funcptr = &clear_attributes_vfunc_callback;
  klass->reorder = &CellLayout_reorder_vfunc_c_callback;
  CellLayout_reorder_vfunc_funcptr = &reorder_vfunc_callback;
