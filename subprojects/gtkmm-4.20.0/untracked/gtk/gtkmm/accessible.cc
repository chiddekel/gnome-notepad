...
// static
GType Glib::Value<Gtk::Accessible::PlatformState>::value_type()
{
  return gtk_accessible_platform_state_get_type();
}

// static
GType Glib::Value<Gtk::Accessible::AnnouncementPriority>::value_type()
{
...
Glib::RefPtr<ATContext> Accessible::get_at_context()
{
...
Glib::RefPtr<const ATContext> Accessible::get_at_context() const
{
  return const_cast<Accessible*>(this)->get_at_context();
}

bool Accessible::get_platform_state(PlatformState state) const
{
  return gtk_accessible_get_platform_state(const_cast<GtkAccessible*>(gobj()), static_cast<GtkAccessiblePlatformState>(state));
}

void Accessible::update_platform_state(PlatformState state)
{
  gtk_accessible_update_platform_state(gobj(), static_cast<GtkAccessiblePlatformState>(state));
}

Glib::RefPtr<Accessible> Accessible::get_accessible_parent()
{
...
Glib::RefPtr<const Accessible> Accessible::get_accessible_parent() const
{
  return const_cast<Accessible*>(this)->get_accessible_parent();
}

void Accessible::set_accessible_parent(const Glib::RefPtr<Accessible>& parent, const Glib::RefPtr<Accessible>& next_sibling)
{
  gtk_accessible_set_accessible_parent(gobj(), Glib::unwrap(parent), Glib::unwrap(next_sibling));
}

Glib::RefPtr<Accessible> Accessible::get_first_accessible_child()
{
  auto retvalue = Glib::wrap(gtk_accessible_get_first_accessible_child(gobj()));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}

Glib::RefPtr<const Accessible> Accessible::get_first_accessible_child() const
{
  return const_cast<Accessible*>(this)->get_first_accessible_child();
}

Glib::RefPtr<Accessible> Accessible::get_next_accessible_sibling()
{
  auto retvalue = Glib::wrap(gtk_accessible_get_next_accessible_sibling(gobj()));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}

Glib::RefPtr<const Accessible> Accessible::get_next_accessible_sibling() const
{
  return const_cast<Accessible*>(this)->get_next_accessible_sibling();
}

void Accessible::update_next_accessible_sibling(const Glib::RefPtr<Accessible>& new_sibling)
{
  gtk_accessible_update_next_accessible_sibling(gobj(), Glib::unwrap(new_sibling));
}

bool Accessible::get_bounds(int& x, int& y, int& width, int& height) const
{
  return gtk_accessible_get_bounds(const_cast<GtkAccessible*>(gobj()), &(x), &(y), &(width), &(height));
}
...
void Accessible::announce(const Glib::ustring& message, AnnouncementPriority priority)
{
  gtk_accessible_announce(gobj(), message.c_str(), static_cast<GtkAccessibleAnnouncementPriority>(priority));
}
