...
using ToggleButton_signal_toggled_functype = void (*)(GtkToggleButton* self);
ToggleButton_signal_toggled_functype ToggleButton_signal_toggled_funcptr;
extern "C" {
static void ToggleButton_signal_toggled_default_callback(GtkToggleButton* self)
{
  ToggleButton_signal_toggled_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void ToggleButton_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->toggled = &ToggleButton_signal_toggled_default_callback;
  ToggleButton_signal_toggled_funcptr = &toggled_callback;
}
