...
extern "C" {
static void TextTagTable_signal_tag_changed_connect_callback(GtkTextTagTable* self, GtkTextTag* p0,gboolean p1,void* data)
{
  using namespace Gtk;
...
{
  "tag_changed",
  (GCallback) &TextTagTable_signal_tag_changed_connect_callback,
  (GCallback) &TextTagTable_signal_tag_changed_connect_callback
};


extern "C" {
static void TextTagTable_signal_tag_added_connect_callback(GtkTextTagTable* self, GtkTextTag* p0,void* data)
{
  using namespace Gtk;
...
{
  "tag_added",
  (GCallback) &TextTagTable_signal_tag_added_connect_callback,
  (GCallback) &TextTagTable_signal_tag_added_connect_callback
};


extern "C" {
static void TextTagTable_signal_tag_removed_connect_callback(GtkTextTagTable* self, GtkTextTag* p0,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(const Glib::RefPtr<TextTag>&)>;
...
{
  "tag_removed",
  (GCallback) &TextTagTable_signal_tag_removed_connect_callback,
  (GCallback) &TextTagTable_signal_tag_removed_connect_callback
};
