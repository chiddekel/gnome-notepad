...
extern "C" {
static void Printer_signal_details_acquired_connect_callback(GtkPrinter* self, gboolean p0,void* data)
{
  using namespace Gtk;
...
{
  "details_acquired",
  (GCallback) &Printer_signal_details_acquired_connect_callback,
  (GCallback) &Printer_signal_details_acquired_connect_callback
};
