...
namespace
{
using ShortcutManager_add_controller_vfunc_functype = void (*)(GtkShortcutManager* self, GtkShortcutController* controller);
ShortcutManager_add_controller_vfunc_functype ShortcutManager_add_controller_vfunc_funcptr;
extern "C" {
static void ShortcutManager_add_controller_vfunc_c_callback(GtkShortcutManager* self, GtkShortcutController* controller)
{
  ShortcutManager_add_controller_vfunc_funcptr( self, controller);
}
} // extern "C"
using ShortcutManager_remove_controller_vfunc_functype = void (*)(GtkShortcutManager* self, GtkShortcutController* controller);
ShortcutManager_remove_controller_vfunc_functype ShortcutManager_remove_controller_vfunc_funcptr;
extern "C" {
static void ShortcutManager_remove_controller_vfunc_c_callback(GtkShortcutManager* self, GtkShortcutController* controller)
{
  ShortcutManager_remove_controller_vfunc_funcptr( self, controller);
}
} // extern "C"
} // anonymous namespace
...
void ShortcutManager_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->add_controller = &ShortcutManager_add_controller_vfunc_c_callback;
  ShortcutManager_add_controller_vfunc_funcptr = &add_controller_vfunc_callback;
  klass->remove_controller = &ShortcutManager_remove_controller_vfunc_c_callback;
  ShortcutManager_remove_controller_vfunc_funcptr = &remove_controller_vfunc_callback;
