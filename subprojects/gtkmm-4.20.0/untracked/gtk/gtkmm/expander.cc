...
static const Glib::SignalProxyInfo Expander_signal_activate_info =
{
  "activate",
...
Glib::SignalProxy<void()> Expander::signal_activate()
{
  return Glib::SignalProxy<void() >(this, &Expander_signal_activate_info);
}
