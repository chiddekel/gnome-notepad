...
using CellRenderer_signal_editing_canceled_functype = void (*)(GtkCellRenderer* self);
CellRenderer_signal_editing_canceled_functype CellRenderer_signal_editing_canceled_funcptr;
extern "C" {
static void CellRenderer_signal_editing_canceled_default_callback(GtkCellRenderer* self)
{
  CellRenderer_signal_editing_canceled_funcptr( self);
}
} // extern "C"


extern "C" {
static void CellRenderer_signal_editing_started_connect_callback(GtkCellRenderer* self, GtkCellEditable* p0,const gchar* p1,void* data)
{
  using namespace Gtk;
...
{
  "editing_started",
  (GCallback) &CellRenderer_signal_editing_started_connect_callback,
  (GCallback) &CellRenderer_signal_editing_started_connect_callback
};


using CellRenderer_signal_editing_started_functype = void (*)(GtkCellRenderer* self, GtkCellEditable* p0, const gchar* p1);
CellRenderer_signal_editing_started_functype CellRenderer_signal_editing_started_funcptr;
extern "C" {
static void CellRenderer_signal_editing_started_default_callback(GtkCellRenderer* self, GtkCellEditable* p0, const gchar* p1)
{
  CellRenderer_signal_editing_started_funcptr( self, p0, p1);
}
} // extern "C"
using CellRenderer_get_request_mode_vfunc_functype = GtkSizeRequestMode (*)(GtkCellRenderer* self);
CellRenderer_get_request_mode_vfunc_functype CellRenderer_get_request_mode_vfunc_funcptr;
extern "C" {
static GtkSizeRequestMode CellRenderer_get_request_mode_vfunc_c_callback(GtkCellRenderer* self)
{
  return CellRenderer_get_request_mode_vfunc_funcptr( self);
}
} // extern "C"
using CellRenderer_get_preferred_width_vfunc_functype = void (*)(GtkCellRenderer* self, GtkWidget* widget, gint* minimum_width, gint* natural_width);
CellRenderer_get_preferred_width_vfunc_functype CellRenderer_get_preferred_width_vfunc_funcptr;
extern "C" {
static void CellRenderer_get_preferred_width_vfunc_c_callback(GtkCellRenderer* self, GtkWidget* widget, gint* minimum_width, gint* natural_width)
{
  CellRenderer_get_preferred_width_vfunc_funcptr( self, widget, minimum_width, natural_width);
}
} // extern "C"
using CellRenderer_get_preferred_height_for_width_vfunc_functype = void (*)(GtkCellRenderer* self, GtkWidget* widget, gint width, gint* minimum_height, gint* natural_height);
CellRenderer_get_preferred_height_for_width_vfunc_functype CellRenderer_get_preferred_height_for_width_vfunc_funcptr;
extern "C" {
static void CellRenderer_get_preferred_height_for_width_vfunc_c_callback(GtkCellRenderer* self, GtkWidget* widget, gint width, gint* minimum_height, gint* natural_height)
{
  CellRenderer_get_preferred_height_for_width_vfunc_funcptr( self, widget, width, minimum_height, natural_height);
}
} // extern "C"
using CellRenderer_get_preferred_height_vfunc_functype = void (*)(GtkCellRenderer* self, GtkWidget* widget, gint* minimum_height, gint* natural_height);
CellRenderer_get_preferred_height_vfunc_functype CellRenderer_get_preferred_height_vfunc_funcptr;
extern "C" {
static void CellRenderer_get_preferred_height_vfunc_c_callback(GtkCellRenderer* self, GtkWidget* widget, gint* minimum_height, gint* natural_height)
{
  CellRenderer_get_preferred_height_vfunc_funcptr( self, widget, minimum_height, natural_height);
}
} // extern "C"
using CellRenderer_get_preferred_width_for_height_vfunc_functype = void (*)(GtkCellRenderer* self, GtkWidget* widget, gint height, gint* minimum_width, gint* natural_width);
CellRenderer_get_preferred_width_for_height_vfunc_functype CellRenderer_get_preferred_width_for_height_vfunc_funcptr;
extern "C" {
static void CellRenderer_get_preferred_width_for_height_vfunc_c_callback(GtkCellRenderer* self, GtkWidget* widget, gint height, gint* minimum_width, gint* natural_width)
{
  CellRenderer_get_preferred_width_for_height_vfunc_funcptr( self, widget, height, minimum_width, natural_width);
}
} // extern "C"
using CellRenderer_snapshot_vfunc_functype = void (*)(GtkCellRenderer* self, GtkSnapshot* snapshot, GtkWidget* widget, const GdkRectangle* background_area, const GdkRectangle* cell_area, GtkCellRendererState flags);
CellRenderer_snapshot_vfunc_functype CellRenderer_snapshot_vfunc_funcptr;
extern "C" {
static void CellRenderer_snapshot_vfunc_c_callback(GtkCellRenderer* self, GtkSnapshot* snapshot, GtkWidget* widget, const GdkRectangle* background_area, const GdkRectangle* cell_area, GtkCellRendererState flags)
{
  CellRenderer_snapshot_vfunc_funcptr( self, snapshot, widget, background_area, cell_area, flags);
}
} // extern "C"
using CellRenderer_activate_vfunc_functype = gboolean (*)(GtkCellRenderer* self, GdkEvent* event, GtkWidget* widget, const gchar* path, const GdkRectangle* background_area, const GdkRectangle* cell_area, GtkCellRendererState flags);
CellRenderer_activate_vfunc_functype CellRenderer_activate_vfunc_funcptr;
extern "C" {
static gboolean CellRenderer_activate_vfunc_c_callback(GtkCellRenderer* self, GdkEvent* event, GtkWidget* widget, const gchar* path, const GdkRectangle* background_area, const GdkRectangle* cell_area, GtkCellRendererState flags)
{
  return CellRenderer_activate_vfunc_funcptr( self, event, widget, path, background_area, cell_area, flags);
}
} // extern "C"
using CellRenderer_start_editing_vfunc_functype = GtkCellEditable* (*)(GtkCellRenderer* self, GdkEvent* event, GtkWidget* widget, const gchar* path, const GdkRectangle* background_area, const GdkRectangle* cell_area, GtkCellRendererState flags);
CellRenderer_start_editing_vfunc_functype CellRenderer_start_editing_vfunc_funcptr;
extern "C" {
static GtkCellEditable* CellRenderer_start_editing_vfunc_c_callback(GtkCellRenderer* self, GdkEvent* event, GtkWidget* widget, const gchar* path, const GdkRectangle* background_area, const GdkRectangle* cell_area, GtkCellRendererState flags)
{
  return CellRenderer_start_editing_vfunc_funcptr( self, event, widget, path, background_area, cell_area, flags);
}
} // extern "C"
} // anonymous namespace
...
void CellRenderer_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->get_request_mode = &CellRenderer_get_request_mode_vfunc_c_callback;
  CellRenderer_get_request_mode_vfunc_funcptr = &get_request_mode_vfunc_callback;
  klass->get_preferred_width = &CellRenderer_get_preferred_width_vfunc_c_callback;
  CellRenderer_get_preferred_width_vfunc_funcptr = &get_preferred_width_vfunc_callback;
  klass->get_preferred_height_for_width = &CellRenderer_get_preferred_height_for_width_vfunc_c_callback;
  CellRenderer_get_preferred_height_for_width_vfunc_funcptr = &get_preferred_height_for_width_vfunc_callback;
  klass->get_preferred_height = &CellRenderer_get_preferred_height_vfunc_c_callback;
  CellRenderer_get_preferred_height_vfunc_funcptr = &get_preferred_height_vfunc_callback;
  klass->get_preferred_width_for_height = &CellRenderer_get_preferred_width_for_height_vfunc_c_callback;
  CellRenderer_get_preferred_width_for_height_vfunc_funcptr = &get_preferred_width_for_height_vfunc_callback;
  klass->snapshot = &CellRenderer_snapshot_vfunc_c_callback;
  CellRenderer_snapshot_vfunc_funcptr = &snapshot_vfunc_callback;
  klass->activate = &CellRenderer_activate_vfunc_c_callback;
  CellRenderer_activate_vfunc_funcptr = &activate_vfunc_callback;
  klass->start_editing = &CellRenderer_start_editing_vfunc_c_callback;
  CellRenderer_start_editing_vfunc_funcptr = &start_editing_vfunc_callback;

  klass->editing_canceled = &CellRenderer_signal_editing_canceled_default_callback;
  CellRenderer_signal_editing_canceled_funcptr = &editing_canceled_callback;
  klass->editing_started = &CellRenderer_signal_editing_started_default_callback;
  CellRenderer_signal_editing_started_funcptr = &editing_started_callback;
}
