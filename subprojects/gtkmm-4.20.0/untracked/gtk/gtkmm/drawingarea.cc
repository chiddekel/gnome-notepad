...
extern "C" {
static void DrawingArea_signal_resize_connect_callback(GtkDrawingArea* self, gint p0,gint p1,void* data)
{
  using namespace Gtk;
...
{
  "resize",
  (GCallback) &DrawingArea_signal_resize_connect_callback,
  (GCallback) &DrawingArea_signal_resize_connect_callback
};


using DrawingArea_signal_resize_functype = void (*)(GtkDrawingArea* self, gint p0, gint p1);
DrawingArea_signal_resize_functype DrawingArea_signal_resize_funcptr;
extern "C" {
static void DrawingArea_signal_resize_default_callback(GtkDrawingArea* self, gint p0, gint p1)
{
  DrawingArea_signal_resize_funcptr( self, p0, p1);
}
} // extern "C"
} // anonymous namespace
...
void DrawingArea_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->resize = &DrawingArea_signal_resize_default_callback;
  DrawingArea_signal_resize_funcptr = &resize_callback;
}
