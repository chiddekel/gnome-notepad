...
extern "C" {
static void Entry_signal_icon_release_connect_callback(GtkEntry* self, GtkEntryIconPosition p0,void* data)
{
  using namespace Gtk;
...
{
  "icon-release",
  (GCallback) &Entry_signal_icon_release_connect_callback,
  (GCallback) &Entry_signal_icon_release_connect_callback
};


extern "C" {
static void Entry_signal_icon_press_connect_callback(GtkEntry* self, GtkEntryIconPosition p0,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(IconPosition)>;
...
{
  "icon-press",
  (GCallback) &Entry_signal_icon_press_connect_callback,
  (GCallback) &Entry_signal_icon_press_connect_callback
};
...
Glib::ustring Entry::get_menu_entry_icon_text(IconPosition icon_pos) const
{
  return Glib::convert_const_gchar_ptr_to_ustring(gtk_entry_get_menu_entry_icon_text(const_cast<GtkEntry*>(gobj()), static_cast<GtkEntryIconPosition>(icon_pos)));
}

void Entry::set_menu_entry_icon_text(const Glib::ustring& text, IconPosition icon_pos)
{
  gtk_entry_set_menu_entry_icon_text(gobj(), static_cast<GtkEntryIconPosition>(icon_pos), text.c_str());
}
...
Glib::PropertyProxy< Glib::ustring > Entry::property_menu_entry_icon_primary_text() 
{
  return Glib::PropertyProxy< Glib::ustring >(this, "menu-entry-icon-primary-text");
}

Glib::PropertyProxy_ReadOnly< Glib::ustring > Entry::property_menu_entry_icon_primary_text() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::ustring >(this, "menu-entry-icon-primary-text");
}

Glib::PropertyProxy< Glib::ustring > Entry::property_menu_entry_icon_secondary_text() 
{
  return Glib::PropertyProxy< Glib::ustring >(this, "menu-entry-icon-secondary-text");
}

Glib::PropertyProxy_ReadOnly< Glib::ustring > Entry::property_menu_entry_icon_secondary_text() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::ustring >(this, "menu-entry-icon-secondary-text");
}
