...
/** @ingroup gtkmmEnums */
inline constexpr PrintCapabilities operator|(PrintCapabilities lhs, PrintCapabilities rhs)
...
/** @ingroup gtkmmEnums */
inline constexpr PrintCapabilities operator~(PrintCapabilities flags)
...
public:
   ...
   * signal_details_acquired() signal
   * will be emitted on @a printer.
   */
