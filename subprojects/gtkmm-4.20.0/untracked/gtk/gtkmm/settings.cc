...
Glib::PropertyProxy< bool > Settings::property_gtk_show_status_shapes() 
{
  return Glib::PropertyProxy< bool >(this, "gtk-show-status-shapes");
}

Glib::PropertyProxy_ReadOnly< bool > Settings::property_gtk_show_status_shapes() const
{
  return Glib::PropertyProxy_ReadOnly< bool >(this, "gtk-show-status-shapes");
}
...
static_assert(Glib::Traits::ValueCompatibleWithWrapProperty<FontRendering>::value,
  "Type FontRendering cannot be used in _WRAP_PROPERTY. "
  "There is no suitable template specialization of Glib::Value<>.");

Glib::PropertyProxy< FontRendering > Settings::property_gtk_font_rendering() 
{
  return Glib::PropertyProxy< FontRendering >(this, "gtk-font-rendering");
}

Glib::PropertyProxy_ReadOnly< FontRendering > Settings::property_gtk_font_rendering() const
{
  return Glib::PropertyProxy_ReadOnly< FontRendering >(this, "gtk-font-rendering");
}

static_assert(Glib::Traits::ValueCompatibleWithWrapProperty<InterfaceColorScheme>::value,
  "Type InterfaceColorScheme cannot be used in _WRAP_PROPERTY. "
  "There is no suitable template specialization of Glib::Value<>.");

Glib::PropertyProxy< InterfaceColorScheme > Settings::property_gtk_interface_color_scheme() 
{
  return Glib::PropertyProxy< InterfaceColorScheme >(this, "gtk-interface-color-scheme");
}

Glib::PropertyProxy_ReadOnly< InterfaceColorScheme > Settings::property_gtk_interface_color_scheme() const
{
  return Glib::PropertyProxy_ReadOnly< InterfaceColorScheme >(this, "gtk-interface-color-scheme");
}

static_assert(Glib::Traits::ValueCompatibleWithWrapProperty<InterfaceContrast>::value,
  "Type InterfaceContrast cannot be used in _WRAP_PROPERTY. "
  "There is no suitable template specialization of Glib::Value<>.");

Glib::PropertyProxy< InterfaceContrast > Settings::property_gtk_interface_contrast() 
{
  return Glib::PropertyProxy< InterfaceContrast >(this, "gtk-interface-contrast");
}

Glib::PropertyProxy_ReadOnly< InterfaceContrast > Settings::property_gtk_interface_contrast() const
{
  return Glib::PropertyProxy_ReadOnly< InterfaceContrast >(this, "gtk-interface-contrast");
}
