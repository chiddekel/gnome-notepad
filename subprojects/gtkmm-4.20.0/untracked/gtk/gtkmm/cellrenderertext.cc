...
extern "C" {
static void CellRendererText_signal_edited_connect_callback(GtkCellRendererText* self, const gchar* p0,const gchar* p1,void* data)
{
  using namespace Gtk;
...
{
  "edited",
  (GCallback) &CellRendererText_signal_edited_connect_callback,
  (GCallback) &CellRendererText_signal_edited_connect_callback
};


using CellRendererText_signal_edited_functype = void (*)(GtkCellRendererText* self, const gchar* p0, const gchar* p1);
CellRendererText_signal_edited_functype CellRendererText_signal_edited_funcptr;
extern "C" {
static void CellRendererText_signal_edited_default_callback(GtkCellRendererText* self, const gchar* p0, const gchar* p1)
{
  CellRendererText_signal_edited_funcptr( self, p0, p1);
}
} // extern "C"
} // anonymous namespace
...
void CellRendererText_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->edited = &CellRendererText_signal_edited_default_callback;
  CellRendererText_signal_edited_funcptr = &edited_callback;
}
