...
extern "C" {
static void EmojiChooser_signal_emoji_picked_connect_callback(GtkEmojiChooser* self, const gchar* p0,void* data)
{
  using namespace Gtk;
...
{
  "emoji-picked",
  (GCallback) &EmojiChooser_signal_emoji_picked_connect_callback,
  (GCallback) &EmojiChooser_signal_emoji_picked_connect_callback
};
