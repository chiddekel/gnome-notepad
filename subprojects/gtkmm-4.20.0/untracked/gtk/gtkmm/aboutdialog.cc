...
// use-header-bar is construct-only in GTK3. It was removed in GTK4.
// This constructor does not work in gtkmm4.
...
extern "C" {
static gboolean AboutDialog_signal_activate_link_connect_callback(GtkAboutDialog* self, const gchar* p0,void* data)
{
  using namespace Gtk;
...
{
  "activate-link",
  (GCallback) &AboutDialog_signal_activate_link_connect_callback,
