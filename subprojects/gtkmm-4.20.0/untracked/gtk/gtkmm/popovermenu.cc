...
using Flags = Gtk::PopoverMenu::Flags;
...
void PopoverMenu::set_flags(Flags flags)
{
  gtk_popover_menu_set_flags(gobj(), static_cast<GtkPopoverMenuFlags>(flags));
}

Flags PopoverMenu::get_flags() const
{
  return static_cast<Flags>(gtk_popover_menu_get_flags(const_cast<GtkPopoverMenu*>(gobj())));
}
...
Glib::PropertyProxy< Flags > PopoverMenu::property_flags() 
{
  return Glib::PropertyProxy< Flags >(this, "flags");
}

Glib::PropertyProxy_ReadOnly< Flags > PopoverMenu::property_flags() const
{
