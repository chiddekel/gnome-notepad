...
extern "C" {
static void GestureRotate_signal_angle_changed_connect_callback(GtkGestureRotate* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "angle-changed",
  (GCallback) &GestureRotate_signal_angle_changed_connect_callback,
  (GCallback) &GestureRotate_signal_angle_changed_connect_callback
};
