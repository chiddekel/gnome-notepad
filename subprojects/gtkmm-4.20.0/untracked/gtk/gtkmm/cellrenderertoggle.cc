...
extern "C" {
static void CellRendererToggle_signal_toggled_connect_callback(GtkCellRendererToggle* self, const gchar* p0,void* data)
{
  using namespace Gtk;
...
{
  "toggled",
  (GCallback) &CellRendererToggle_signal_toggled_connect_callback,
  (GCallback) &CellRendererToggle_signal_toggled_connect_callback
};
