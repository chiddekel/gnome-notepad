...
extern "C" {
static GdkGLContext* GLArea_signal_create_context_connect_callback(GtkGLArea* self, void* data)
{
  using namespace Gtk;
...
{
  "create_context",
  (GCallback) &GLArea_signal_create_context_connect_callback,
  (GCallback) &GLArea_signal_create_context_notify_callback
};


using GLArea_signal_create_context_functype = GdkGLContext* (*)(GtkGLArea* self);
GLArea_signal_create_context_functype GLArea_signal_create_context_funcptr;
extern "C" {
static GdkGLContext* GLArea_signal_create_context_default_callback(GtkGLArea* self)
{
  return GLArea_signal_create_context_funcptr( self);
}
} // extern "C"


extern "C" {
static gboolean GLArea_signal_render_connect_callback(GtkGLArea* self, GdkGLContext* p0,void* data)
{
  using namespace Gtk;
...
{
  "render",
  (GCallback) &GLArea_signal_render_connect_callback,
  (GCallback) &GLArea_signal_render_notify_callback
};


using GLArea_signal_render_functype = gboolean (*)(GtkGLArea* self, GdkGLContext* p0);
GLArea_signal_render_functype GLArea_signal_render_funcptr;
extern "C" {
static gboolean GLArea_signal_render_default_callback(GtkGLArea* self, GdkGLContext* p0)
{
  return GLArea_signal_render_funcptr( self, p0);
}
} // extern "C"


extern "C" {
static void GLArea_signal_resize_connect_callback(GtkGLArea* self, gint p0,gint p1,void* data)
{
  using namespace Gtk;
...
{
  "resize",
  (GCallback) &GLArea_signal_resize_connect_callback,
  (GCallback) &GLArea_signal_resize_connect_callback
};


using GLArea_signal_resize_functype = void (*)(GtkGLArea* self, gint p0, gint p1);
GLArea_signal_resize_functype GLArea_signal_resize_funcptr;
extern "C" {
static void GLArea_signal_resize_default_callback(GtkGLArea* self, gint p0, gint p1)
{
  GLArea_signal_resize_funcptr( self, p0, p1);
}
} // extern "C"
} // anonymous namespace
...
void GLArea_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->create_context = &GLArea_signal_create_context_default_callback;
  GLArea_signal_create_context_funcptr = &create_context_callback;
  klass->render = &GLArea_signal_render_default_callback;
  GLArea_signal_render_funcptr = &render_callback;
  klass->resize = &GLArea_signal_resize_default_callback;
  GLArea_signal_resize_funcptr = &resize_callback;
}
...
void GLArea::set_allowed_apis(Gdk::GLApi apis)
{
  gtk_gl_area_set_allowed_apis(gobj(), static_cast<GdkGLAPI>(apis));
}

Gdk::GLApi GLArea::get_allowed_apis() const
{
  return static_cast<Gdk::GLApi>(gtk_gl_area_get_allowed_apis(const_cast<GtkGLArea*>(gobj())));
}

Gdk::GLApi GLArea::get_api() const
{
  return static_cast<Gdk::GLApi>(gtk_gl_area_get_api(const_cast<GtkGLArea*>(gobj())));
}
...
static_assert(Glib::Traits::ValueCompatibleWithWrapProperty<Gdk::GLApi>::value,
  "Type Gdk::GLApi cannot be used in _WRAP_PROPERTY. "
  "There is no suitable template specialization of Glib::Value<>.");

Glib::PropertyProxy< Gdk::GLApi > GLArea::property_allowed_apis() 
{
  return Glib::PropertyProxy< Gdk::GLApi >(this, "allowed-apis");
}

Glib::PropertyProxy_ReadOnly< Gdk::GLApi > GLArea::property_allowed_apis() const
{
  return Glib::PropertyProxy_ReadOnly< Gdk::GLApi >(this, "allowed-apis");
}
...
Glib::PropertyProxy_ReadOnly< Gdk::GLApi > GLArea::property_api() const
{
  return Glib::PropertyProxy_ReadOnly< Gdk::GLApi >(this, "api");
}
