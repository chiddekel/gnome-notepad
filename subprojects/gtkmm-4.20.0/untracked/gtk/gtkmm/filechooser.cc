...
std::vector<Glib::RefPtr<Gio::File>> FileChooser::get_files2()
{
  return listmodel_to_vector<Gio::File>(gtk_file_chooser_get_files(gobj()));
}

std::vector<Glib::RefPtr<const Gio::File>> FileChooser::get_files2() const
{
  return listmodel_to_vector<const Gio::File>(gtk_file_chooser_get_files(const_cast<GtkFileChooser*>(gobj())));
}
...
std::vector<Glib::RefPtr<Gio::File>> FileChooser::get_shortcut_folders2()
{
  return listmodel_to_vector<Gio::File>(gtk_file_chooser_get_shortcut_folders(gobj()));
}
