...
extern "C" {
static gboolean EventControllerScroll_signal_scroll_connect_callback(GtkEventControllerScroll* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "scroll",
  (GCallback) &EventControllerScroll_signal_scroll_connect_callback,
...
extern "C" {
static void EventControllerScroll_signal_decelerate_connect_callback(GtkEventControllerScroll* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(double, double)>;
...
{
  "decelerate",
  (GCallback) &EventControllerScroll_signal_decelerate_connect_callback,
  (GCallback) &EventControllerScroll_signal_decelerate_connect_callback
};
