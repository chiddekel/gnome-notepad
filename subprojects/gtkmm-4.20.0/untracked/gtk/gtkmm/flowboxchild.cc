...
using FlowBoxChild_signal_activate_functype = void (*)(GtkFlowBoxChild* self);
FlowBoxChild_signal_activate_functype FlowBoxChild_signal_activate_funcptr;
extern "C" {
static void FlowBoxChild_signal_activate_default_callback(GtkFlowBoxChild* self)
{
  FlowBoxChild_signal_activate_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void FlowBoxChild_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->activate = &FlowBoxChild_signal_activate_default_callback;
  FlowBoxChild_signal_activate_funcptr = &activate_callback;
}
