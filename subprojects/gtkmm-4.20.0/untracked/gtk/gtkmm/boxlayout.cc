...
void BoxLayout::set_baseline_child(int child)
{
  gtk_box_layout_set_baseline_child(gobj(), child);
}

int BoxLayout::get_baseline_child() const
{
  return gtk_box_layout_get_baseline_child(const_cast<GtkBoxLayout*>(gobj()));
}
...
Glib::PropertyProxy< int > BoxLayout::property_baseline_child() 
{
  return Glib::PropertyProxy< int >(this, "baseline-child");
}

Glib::PropertyProxy_ReadOnly< int > BoxLayout::property_baseline_child() const
{
  return Glib::PropertyProxy_ReadOnly< int >(this, "baseline-child");
}
