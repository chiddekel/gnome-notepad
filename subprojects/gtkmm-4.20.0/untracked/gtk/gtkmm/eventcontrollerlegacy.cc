...
extern "C" {
static gboolean EventControllerLegacy_signal_event_connect_callback(GtkEventControllerLegacy* self, GdkEvent* p0,void* data)
{
  using namespace Gtk;
...
{
  "event",
  (GCallback) &EventControllerLegacy_signal_event_connect_callback,
