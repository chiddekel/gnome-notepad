...
extern "C" {
static void NativeDialog_signal_response_connect_callback(GtkNativeDialog* self, gint p0,void* data)
{
  using namespace Gtk;
...
{
  "response",
  (GCallback) &NativeDialog_signal_response_connect_callback,
  (GCallback) &NativeDialog_signal_response_connect_callback
};


using NativeDialog_signal_response_functype = void (*)(GtkNativeDialog* self, gint p0);
NativeDialog_signal_response_functype NativeDialog_signal_response_funcptr;
extern "C" {
static void NativeDialog_signal_response_default_callback(GtkNativeDialog* self, gint p0)
{
  NativeDialog_signal_response_funcptr( self, p0);
}
} // extern "C"
} // anonymous namespace
...
void NativeDialog_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->response = &NativeDialog_signal_response_default_callback;
  NativeDialog_signal_response_funcptr = &response_callback;
}
