...
extern "C" {
static void DropControllerMotion_signal_enter_connect_callback(GtkDropControllerMotion* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "enter",
  (GCallback) &DropControllerMotion_signal_enter_connect_callback,
  (GCallback) &DropControllerMotion_signal_enter_connect_callback
};
...
extern "C" {
static void DropControllerMotion_signal_motion_connect_callback(GtkDropControllerMotion* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(double, double)>;
...
{
  "motion",
  (GCallback) &DropControllerMotion_signal_motion_connect_callback,
  (GCallback) &DropControllerMotion_signal_motion_connect_callback
};
