...
extern "C" {
static void FlowBox_signal_child_activated_connect_callback(GtkFlowBox* self, GtkFlowBoxChild* p0,void* data)
{
  using namespace Gtk;
...
{
  "child-activated",
  (GCallback) &FlowBox_signal_child_activated_connect_callback,
  (GCallback) &FlowBox_signal_child_activated_connect_callback
};
...
void FlowBox::remove_all()
{
  gtk_flow_box_remove_all(gobj());
}
