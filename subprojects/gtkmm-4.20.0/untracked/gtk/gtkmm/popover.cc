...
using Popover_signal_closed_functype = void (*)(GtkPopover* self);
Popover_signal_closed_functype Popover_signal_closed_funcptr;
extern "C" {
static void Popover_signal_closed_default_callback(GtkPopover* self)
{
  Popover_signal_closed_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void Popover_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->closed = &Popover_signal_closed_default_callback;
  Popover_signal_closed_funcptr = &closed_callback;
}
