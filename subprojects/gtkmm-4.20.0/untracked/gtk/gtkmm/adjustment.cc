...
using Adjustment_signal_changed_functype = void (*)(GtkAdjustment* self);
Adjustment_signal_changed_functype Adjustment_signal_changed_funcptr;
extern "C" {
static void Adjustment_signal_changed_default_callback(GtkAdjustment* self)
{
  Adjustment_signal_changed_funcptr( self);
}
} // extern "C"
...
using Adjustment_signal_value_changed_functype = void (*)(GtkAdjustment* self);
Adjustment_signal_value_changed_functype Adjustment_signal_value_changed_funcptr;
extern "C" {
static void Adjustment_signal_value_changed_default_callback(GtkAdjustment* self)
{
  Adjustment_signal_value_changed_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void Adjustment_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->changed = &Adjustment_signal_changed_default_callback;
  Adjustment_signal_changed_funcptr = &changed_callback;
  klass->value_changed = &Adjustment_signal_value_changed_default_callback;
  Adjustment_signal_value_changed_funcptr = &value_changed_callback;
}
