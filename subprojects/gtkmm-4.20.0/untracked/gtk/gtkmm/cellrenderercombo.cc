...
extern "C" {
static void CellRendererCombo_signal_changed_connect_callback(GtkCellRendererCombo* self, const gchar* p0,GtkTreeIter* p1,void* data)
{
  using namespace Gtk;
...
{
  "changed",
  (GCallback) &CellRendererCombo_signal_changed_connect_callback,
  (GCallback) &CellRendererCombo_signal_changed_connect_callback
};
