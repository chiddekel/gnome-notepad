...
extern "C" {
static gboolean EntryCompletion_signal_insert_prefix_connect_callback(GtkEntryCompletion* self, const gchar* p0,void* data)
{
  using namespace Gtk;
...
{
  "insert_prefix",
  (GCallback) &EntryCompletion_signal_insert_prefix_connect_callback,
