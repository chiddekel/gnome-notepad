...
extern "C" {
static gboolean Overlay_signal_get_child_position_connect_callback(GtkOverlay* self, GtkWidget* p0,GdkRectangle* p1,void* data)
{
  using namespace Gtk;
...
{
  "get-child-position",
  (GCallback) &Overlay_signal_get_child_position_connect_callback,
