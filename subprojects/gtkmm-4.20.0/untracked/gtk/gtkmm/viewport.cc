...
void Viewport::scroll_to(const Widget& descendant, const Glib::RefPtr<const ScrollInfo>& scroll)
{
  gtk_viewport_scroll_to(gobj(), const_cast<GtkWidget*>((descendant).gobj()), const_cast<GtkScrollInfo*>(Glib::unwrap_copy(scroll)));
}
