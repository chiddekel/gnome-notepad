...
bool FilterListModel::get_watch_items() const
{
  return gtk_filter_list_model_get_watch_items(const_cast<GtkFilterListModel*>(gobj()));
}

void FilterListModel::set_watch_items(bool watch_items)
{
  gtk_filter_list_model_set_watch_items(gobj(), static_cast<int>(watch_items));
}
...
Glib::PropertyProxy< bool > FilterListModel::property_watch_items() 
{
  return Glib::PropertyProxy< bool >(this, "watch-items");
}

Glib::PropertyProxy_ReadOnly< bool > FilterListModel::property_watch_items() const
{
  return Glib::PropertyProxy_ReadOnly< bool >(this, "watch-items");
}
