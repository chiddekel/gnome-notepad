...
using TextView_signal_set_anchor_functype = void (*)(GtkTextView* self);
TextView_signal_set_anchor_functype TextView_signal_set_anchor_funcptr;
extern "C" {
static void TextView_signal_set_anchor_default_callback(GtkTextView* self)
{
  TextView_signal_set_anchor_funcptr( self);
}
} // extern "C"


extern "C" {
static void TextView_signal_insert_at_cursor_connect_callback(GtkTextView* self, const gchar* p0,void* data)
{
  using namespace Gtk;
...
{
  "insert_at_cursor",
  (GCallback) &TextView_signal_insert_at_cursor_connect_callback,
  (GCallback) &TextView_signal_insert_at_cursor_connect_callback
};


using TextView_signal_insert_at_cursor_functype = void (*)(GtkTextView* self, const gchar* p0);
TextView_signal_insert_at_cursor_functype TextView_signal_insert_at_cursor_funcptr;
extern "C" {
static void TextView_signal_insert_at_cursor_default_callback(GtkTextView* self, const gchar* p0)
{
  TextView_signal_insert_at_cursor_funcptr( self, p0);
}
} // extern "C"
} // anonymous namespace
...
void TextView_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->set_anchor = &TextView_signal_set_anchor_default_callback;
  TextView_signal_set_anchor_funcptr = &set_anchor_callback;
  klass->insert_at_cursor = &TextView_signal_insert_at_cursor_default_callback;
  TextView_signal_insert_at_cursor_funcptr = &insert_at_cursor_callback;
}
