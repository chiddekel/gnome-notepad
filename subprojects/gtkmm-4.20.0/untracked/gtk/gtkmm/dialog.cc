...
extern "C" {
static void Dialog_signal_response_connect_callback(GtkDialog* self, gint p0,void* data)
{
  using namespace Gtk;
...
{
  "response",
  (GCallback) &Dialog_signal_response_connect_callback,
  (GCallback) &Dialog_signal_response_connect_callback
};


using Dialog_signal_response_functype = void (*)(GtkDialog* self, gint p0);
Dialog_signal_response_functype Dialog_signal_response_funcptr;
extern "C" {
static void Dialog_signal_response_default_callback(GtkDialog* self, gint p0)
{
  Dialog_signal_response_funcptr( self, p0);
}
} // extern "C"
} // anonymous namespace
...
void Dialog_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->response = &Dialog_signal_response_default_callback;
  Dialog_signal_response_funcptr = &response_callback;
}
