...
extern "C" {
static void GestureLongPress_signal_pressed_connect_callback(GtkGestureLongPress* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "pressed",
  (GCallback) &GestureLongPress_signal_pressed_connect_callback,
  (GCallback) &GestureLongPress_signal_pressed_connect_callback
};
