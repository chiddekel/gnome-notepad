...
extern "C" {
static void TreeModel_signal_row_changed_connect_callback(GtkTreeModel* self, GtkTreePath* p0,GtkTreeIter* p1,void* data)
{
  using namespace Gtk;
...
{
  "row_changed",
  (GCallback) &TreeModel_signal_row_changed_connect_callback,
  (GCallback) &TreeModel_signal_row_changed_connect_callback
};


using TreeModel_signal_row_changed_functype = void (*)(GtkTreeModel* self, GtkTreePath* p0, GtkTreeIter* p1);
TreeModel_signal_row_changed_functype TreeModel_signal_row_changed_funcptr;
extern "C" {
static void TreeModel_signal_row_changed_default_callback(GtkTreeModel* self, GtkTreePath* p0, GtkTreeIter* p1)
{
  TreeModel_signal_row_changed_funcptr( self, p0, p1);
}
} // extern "C"


extern "C" {
static void TreeModel_signal_row_inserted_connect_callback(GtkTreeModel* self, GtkTreePath* p0,GtkTreeIter* p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(const TreeModel::Path&, const TreeModel::iterator&)>;
...
{
  "row_inserted",
  (GCallback) &TreeModel_signal_row_inserted_connect_callback,
  (GCallback) &TreeModel_signal_row_inserted_connect_callback
};


using TreeModel_signal_row_inserted_functype = void (*)(GtkTreeModel* self, GtkTreePath* p0, GtkTreeIter* p1);
TreeModel_signal_row_inserted_functype TreeModel_signal_row_inserted_funcptr;
extern "C" {
static void TreeModel_signal_row_inserted_default_callback(GtkTreeModel* self, GtkTreePath* p0, GtkTreeIter* p1)
{
  TreeModel_signal_row_inserted_funcptr( self, p0, p1);
}
} // extern "C"


extern "C" {
static void TreeModel_signal_row_has_child_toggled_connect_callback(GtkTreeModel* self, GtkTreePath* p0,GtkTreeIter* p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(const TreeModel::Path&, const TreeModel::iterator&)>;
...
static const Glib::SignalProxyInfo TreeModel_signal_row_has_child_toggled_info =
{
  ...
  (GCallback) &TreeModel_signal_row_has_child_toggled_connect_callback,
  (GCallback) &TreeModel_signal_row_has_child_toggled_connect_callback
};


using TreeModel_signal_row_has_child_toggled_functype = void (*)(GtkTreeModel* self, GtkTreePath* p0, GtkTreeIter* p1);
TreeModel_signal_row_has_child_toggled_functype TreeModel_signal_row_has_child_toggled_funcptr;
extern "C" {
static void TreeModel_signal_row_has_child_toggled_default_callback(GtkTreeModel* self, GtkTreePath* p0, GtkTreeIter* p1)
{
  TreeModel_signal_row_has_child_toggled_funcptr( self, p0, p1);
}
} // extern "C"


extern "C" {
static void TreeModel_signal_row_deleted_connect_callback(GtkTreeModel* self, GtkTreePath* p0,void* data)
{
  using namespace Gtk;
...
{
  "row_deleted",
  (GCallback) &TreeModel_signal_row_deleted_connect_callback,
  (GCallback) &TreeModel_signal_row_deleted_connect_callback
};


using TreeModel_signal_row_deleted_functype = void (*)(GtkTreeModel* self, GtkTreePath* p0);
TreeModel_signal_row_deleted_functype TreeModel_signal_row_deleted_funcptr;
extern "C" {
static void TreeModel_signal_row_deleted_default_callback(GtkTreeModel* self, GtkTreePath* p0)
{
  TreeModel_signal_row_deleted_funcptr( self, p0);
}
} // extern "C"


extern "C" {
static void TreeModel_signal_rows_reordered_connect_callback(GtkTreeModel* self, GtkTreePath* p0,GtkTreeIter* p1,gint* p2,void* data)
{
  using namespace Gtk;
...
{
  "rows_reordered",
  (GCallback) &TreeModel_signal_rows_reordered_connect_callback,
  (GCallback) &TreeModel_signal_rows_reordered_connect_callback
};


using TreeModel_signal_rows_reordered_functype = void (*)(GtkTreeModel* self, GtkTreePath* p0, GtkTreeIter* p1, gint* p2);
TreeModel_signal_rows_reordered_functype TreeModel_signal_rows_reordered_funcptr;
extern "C" {
static void TreeModel_signal_rows_reordered_default_callback(GtkTreeModel* self, GtkTreePath* p0, GtkTreeIter* p1, gint* p2)
{
  TreeModel_signal_rows_reordered_funcptr( self, p0, p1, p2);
}
} // extern "C"
using TreeModel_get_flags_vfunc_functype = GtkTreeModelFlags (*)(GtkTreeModel* self);
TreeModel_get_flags_vfunc_functype TreeModel_get_flags_vfunc_funcptr;
extern "C" {
static GtkTreeModelFlags TreeModel_get_flags_vfunc_c_callback(GtkTreeModel* self)
{
  return TreeModel_get_flags_vfunc_funcptr( self);
}
} // extern "C"
using TreeModel_get_n_columns_vfunc_functype = gint (*)(GtkTreeModel* self);
TreeModel_get_n_columns_vfunc_functype TreeModel_get_n_columns_vfunc_funcptr;
extern "C" {
static gint TreeModel_get_n_columns_vfunc_c_callback(GtkTreeModel* self)
{
  return TreeModel_get_n_columns_vfunc_funcptr( self);
}
} // extern "C"
using TreeModel_get_column_type_vfunc_functype = GType (*)(GtkTreeModel* self, gint index);
TreeModel_get_column_type_vfunc_functype TreeModel_get_column_type_vfunc_funcptr;
extern "C" {
static GType TreeModel_get_column_type_vfunc_c_callback(GtkTreeModel* self, gint index)
{
  return TreeModel_get_column_type_vfunc_funcptr( self, index);
}
} // extern "C"
using TreeModel_iter_has_child_vfunc_functype = gboolean (*)(GtkTreeModel* self, GtkTreeIter* iter);
TreeModel_iter_has_child_vfunc_functype TreeModel_iter_has_child_vfunc_funcptr;
extern "C" {
static gboolean TreeModel_iter_has_child_vfunc_c_callback(GtkTreeModel* self, GtkTreeIter* iter)
{
  return TreeModel_iter_has_child_vfunc_funcptr( self, iter);
}
} // extern "C"
using TreeModel_ref_node_vfunc_functype = void (*)(GtkTreeModel* self, GtkTreeIter* iter);
TreeModel_ref_node_vfunc_functype TreeModel_ref_node_vfunc_funcptr;
extern "C" {
static void TreeModel_ref_node_vfunc_c_callback(GtkTreeModel* self, GtkTreeIter* iter)
{
  TreeModel_ref_node_vfunc_funcptr( self, iter);
}
} // extern "C"
using TreeModel_unref_node_vfunc_functype = void (*)(GtkTreeModel* self, GtkTreeIter* iter);
TreeModel_unref_node_vfunc_functype TreeModel_unref_node_vfunc_funcptr;
extern "C" {
static void TreeModel_unref_node_vfunc_c_callback(GtkTreeModel* self, GtkTreeIter* iter)
{
  TreeModel_unref_node_vfunc_funcptr( self, iter);
}
} // extern "C"
using TreeModel_get_path_vfunc_functype = GtkTreePath* (*)(GtkTreeModel* self, GtkTreeIter* iter);
TreeModel_get_path_vfunc_functype TreeModel_get_path_vfunc_funcptr;
extern "C" {
static GtkTreePath* TreeModel_get_path_vfunc_c_callback(GtkTreeModel* self, GtkTreeIter* iter)
{
  return TreeModel_get_path_vfunc_funcptr( self, iter);
}
} // extern "C"
using TreeModel_get_value_vfunc_functype = void (*)(GtkTreeModel* self, GtkTreeIter* iter, gint column, GValue* value);
TreeModel_get_value_vfunc_functype TreeModel_get_value_vfunc_funcptr;
extern "C" {
static void TreeModel_get_value_vfunc_c_callback(GtkTreeModel* self, GtkTreeIter* iter, gint column, GValue* value)
{
  TreeModel_get_value_vfunc_funcptr( self, iter, column, value);
}
} // extern "C"
} // anonymous namespace
...
void TreeModel_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->get_flags = &TreeModel_get_flags_vfunc_c_callback;
  TreeModel_get_flags_vfunc_funcptr = &get_flags_vfunc_callback;
  klass->get_n_columns = &TreeModel_get_n_columns_vfunc_c_callback;
  TreeModel_get_n_columns_vfunc_funcptr = &get_n_columns_vfunc_callback;
  klass->get_column_type = &TreeModel_get_column_type_vfunc_c_callback;
  TreeModel_get_column_type_vfunc_funcptr = &get_column_type_vfunc_callback;
    ...
    klass->iter_has_child = &TreeModel_iter_has_child_vfunc_c_callback;
  TreeModel_iter_has_child_vfunc_funcptr = &iter_has_child_vfunc_callback;
  klass->ref_node = &TreeModel_ref_node_vfunc_c_callback;
  TreeModel_ref_node_vfunc_funcptr = &ref_node_vfunc_callback;
  klass->unref_node = &TreeModel_unref_node_vfunc_c_callback;
  TreeModel_unref_node_vfunc_funcptr = &unref_node_vfunc_callback;
  klass->get_path = &TreeModel_get_path_vfunc_c_callback;
  TreeModel_get_path_vfunc_funcptr = &get_path_vfunc_callback;
  klass->get_value = &TreeModel_get_value_vfunc_c_callback;
  TreeModel_get_value_vfunc_funcptr = &get_value_vfunc_callback;

  klass->row_changed = &TreeModel_signal_row_changed_default_callback;
  TreeModel_signal_row_changed_funcptr = &row_changed_callback;
  klass->row_inserted = &TreeModel_signal_row_inserted_default_callback;
  TreeModel_signal_row_inserted_funcptr = &row_inserted_callback;
  klass->row_has_child_toggled = &TreeModel_signal_row_has_child_toggled_default_callback;
  TreeModel_signal_row_has_child_toggled_funcptr = &row_has_child_toggled_callback;
  klass->row_deleted = &TreeModel_signal_row_deleted_default_callback;
  TreeModel_signal_row_deleted_funcptr = &row_deleted_callback;
  klass->rows_reordered = &TreeModel_signal_rows_reordered_default_callback;
  TreeModel_signal_rows_reordered_funcptr = &rows_reordered_callback;
}
