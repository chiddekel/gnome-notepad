...
public:
  ...
  /** Gets the text that will be used in the context menu of the `Gtk::Entry`
   ...
   * @newin{4,20}
   * 
   * @param icon_pos Either @a GTK_ENTRY_ICON_PRIMARY or @a GTK_ENTRY_ICON_SECONDARY.
   * @return The text that will be used in the menu item,
   * or <tt>nullptr</tt> if no menu item is desired.
   */
  Glib::ustring get_menu_entry_icon_text(IconPosition icon_pos =  IconPosition::PRIMARY) const;
  
  /** Sets the text that will be used in the context menu of the `Gtk::Entry`
   * when the specified icon is activatable. Selecting this item in the menu
   * results, from all aspects, the same than clicking on the specified icon.
   * This greatly simplifies making accessible applications, because the icons
   * aren't focusable when using keyboard navigation. This is why Gtk recommends
   ...
   * 
   * @param icon_pos Either @a GTK_ENTRY_ICON_PRIMARY or @a GTK_ENTRY_ICON_SECONDARY.
   * @param text The text used for the menu item in the context menu, or <tt>nullptr</tt> to not add a menu item.
   */
  void set_menu_entry_icon_text(const Glib::ustring& text, IconPosition icon_pos =  IconPosition::PRIMARY);
...
/** Whether to suggest Emoji replacements for :-delimited names
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< Glib::ustring > property_menu_entry_icon_primary_text() ;
...
/** Text for an item in the context menu to activate the primary icon action.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< Glib::ustring > property_menu_entry_icon_primary_text() const;
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< Glib::ustring > property_menu_entry_icon_secondary_text() ;
...
/** Text for an item in the context menu to activate the secondary icon action.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< Glib::ustring > property_menu_entry_icon_secondary_text() const;
