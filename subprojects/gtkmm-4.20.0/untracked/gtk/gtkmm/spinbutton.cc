...
extern "C" {
static gint SpinButton_signal_input_connect_callback(GtkSpinButton* self, double* p0,void* data)
{
  using namespace Gtk;
...
{
  "input",
  (GCallback) &SpinButton_signal_input_connect_callback,
  (GCallback) &SpinButton_signal_input_notify_callback
};


extern "C" {
static gboolean SpinButton_signal_output_connect_callback(GtkSpinButton* self, void* data)
{
  using namespace Gtk;
...
{
  "output",
  (GCallback) &SpinButton_signal_output_connect_callback,
...
static const Glib::SignalProxyInfo SpinButton_signal_activate_info =
{
  "activate",
  (GCallback) &Glib::SignalProxyNormal::slot0_void_callback,
  (GCallback) &Glib::SignalProxyNormal::slot0_void_callback
...
void SpinButton::set_activates_default(bool activates_default)
{
  gtk_spin_button_set_activates_default(gobj(), static_cast<int>(activates_default));
}

bool SpinButton::get_activates_default() const
{
  return gtk_spin_button_get_activates_default(const_cast<GtkSpinButton*>(gobj()));
}
...
Glib::SignalProxy<void()> SpinButton::signal_activate()
{
  return Glib::SignalProxy<void() >(this, &SpinButton_signal_activate_info);
}


Glib::PropertyProxy< bool > SpinButton::property_activates_default() 
{
  return Glib::PropertyProxy< bool >(this, "activates-default");
}

Glib::PropertyProxy_ReadOnly< bool > SpinButton::property_activates_default() const
{
