...
extern "C" {
static void CellRendererAccel_signal_accel_edited_connect_callback(GtkCellRendererAccel* self, const gchar* p0,guint p1,GdkModifierType p2,guint p3,void* data)
{
  using namespace Gtk;
...
{
  "accel_edited",
  (GCallback) &CellRendererAccel_signal_accel_edited_connect_callback,
  (GCallback) &CellRendererAccel_signal_accel_edited_connect_callback
};


extern "C" {
static void CellRendererAccel_signal_accel_cleared_connect_callback(GtkCellRendererAccel* self, const gchar* p0,void* data)
{
  using namespace Gtk;
...
{
  "accel_cleared",
  (GCallback) &CellRendererAccel_signal_accel_cleared_connect_callback,
  (GCallback) &CellRendererAccel_signal_accel_cleared_connect_callback
};
