...
// static
GType Glib::Value<Gtk::Collation>::value_type()
{
...
void StringSorter::set_collation(Collation collation)
{
  gtk_string_sorter_set_collation(gobj(), static_cast<GtkCollation>(collation));
}

Collation StringSorter::get_collation() const
{
  return static_cast<Collation>(gtk_string_sorter_get_collation(const_cast<GtkStringSorter*>(gobj())));
}
...
static_assert(Glib::Traits::ValueCompatibleWithWrapProperty<Collation>::value,
  "Type Collation cannot be used in _WRAP_PROPERTY. "
  "There is no suitable template specialization of Glib::Value<>.");

Glib::PropertyProxy< Collation > StringSorter::property_collation() 
{
  return Glib::PropertyProxy< Collation >(this, "collation");
}

Glib::PropertyProxy_ReadOnly< Collation > StringSorter::property_collation() const
{
