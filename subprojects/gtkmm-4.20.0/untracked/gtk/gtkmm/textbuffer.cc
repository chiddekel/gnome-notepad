...
extern "C" {
static void TextBuffer_signal_insert_connect_callback(GtkTextBuffer* self, GtkTextIter* p0,const gchar* p1,gint p2,void* data)
{
  using namespace Gtk;
...
{
  "insert_text",
  (GCallback) &TextBuffer_signal_insert_connect_callback,
  (GCallback) &TextBuffer_signal_insert_connect_callback
};


using TextBuffer_signal_insert_text_functype = void (*)(GtkTextBuffer* self, GtkTextIter* p0, const gchar* p1, gint p2);
TextBuffer_signal_insert_text_functype TextBuffer_signal_insert_text_funcptr;
extern "C" {
static void TextBuffer_signal_insert_text_default_callback(GtkTextBuffer* self, GtkTextIter* p0, const gchar* p1, gint p2)
{
  TextBuffer_signal_insert_text_funcptr( self, p0, p1, p2);
}
} // extern "C"


extern "C" {
static void TextBuffer_signal_insert_paintable_connect_callback(GtkTextBuffer* self, GtkTextIter* p0,GdkPaintable* p1,void* data)
{
  using namespace Gtk;
...
{
  "insert_paintable",
  (GCallback) &TextBuffer_signal_insert_paintable_connect_callback,
  (GCallback) &TextBuffer_signal_insert_paintable_connect_callback
};


using TextBuffer_signal_insert_paintable_functype = void (*)(GtkTextBuffer* self, GtkTextIter* p0, GdkPaintable* p1);
TextBuffer_signal_insert_paintable_functype TextBuffer_signal_insert_paintable_funcptr;
extern "C" {
static void TextBuffer_signal_insert_paintable_default_callback(GtkTextBuffer* self, GtkTextIter* p0, GdkPaintable* p1)
{
  TextBuffer_signal_insert_paintable_funcptr( self, p0, p1);
}
} // extern "C"


extern "C" {
static void TextBuffer_signal_insert_child_anchor_connect_callback(GtkTextBuffer* self, GtkTextIter* p0,GtkTextChildAnchor* p1,void* data)
{
  using namespace Gtk;
...
{
  "insert_child_anchor",
  (GCallback) &TextBuffer_signal_insert_child_anchor_connect_callback,
  (GCallback) &TextBuffer_signal_insert_child_anchor_connect_callback
};


using TextBuffer_signal_insert_child_anchor_functype = void (*)(GtkTextBuffer* self, GtkTextIter* p0, GtkTextChildAnchor* p1);
TextBuffer_signal_insert_child_anchor_functype TextBuffer_signal_insert_child_anchor_funcptr;
extern "C" {
static void TextBuffer_signal_insert_child_anchor_default_callback(GtkTextBuffer* self, GtkTextIter* p0, GtkTextChildAnchor* p1)
{
  TextBuffer_signal_insert_child_anchor_funcptr( self, p0, p1);
}
} // extern "C"


extern "C" {
static void TextBuffer_signal_erase_connect_callback(GtkTextBuffer* self, GtkTextIter* p0,GtkTextIter* p1,void* data)
{
  using namespace Gtk;
...
{
  "delete_range",
  (GCallback) &TextBuffer_signal_erase_connect_callback,
  (GCallback) &TextBuffer_signal_erase_connect_callback
};


using TextBuffer_signal_delete_range_functype = void (*)(GtkTextBuffer* self, GtkTextIter* p0, GtkTextIter* p1);
TextBuffer_signal_delete_range_functype TextBuffer_signal_delete_range_funcptr;
extern "C" {
static void TextBuffer_signal_delete_range_default_callback(GtkTextBuffer* self, GtkTextIter* p0, GtkTextIter* p1)
{
  TextBuffer_signal_delete_range_funcptr( self, p0, p1);
}
} // extern "C"
...
using TextBuffer_signal_changed_functype = void (*)(GtkTextBuffer* self);
TextBuffer_signal_changed_functype TextBuffer_signal_changed_funcptr;
extern "C" {
static void TextBuffer_signal_changed_default_callback(GtkTextBuffer* self)
{
  TextBuffer_signal_changed_funcptr( self);
}
} // extern "C"
...
using TextBuffer_signal_modified_changed_functype = void (*)(GtkTextBuffer* self);
TextBuffer_signal_modified_changed_functype TextBuffer_signal_modified_changed_funcptr;
extern "C" {
static void TextBuffer_signal_modified_changed_default_callback(GtkTextBuffer* self)
{
  TextBuffer_signal_modified_changed_funcptr( self);
}
} // extern "C"


extern "C" {
static void TextBuffer_signal_mark_set_connect_callback(GtkTextBuffer* self, const GtkTextIter* p0,GtkTextMark* p1,void* data)
{
  using namespace Gtk;
...
{
  "mark_set",
  (GCallback) &TextBuffer_signal_mark_set_connect_callback,
  (GCallback) &TextBuffer_signal_mark_set_connect_callback
};


using TextBuffer_signal_mark_set_functype = void (*)(GtkTextBuffer* self, const GtkTextIter* p0, GtkTextMark* p1);
TextBuffer_signal_mark_set_functype TextBuffer_signal_mark_set_funcptr;
extern "C" {
static void TextBuffer_signal_mark_set_default_callback(GtkTextBuffer* self, const GtkTextIter* p0, GtkTextMark* p1)
{
  TextBuffer_signal_mark_set_funcptr( self, p0, p1);
}
} // extern "C"


extern "C" {
static void TextBuffer_signal_mark_deleted_connect_callback(GtkTextBuffer* self, GtkTextMark* p0,void* data)
{
  using namespace Gtk;
...
{
  "mark_deleted",
  (GCallback) &TextBuffer_signal_mark_deleted_connect_callback,
  (GCallback) &TextBuffer_signal_mark_deleted_connect_callback
};


using TextBuffer_signal_mark_deleted_functype = void (*)(GtkTextBuffer* self, GtkTextMark* p0);
TextBuffer_signal_mark_deleted_functype TextBuffer_signal_mark_deleted_funcptr;
extern "C" {
static void TextBuffer_signal_mark_deleted_default_callback(GtkTextBuffer* self, GtkTextMark* p0)
{
  TextBuffer_signal_mark_deleted_funcptr( self, p0);
}
} // extern "C"


extern "C" {
static void TextBuffer_signal_apply_tag_connect_callback(GtkTextBuffer* self, GtkTextTag* p0,const GtkTextIter* p1,const GtkTextIter* p2,void* data)
{
  using namespace Gtk;
...
{
  "apply_tag",
  (GCallback) &TextBuffer_signal_apply_tag_connect_callback,
  (GCallback) &TextBuffer_signal_apply_tag_connect_callback
};


using TextBuffer_signal_apply_tag_functype = void (*)(GtkTextBuffer* self, GtkTextTag* p0, const GtkTextIter* p1, const GtkTextIter* p2);
TextBuffer_signal_apply_tag_functype TextBuffer_signal_apply_tag_funcptr;
extern "C" {
static void TextBuffer_signal_apply_tag_default_callback(GtkTextBuffer* self, GtkTextTag* p0, const GtkTextIter* p1, const GtkTextIter* p2)
{
  TextBuffer_signal_apply_tag_funcptr( self, p0, p1, p2);
}
} // extern "C"


extern "C" {
static void TextBuffer_signal_remove_tag_connect_callback(GtkTextBuffer* self, GtkTextTag* p0,const GtkTextIter* p1,const GtkTextIter* p2,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(const Glib::RefPtr<TextBuffer::Tag>&, const TextBuffer::iterator&, const TextBuffer::iterator&)>;
...
{
  "remove_tag",
  (GCallback) &TextBuffer_signal_remove_tag_connect_callback,
  (GCallback) &TextBuffer_signal_remove_tag_connect_callback
};


using TextBuffer_signal_remove_tag_functype = void (*)(GtkTextBuffer* self, GtkTextTag* p0, const GtkTextIter* p1, const GtkTextIter* p2);
TextBuffer_signal_remove_tag_functype TextBuffer_signal_remove_tag_funcptr;
extern "C" {
static void TextBuffer_signal_remove_tag_default_callback(GtkTextBuffer* self, GtkTextTag* p0, const GtkTextIter* p1, const GtkTextIter* p2)
{
  TextBuffer_signal_remove_tag_funcptr( self, p0, p1, p2);
}
} // extern "C"
...
using TextBuffer_signal_begin_user_action_functype = void (*)(GtkTextBuffer* self);
TextBuffer_signal_begin_user_action_functype TextBuffer_signal_begin_user_action_funcptr;
extern "C" {
static void TextBuffer_signal_begin_user_action_default_callback(GtkTextBuffer* self)
{
  TextBuffer_signal_begin_user_action_funcptr( self);
}
} // extern "C"
...
using TextBuffer_signal_end_user_action_functype = void (*)(GtkTextBuffer* self);
TextBuffer_signal_end_user_action_functype TextBuffer_signal_end_user_action_funcptr;
extern "C" {
static void TextBuffer_signal_end_user_action_default_callback(GtkTextBuffer* self)
{
  TextBuffer_signal_end_user_action_funcptr( self);
}
} // extern "C"


extern "C" {
static void TextBuffer_signal_paste_done_connect_callback(GtkTextBuffer* self, GdkClipboard* p0,void* data)
{
  using namespace Gtk;
...
{
  "paste_done",
  (GCallback) &TextBuffer_signal_paste_done_connect_callback,
  (GCallback) &TextBuffer_signal_paste_done_connect_callback
};


using TextBuffer_signal_paste_done_functype = void (*)(GtkTextBuffer* self, GdkClipboard* p0);
TextBuffer_signal_paste_done_functype TextBuffer_signal_paste_done_funcptr;
extern "C" {
static void TextBuffer_signal_paste_done_default_callback(GtkTextBuffer* self, GdkClipboard* p0)
{
  TextBuffer_signal_paste_done_funcptr( self, p0);
}
} // extern "C"
...
using TextBuffer_signal_redo_functype = void (*)(GtkTextBuffer* self);
TextBuffer_signal_redo_functype TextBuffer_signal_redo_funcptr;
extern "C" {
static void TextBuffer_signal_redo_default_callback(GtkTextBuffer* self)
{
  TextBuffer_signal_redo_funcptr( self);
}
} // extern "C"
...
using TextBuffer_signal_undo_functype = void (*)(GtkTextBuffer* self);
TextBuffer_signal_undo_functype TextBuffer_signal_undo_funcptr;
extern "C" {
static void TextBuffer_signal_undo_default_callback(GtkTextBuffer* self)
{
  TextBuffer_signal_undo_funcptr( self);
}
} // extern "C"
} // anonymous namespace

// static
GType Glib::Value<Gtk::TextBuffer::NotifyFlags>::value_type()
{
...
void TextBuffer_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->insert_text = &TextBuffer_signal_insert_text_default_callback;
  TextBuffer_signal_insert_text_funcptr = &insert_text_callback;
  klass->insert_paintable = &TextBuffer_signal_insert_paintable_default_callback;
  TextBuffer_signal_insert_paintable_funcptr = &insert_paintable_callback;
  klass->insert_child_anchor = &TextBuffer_signal_insert_child_anchor_default_callback;
  TextBuffer_signal_insert_child_anchor_funcptr = &insert_child_anchor_callback;
  klass->delete_range = &TextBuffer_signal_delete_range_default_callback;
  TextBuffer_signal_delete_range_funcptr = &delete_range_callback;
  klass->changed = &TextBuffer_signal_changed_default_callback;
  TextBuffer_signal_changed_funcptr = &changed_callback;
  klass->modified_changed = &TextBuffer_signal_modified_changed_default_callback;
  TextBuffer_signal_modified_changed_funcptr = &modified_changed_callback;
  klass->mark_set = &TextBuffer_signal_mark_set_default_callback;
  TextBuffer_signal_mark_set_funcptr = &mark_set_callback;
  klass->mark_deleted = &TextBuffer_signal_mark_deleted_default_callback;
  TextBuffer_signal_mark_deleted_funcptr = &mark_deleted_callback;
  klass->apply_tag = &TextBuffer_signal_apply_tag_default_callback;
  TextBuffer_signal_apply_tag_funcptr = &apply_tag_callback;
  klass->remove_tag = &TextBuffer_signal_remove_tag_default_callback;
  TextBuffer_signal_remove_tag_funcptr = &remove_tag_callback;
  klass->begin_user_action = &TextBuffer_signal_begin_user_action_default_callback;
  TextBuffer_signal_begin_user_action_funcptr = &begin_user_action_callback;
  klass->end_user_action = &TextBuffer_signal_end_user_action_default_callback;
  TextBuffer_signal_end_user_action_funcptr = &end_user_action_callback;
  klass->paste_done = &TextBuffer_signal_paste_done_default_callback;
  TextBuffer_signal_paste_done_funcptr = &paste_done_callback;
  klass->redo = &TextBuffer_signal_redo_default_callback;
  TextBuffer_signal_redo_funcptr = &redo_callback;
  klass->undo = &TextBuffer_signal_undo_default_callback;
  TextBuffer_signal_undo_funcptr = &undo_callback;
}
...
void TextBuffer::remove_commit_notify(guint commit_notify_handler)
{
  gtk_text_buffer_remove_commit_notify(gobj(), commit_notify_handler);
}
