...
bool TreeExpander::get_indent_for_depth() const
{
  return gtk_tree_expander_get_indent_for_depth(const_cast<GtkTreeExpander*>(gobj()));
}

void TreeExpander::set_indent_for_depth(bool indent_for_depth)
{
  gtk_tree_expander_set_indent_for_depth(gobj(), static_cast<int>(indent_for_depth));
}
...
bool TreeExpander::get_hide_expander() const
{
  return gtk_tree_expander_get_hide_expander(const_cast<GtkTreeExpander*>(gobj()));
}

void TreeExpander::set_hide_expander(bool hide_expander)
{
  gtk_tree_expander_set_hide_expander(gobj(), static_cast<int>(hide_expander));
}
...
Glib::PropertyProxy< bool > TreeExpander::property_hide_expander() 
{
  return Glib::PropertyProxy< bool >(this, "hide-expander");
}

Glib::PropertyProxy_ReadOnly< bool > TreeExpander::property_hide_expander() const
{
  return Glib::PropertyProxy_ReadOnly< bool >(this, "hide-expander");
}

Glib::PropertyProxy< bool > TreeExpander::property_indent_for_depth() 
{
  return Glib::PropertyProxy< bool >(this, "indent-for-depth");
}

Glib::PropertyProxy_ReadOnly< bool > TreeExpander::property_indent_for_depth() const
{
