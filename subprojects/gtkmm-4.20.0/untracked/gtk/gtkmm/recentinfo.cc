...
{
  return Glib::wrap(gtk_recent_info_get_added(const_cast<GtkRecentInfo*>(gobj())), true);
}

Glib::DateTime RecentInfo::get_modified() const
{
  return Glib::wrap(gtk_recent_info_get_modified(const_cast<GtkRecentInfo*>(gobj())), true);
}

Glib::DateTime RecentInfo::get_visited() const
{
  return Glib::wrap(gtk_recent_info_get_visited(const_cast<GtkRecentInfo*>(gobj())), true);
}
