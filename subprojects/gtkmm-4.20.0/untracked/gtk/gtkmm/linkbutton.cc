...
extern "C" {
static gboolean LinkButton_signal_activate_link_connect_callback(GtkLinkButton* self, void* data)
{
  using namespace Gtk;
...
{
  "activate-link",
  (GCallback) &LinkButton_signal_activate_link_connect_callback,
