...
bool HeaderBar::get_use_native_controls() const
{
  return gtk_header_bar_get_use_native_controls(const_cast<GtkHeaderBar*>(gobj()));
}

void HeaderBar::set_use_native_controls(bool setting)
{
  gtk_header_bar_set_use_native_controls(gobj(), static_cast<int>(setting));
}
...
Glib::PropertyProxy< bool > HeaderBar::property_use_native_controls() 
{
  return Glib::PropertyProxy< bool >(this, "use-native-controls");
}

Glib::PropertyProxy_ReadOnly< bool > HeaderBar::property_use_native_controls() const
{
