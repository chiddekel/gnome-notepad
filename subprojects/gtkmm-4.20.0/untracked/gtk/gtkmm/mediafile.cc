...
namespace
{
using MediaFile_open_vfunc_functype = void (*)(GtkMediaFile* self);
MediaFile_open_vfunc_functype MediaFile_open_vfunc_funcptr;
extern "C" {
static void MediaFile_open_vfunc_c_callback(GtkMediaFile* self)
{
  MediaFile_open_vfunc_funcptr( self);
}
} // extern "C"
using MediaFile_close_vfunc_functype = void (*)(GtkMediaFile* self);
MediaFile_close_vfunc_functype MediaFile_close_vfunc_funcptr;
extern "C" {
static void MediaFile_close_vfunc_c_callback(GtkMediaFile* self)
{
  MediaFile_close_vfunc_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void MediaFile_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->open = &MediaFile_open_vfunc_c_callback;
  MediaFile_open_vfunc_funcptr = &open_vfunc_callback;
  klass->close = &MediaFile_close_vfunc_c_callback;
  MediaFile_close_vfunc_funcptr = &close_vfunc_callback;
