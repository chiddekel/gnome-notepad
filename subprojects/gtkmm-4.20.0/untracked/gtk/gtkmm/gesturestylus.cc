...
extern "C" {
static void GestureStylus_signal_proximity_connect_callback(GtkGestureStylus* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "proximity",
  (GCallback) &GestureStylus_signal_proximity_connect_callback,
  (GCallback) &GestureStylus_signal_proximity_connect_callback
};


extern "C" {
static void GestureStylus_signal_down_connect_callback(GtkGestureStylus* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(double, double)>;
...
{
  "down",
  (GCallback) &GestureStylus_signal_down_connect_callback,
  (GCallback) &GestureStylus_signal_down_connect_callback
};


extern "C" {
static void GestureStylus_signal_motion_connect_callback(GtkGestureStylus* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(double, double)>;
...
{
  "motion",
  (GCallback) &GestureStylus_signal_motion_connect_callback,
  (GCallback) &GestureStylus_signal_motion_connect_callback
};


extern "C" {
static void GestureStylus_signal_up_connect_callback(GtkGestureStylus* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(double, double)>;
...
{
  "up",
  (GCallback) &GestureStylus_signal_up_connect_callback,
  (GCallback) &GestureStylus_signal_up_connect_callback
};
...
bool GestureStylus::get_stylus_only() const
{
  return gtk_gesture_stylus_get_stylus_only(const_cast<GtkGestureStylus*>(gobj()));
}

void GestureStylus::set_stylus_only(bool stylus_only)
{
  gtk_gesture_stylus_set_stylus_only(gobj(), static_cast<int>(stylus_only));
}
...
Glib::PropertyProxy< bool > GestureStylus::property_stylus_only() 
{
  return Glib::PropertyProxy< bool >(this, "stylus-only");
}

Glib::PropertyProxy_ReadOnly< bool > GestureStylus::property_stylus_only() const
{
