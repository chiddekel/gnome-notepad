...
extern "C" {
static void EntryBuffer_signal_inserted_text_connect_callback(GtkEntryBuffer* self, guint p0,const gchar* p1,guint p2,void* data)
{
  using namespace Gtk;
...
{
  "inserted-text",
  (GCallback) &EntryBuffer_signal_inserted_text_connect_callback,
  (GCallback) &EntryBuffer_signal_inserted_text_connect_callback
};


using EntryBuffer_signal_inserted_text_functype = void (*)(GtkEntryBuffer* self, guint p0, const gchar* p1, guint p2);
EntryBuffer_signal_inserted_text_functype EntryBuffer_signal_inserted_text_funcptr;
extern "C" {
static void EntryBuffer_signal_inserted_text_default_callback(GtkEntryBuffer* self, guint p0, const gchar* p1, guint p2)
{
  EntryBuffer_signal_inserted_text_funcptr( self, p0, p1, p2);
}
} // extern "C"


extern "C" {
static void EntryBuffer_signal_deleted_text_connect_callback(GtkEntryBuffer* self, guint p0,guint p1,void* data)
{
  using namespace Gtk;
...
{
  "deleted-text",
  (GCallback) &EntryBuffer_signal_deleted_text_connect_callback,
  (GCallback) &EntryBuffer_signal_deleted_text_connect_callback
};


using EntryBuffer_signal_deleted_text_functype = void (*)(GtkEntryBuffer* self, guint p0, guint p1);
EntryBuffer_signal_deleted_text_functype EntryBuffer_signal_deleted_text_funcptr;
extern "C" {
static void EntryBuffer_signal_deleted_text_default_callback(GtkEntryBuffer* self, guint p0, guint p1)
{
  EntryBuffer_signal_deleted_text_funcptr( self, p0, p1);
}
} // extern "C"
} // anonymous namespace
...
void EntryBuffer_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->inserted_text = &EntryBuffer_signal_inserted_text_default_callback;
  EntryBuffer_signal_inserted_text_funcptr = &inserted_text_callback;
  klass->deleted_text = &EntryBuffer_signal_deleted_text_default_callback;
  EntryBuffer_signal_deleted_text_funcptr = &deleted_text_callback;
}
