...
extern "C" {
static void ListBox_signal_row_selected_connect_callback(GtkListBox* self, GtkListBoxRow* p0,void* data)
{
  using namespace Gtk;
...
{
  "row-selected",
  (GCallback) &ListBox_signal_row_selected_connect_callback,
  (GCallback) &ListBox_signal_row_selected_connect_callback
};


extern "C" {
static void ListBox_signal_row_activated_connect_callback(GtkListBox* self, GtkListBoxRow* p0,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(ListBoxRow*)>;
...
{
  "row-activated",
  (GCallback) &ListBox_signal_row_activated_connect_callback,
  (GCallback) &ListBox_signal_row_activated_connect_callback
};
...
void ListBox::set_tab_behavior(ListTabBehavior tab_behavior)
{
  gtk_list_box_set_tab_behavior(gobj(), static_cast<GtkListTabBehavior>(tab_behavior));
}

ListTabBehavior ListBox::get_tab_behavior() const
{
  return static_cast<ListTabBehavior>(gtk_list_box_get_tab_behavior(const_cast<GtkListBox*>(gobj())));
}
...
Glib::PropertyProxy< ListTabBehavior > ListBox::property_tab_behavior() 
{
  return Glib::PropertyProxy< ListTabBehavior >(this, "tab-behavior");
}

Glib::PropertyProxy_ReadOnly< ListTabBehavior > ListBox::property_tab_behavior() const
{
