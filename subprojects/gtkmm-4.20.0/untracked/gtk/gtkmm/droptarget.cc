...
extern "C" {
static gboolean DropTarget_signal_accept_connect_callback(GtkDropTarget* self, GdkDrop* p0,void* data)
{
  using namespace Gtk;
...
{
  "accept",
  (GCallback) &DropTarget_signal_accept_connect_callback,
  (GCallback) &DropTarget_signal_accept_notify_callback
};


extern "C" {
static GdkDragAction DropTarget_signal_enter_connect_callback(GtkDropTarget* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "enter",
  (GCallback) &DropTarget_signal_enter_connect_callback,
  (GCallback) &DropTarget_signal_enter_notify_callback
};


extern "C" {
static GdkDragAction DropTarget_signal_motion_connect_callback(GtkDropTarget* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<Gdk::DragAction(double, double)>;
...
{
  "motion",
  (GCallback) &DropTarget_signal_motion_connect_callback,
...
extern "C" {
static gboolean DropTarget_signal_drop_connect_callback(GtkDropTarget* self, const GValue* p0,gdouble p1,gdouble p2,void* data)
{
  using namespace Gtk;
...
{
  "drop",
  (GCallback) &DropTarget_signal_drop_connect_callback,
