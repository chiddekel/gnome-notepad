...
public:
   ...
   */
  Glib::PropertyProxy< InterfaceColorScheme > property_prefers_color_scheme() ;
...
/** Define the color scheme used for rendering the user interface.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< InterfaceColorScheme > property_prefers_color_scheme() const;
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< InterfaceContrast > property_prefers_contrast() ;
...
/** Define the contrast mode to use for the user interface.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< InterfaceContrast > property_prefers_contrast() const;
