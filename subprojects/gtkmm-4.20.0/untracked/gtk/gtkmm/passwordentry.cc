...
static const Glib::SignalProxyInfo PasswordEntry_signal_activate_info =
{
  "activate",
...
Glib::SignalProxy<void()> PasswordEntry::signal_activate()
{
  return Glib::SignalProxy<void() >(this, &PasswordEntry_signal_activate_info);
}
