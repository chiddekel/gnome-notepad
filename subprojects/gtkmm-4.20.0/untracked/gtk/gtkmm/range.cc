...
using Range_signal_value_changed_functype = void (*)(GtkRange* self);
Range_signal_value_changed_functype Range_signal_value_changed_funcptr;
extern "C" {
static void Range_signal_value_changed_default_callback(GtkRange* self)
{
  Range_signal_value_changed_funcptr( self);
}
} // extern "C"


extern "C" {
static void Range_signal_adjust_bounds_connect_callback(GtkRange* self, gdouble p0,void* data)
{
  using namespace Gtk;
...
{
  "adjust_bounds",
  (GCallback) &Range_signal_adjust_bounds_connect_callback,
  (GCallback) &Range_signal_adjust_bounds_connect_callback
};


using Range_signal_adjust_bounds_functype = void (*)(GtkRange* self, gdouble p0);
Range_signal_adjust_bounds_functype Range_signal_adjust_bounds_funcptr;
extern "C" {
static void Range_signal_adjust_bounds_default_callback(GtkRange* self, gdouble p0)
{
  Range_signal_adjust_bounds_funcptr( self, p0);
}
} // extern "C"


extern "C" {
static void Range_signal_move_slider_connect_callback(GtkRange* self, GtkScrollType p0,void* data)
{
  using namespace Gtk;
...
{
  "move_slider",
  (GCallback) &Range_signal_move_slider_connect_callback,
  (GCallback) &Range_signal_move_slider_connect_callback
};


using Range_signal_move_slider_functype = void (*)(GtkRange* self, GtkScrollType p0);
Range_signal_move_slider_functype Range_signal_move_slider_funcptr;
extern "C" {
static void Range_signal_move_slider_default_callback(GtkRange* self, GtkScrollType p0)
{
  Range_signal_move_slider_funcptr( self, p0);
}
} // extern "C"


extern "C" {
static gboolean Range_signal_change_value_connect_callback(GtkRange* self, GtkScrollType p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "change_value",
  (GCallback) &Range_signal_change_value_connect_callback,
  (GCallback) &Range_signal_change_value_notify_callback
};


using Range_signal_change_value_functype = gboolean (*)(GtkRange* self, GtkScrollType p0, gdouble p1);
Range_signal_change_value_functype Range_signal_change_value_funcptr;
extern "C" {
static gboolean Range_signal_change_value_default_callback(GtkRange* self, GtkScrollType p0, gdouble p1)
{
  return Range_signal_change_value_funcptr( self, p0, p1);
}
} // extern "C"
using Range_get_range_border_vfunc_functype = void (*)(GtkRange* self, GtkBorder* border);
Range_get_range_border_vfunc_functype Range_get_range_border_vfunc_funcptr;
extern "C" {
static void Range_get_range_border_vfunc_c_callback(GtkRange* self, GtkBorder* border)
{
  Range_get_range_border_vfunc_funcptr(    self, border);
}
} // extern "C"
} // anonymous namespace
...
void Range_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->get_range_border = &Range_get_range_border_vfunc_c_callback;
  Range_get_range_border_vfunc_funcptr = &get_range_border_vfunc_callback;

  klass->value_changed = &Range_signal_value_changed_default_callback;
  Range_signal_value_changed_funcptr = &value_changed_callback;
  klass->adjust_bounds = &Range_signal_adjust_bounds_default_callback;
  Range_signal_adjust_bounds_funcptr = &adjust_bounds_callback;
  klass->move_slider = &Range_signal_move_slider_default_callback;
  Range_signal_move_slider_funcptr = &move_slider_callback;
  klass->change_value = &Range_signal_change_value_default_callback;
  Range_signal_change_value_funcptr = &change_value_callback;
}
