...
bool WindowControls::get_use_native_controls() const
{
  return gtk_window_controls_get_use_native_controls(const_cast<GtkWindowControls*>(gobj()));
}

void WindowControls::set_use_native_controls(bool setting)
{
  gtk_window_controls_set_use_native_controls(gobj(), static_cast<int>(setting));
}
...
Glib::PropertyProxy< bool > WindowControls::property_use_native_controls() 
{
  return Glib::PropertyProxy< bool >(this, "use-native-controls");
}

Glib::PropertyProxy_ReadOnly< bool > WindowControls::property_use_native_controls() const
{
  return Glib::PropertyProxy_ReadOnly< bool >(this, "use-native-controls");
}
