...
extern "C" {
static void GestureSwipe_signal_swipe_connect_callback(GtkGestureSwipe* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "swipe",
  (GCallback) &GestureSwipe_signal_swipe_connect_callback,
  (GCallback) &GestureSwipe_signal_swipe_connect_callback
};
