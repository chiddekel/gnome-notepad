...
extern "C" {
static void GridView_signal_activate_connect_callback(GtkGridView* self, guint p0,void* data)
{
  using namespace Gtk;
...
{
  "activate",
  (GCallback) &GridView_signal_activate_connect_callback,
  (GCallback) &GridView_signal_activate_connect_callback
};
...
void GridView::set_tab_behavior(ListTabBehavior tab_behavior)
{
  gtk_grid_view_set_tab_behavior(gobj(), static_cast<GtkListTabBehavior>(tab_behavior));
}

ListTabBehavior GridView::get_tab_behavior() const
{
  return static_cast<ListTabBehavior>(gtk_grid_view_get_tab_behavior(const_cast<GtkGridView*>(gobj())));
}
...
void GridView::scroll_to(guint pos, ListScrollFlags flags, const Glib::RefPtr<const ScrollInfo>& scroll)
{
  gtk_grid_view_scroll_to(gobj(), pos, static_cast<GtkListScrollFlags>(flags), const_cast<GtkScrollInfo*>(Glib::unwrap_copy(scroll)));
}
...
Glib::PropertyProxy< ListTabBehavior > GridView::property_tab_behavior() 
{
  return Glib::PropertyProxy< ListTabBehavior >(this, "tab-behavior");
}

Glib::PropertyProxy_ReadOnly< ListTabBehavior > GridView::property_tab_behavior() const
{
