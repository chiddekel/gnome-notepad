...
using Button_signal_clicked_functype = void (*)(GtkButton* self);
Button_signal_clicked_functype Button_signal_clicked_funcptr;
extern "C" {
static void Button_signal_clicked_default_callback(GtkButton* self)
{
  Button_signal_clicked_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void Button_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->clicked = &Button_signal_clicked_default_callback;
  Button_signal_clicked_funcptr = &clicked_callback;
}
...
void Button::set_can_shrink(bool can_shrink)
{
  gtk_button_set_can_shrink(gobj(), static_cast<int>(can_shrink));
}

bool Button::get_can_shrink() const
{
  return gtk_button_get_can_shrink(const_cast<GtkButton*>(gobj()));
}
...
Glib::PropertyProxy< bool > Button::property_can_shrink() 
{
  return Glib::PropertyProxy< bool >(this, "can-shrink");
}

Glib::PropertyProxy_ReadOnly< bool > Button::property_can_shrink() const
{
