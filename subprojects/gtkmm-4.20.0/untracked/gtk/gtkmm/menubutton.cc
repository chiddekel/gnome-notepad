...
static const Glib::SignalProxyInfo MenuButton_signal_activate_info =
{
  "activate",
...
void MenuButton::set_active(bool active)
{
  gtk_menu_button_set_active(gobj(), static_cast<int>(active));
}

bool MenuButton::get_active() const
{
  return gtk_menu_button_get_active(const_cast<GtkMenuButton*>(gobj()));
}

void MenuButton::set_can_chrink(bool can_shrink)
{
  gtk_menu_button_set_can_shrink(gobj(), static_cast<int>(can_shrink));
}

bool MenuButton::get_can_shrink() const
{
  return gtk_menu_button_get_can_shrink(const_cast<GtkMenuButton*>(gobj()));
}


Glib::SignalProxy<void()> MenuButton::signal_activate()
{
  return Glib::SignalProxy<void() >(this, &MenuButton_signal_activate_info);
}
...
Glib::PropertyProxy< bool > MenuButton::property_active() 
{
  return Glib::PropertyProxy< bool >(this, "active");
}

Glib::PropertyProxy_ReadOnly< bool > MenuButton::property_active() const
{
  return Glib::PropertyProxy_ReadOnly< bool >(this, "active");
}

Glib::PropertyProxy< bool > MenuButton::property_can_shrink() 
{
  return Glib::PropertyProxy< bool >(this, "can-shrink");
}

Glib::PropertyProxy_ReadOnly< bool > MenuButton::property_can_shrink() const
{
