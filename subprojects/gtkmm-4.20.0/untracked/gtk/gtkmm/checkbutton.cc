...
using CheckButton_signal_toggled_functype = void (*)(GtkCheckButton* self);
CheckButton_signal_toggled_functype CheckButton_signal_toggled_funcptr;
extern "C" {
static void CheckButton_signal_toggled_default_callback(GtkCheckButton* self)
{
  CheckButton_signal_toggled_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void CheckButton_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->toggled = &CheckButton_signal_toggled_default_callback;
  CheckButton_signal_toggled_funcptr = &toggled_callback;
}
