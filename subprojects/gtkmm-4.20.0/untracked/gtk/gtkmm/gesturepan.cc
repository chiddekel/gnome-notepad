...
extern "C" {
static void GesturePan_signal_pan_connect_callback(GtkGesturePan* self, GtkPanDirection p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "pan",
  (GCallback) &GesturePan_signal_pan_connect_callback,
  (GCallback) &GesturePan_signal_pan_connect_callback
};
