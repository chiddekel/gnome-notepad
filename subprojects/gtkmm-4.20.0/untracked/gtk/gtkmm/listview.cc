...
extern "C" {
static void ListView_signal_activate_connect_callback(GtkListView* self, guint p0,void* data)
{
  using namespace Gtk;
...
{
  "activate",
  (GCallback) &ListView_signal_activate_connect_callback,
  (GCallback) &ListView_signal_activate_connect_callback
};
...
void ListView::set_header_factory(const Glib::RefPtr<ListItemFactory>& factory)
{
  gtk_list_view_set_header_factory(gobj(), Glib::unwrap(factory));
}

Glib::RefPtr<ListItemFactory> ListView::get_header_factory()
{
  auto retvalue = Glib::wrap(gtk_list_view_get_header_factory(gobj()));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}

Glib::RefPtr<const ListItemFactory> ListView::get_header_factory() const
{
  return const_cast<ListView*>(this)->get_header_factory();
}
...
void ListView::set_tab_behavior(ListTabBehavior tab_behavior)
{
  gtk_list_view_set_tab_behavior(gobj(), static_cast<GtkListTabBehavior>(tab_behavior));
}

ListTabBehavior ListView::get_tab_behavior() const
{
  return static_cast<ListTabBehavior>(gtk_list_view_get_tab_behavior(const_cast<GtkListView*>(gobj())));
}

void ListView::scroll_to(guint pos, ListScrollFlags flags, const Glib::RefPtr<const ScrollInfo>& scroll)
{
  gtk_list_view_scroll_to(gobj(), pos, static_cast<GtkListScrollFlags>(flags), const_cast<GtkScrollInfo*>(Glib::unwrap_copy(scroll)));
}
...
Glib::PropertyProxy< Glib::RefPtr<ListItemFactory> > ListView::property_header_factory() 
{
  return Glib::PropertyProxy< Glib::RefPtr<ListItemFactory> >(this, "header-factory");
}

Glib::PropertyProxy_ReadOnly< Glib::RefPtr<ListItemFactory> > ListView::property_header_factory() const
{
...
Glib::PropertyProxy< ListTabBehavior > ListView::property_tab_behavior() 
{
  return Glib::PropertyProxy< ListTabBehavior >(this, "tab-behavior");
}

Glib::PropertyProxy_ReadOnly< ListTabBehavior > ListView::property_tab_behavior() const
{
