...
extern "C" {
static void LevelBar_signal_offset_changed_connect_callback(GtkLevelBar* self, const gchar* p0,void* data)
{
  using namespace Gtk;
...
{
  "offset_changed",
  (GCallback) &LevelBar_signal_offset_changed_connect_callback,
  (GCallback) &LevelBar_signal_offset_changed_connect_callback
};
