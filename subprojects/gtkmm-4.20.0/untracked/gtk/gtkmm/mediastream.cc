...
namespace
{
using MediaStream_play_vfunc_functype = gboolean (*)(GtkMediaStream* self);
MediaStream_play_vfunc_functype MediaStream_play_vfunc_funcptr;
extern "C" {
static gboolean MediaStream_play_vfunc_c_callback(GtkMediaStream* self)
{
  return MediaStream_play_vfunc_funcptr( self);
}
} // extern "C"
using MediaStream_pause_vfunc_functype = void (*)(GtkMediaStream* self);
MediaStream_pause_vfunc_functype MediaStream_pause_vfunc_funcptr;
extern "C" {
static void MediaStream_pause_vfunc_c_callback(GtkMediaStream* self)
{
  MediaStream_pause_vfunc_funcptr( self);
}
} // extern "C"
using MediaStream_seek_vfunc_functype = void (*)(GtkMediaStream* self, gint64 timestamp);
MediaStream_seek_vfunc_functype MediaStream_seek_vfunc_funcptr;
extern "C" {
static void MediaStream_seek_vfunc_c_callback(GtkMediaStream* self, gint64 timestamp)
{
  MediaStream_seek_vfunc_funcptr( self, timestamp);
}
} // extern "C"
using MediaStream_update_audio_vfunc_functype = void (*)(GtkMediaStream* self, gboolean muted, double volume);
MediaStream_update_audio_vfunc_functype MediaStream_update_audio_vfunc_funcptr;
extern "C" {
static void MediaStream_update_audio_vfunc_c_callback(GtkMediaStream* self, gboolean muted, double volume)
{
  MediaStream_update_audio_vfunc_funcptr( self, muted, volume);
}
} // extern "C"
using MediaStream_realize_vfunc_functype = void (*)(GtkMediaStream* self, GdkSurface* surface);
MediaStream_realize_vfunc_functype MediaStream_realize_vfunc_funcptr;
extern "C" {
static void MediaStream_realize_vfunc_c_callback(GtkMediaStream* self, GdkSurface* surface)
{
  MediaStream_realize_vfunc_funcptr( self, surface);
}
} // extern "C"
using MediaStream_unrealize_vfunc_functype = void (*)(GtkMediaStream* self, GdkSurface* surface);
MediaStream_unrealize_vfunc_functype MediaStream_unrealize_vfunc_funcptr;
extern "C" {
static void MediaStream_unrealize_vfunc_c_callback(GtkMediaStream* self, GdkSurface* surface)
{
  MediaStream_unrealize_vfunc_funcptr( self, surface);
}
} // extern "C"
} // anonymous namespace
...
void MediaStream_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->play = &MediaStream_play_vfunc_c_callback;
  MediaStream_play_vfunc_funcptr = &play_vfunc_callback;
  klass->pause = &MediaStream_pause_vfunc_c_callback;
  MediaStream_pause_vfunc_funcptr = &pause_vfunc_callback;
  klass->seek = &MediaStream_seek_vfunc_c_callback;
  MediaStream_seek_vfunc_funcptr = &seek_vfunc_callback;
  klass->update_audio = &MediaStream_update_audio_vfunc_c_callback;
  MediaStream_update_audio_vfunc_funcptr = &update_audio_vfunc_callback;
  klass->realize = &MediaStream_realize_vfunc_c_callback;
  MediaStream_realize_vfunc_funcptr = &realize_vfunc_callback;
  klass->unrealize = &MediaStream_unrealize_vfunc_c_callback;
  MediaStream_unrealize_vfunc_funcptr = &unrealize_vfunc_callback;
