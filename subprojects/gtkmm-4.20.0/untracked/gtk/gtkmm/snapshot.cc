...
Glib::RefPtr<Gdk::Paintable> Snapshot::to_paintable(const Gdk::Graphene::Size& size)
{
  return Glib::wrap(gtk_snapshot_to_paintable(gobj(), (size).gobj()));
}

Glib::RefPtr<Gdk::Paintable> Snapshot::to_paintable()
{
  return Glib::wrap(gtk_snapshot_to_paintable(gobj(), nullptr));
}
...
void Snapshot::push_repeat(const Gdk::Graphene::Rect& bounds, const Gdk::Graphene::Rect& child_bounds)
{
  gtk_snapshot_push_repeat(gobj(), (bounds).gobj(), (child_bounds).gobj());
}

void Snapshot::push_repeat(const Gdk::Graphene::Rect& bounds)
{
  gtk_snapshot_push_repeat(gobj(), (bounds).gobj(), nullptr);
}
...
void Snapshot::push_clip(const Gdk::Graphene::Rect& bounds)
{
  gtk_snapshot_push_clip(gobj(), (bounds).gobj());
}

void Snapshot::push_rounded_clip(const Gsk::RoundedRect& bounds)
{
  gtk_snapshot_push_rounded_clip(gobj(), (bounds).gobj());
}
...
void Snapshot::transform(const Glib::RefPtr<const Gsk::Transform>& transform)
{
  gtk_snapshot_transform(gobj(), const_cast<GskTransform*>(Glib::unwrap(transform)));
}

void Snapshot::translate(const Gdk::Graphene::Point& point)
{
  gtk_snapshot_translate(gobj(), (point).gobj());
}
...
Cairo::RefPtr<Cairo::Context> Snapshot::append_cairo(const Gdk::Graphene::Rect& bounds)
{
  return Gdk::Cairo::wrap(gtk_snapshot_append_cairo(gobj(), (bounds).gobj()));
}
...
void Snapshot::append_texture(const Glib::RefPtr<Gdk::Texture>& texture, const Gdk::Graphene::Rect& bounds)
{
  gtk_snapshot_append_texture(gobj(), Glib::unwrap(texture), (bounds).gobj());
}
...
void Snapshot::append_color(const Gdk::RGBA& color, const Gdk::Graphene::Rect& bounds)
{
  gtk_snapshot_append_color(gobj(), (color).gobj(), (bounds).gobj());
}

void Snapshot::append_inset_shadow(const Gsk::RoundedRect& outline, const Gdk::RGBA& color, float dx, float dy, float spread, float blur_radius)
{
  gtk_snapshot_append_inset_shadow(gobj(), (outline).gobj(), (color).gobj(), dx, dy, spread, blur_radius);
}

void Snapshot::append_outset_shadow(const Gsk::RoundedRect& outline, const Gdk::RGBA& color, float dx, float dy, float spread, float blur_radius)
{
  gtk_snapshot_append_outset_shadow(gobj(), (outline).gobj(), (color).gobj(), dx, dy, spread, blur_radius);
}
...
#ifndef GTKMM_DISABLE_DEPRECATED
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
void Snapshot::render_background(const Glib::RefPtr<StyleContext>& context, double x, double y, double width, double height)
{
  gtk_snapshot_render_background(gobj(), Glib::unwrap(context), x, y, width, height);
}
G_GNUC_END_IGNORE_DEPRECATIONS
