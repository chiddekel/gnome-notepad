...
namespace
{
using Scrollable_get_border_vfunc_functype = gboolean (*)(GtkScrollable* self, GtkBorder* border);
Scrollable_get_border_vfunc_functype Scrollable_get_border_vfunc_funcptr;
extern "C" {
static gboolean Scrollable_get_border_vfunc_c_callback(GtkScrollable* self, GtkBorder* border)
{
  return Scrollable_get_border_vfunc_funcptr( self, border);
}
} // extern "C"
} // anonymous namespace
...
void Scrollable_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->get_border = &Scrollable_get_border_vfunc_c_callback;
  Scrollable_get_border_vfunc_funcptr = &get_border_vfunc_callback;
