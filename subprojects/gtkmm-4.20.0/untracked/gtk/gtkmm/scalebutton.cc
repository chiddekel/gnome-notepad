...
extern "C" {
static void ScaleButton_signal_value_changed_connect_callback(GtkScaleButton* self, gdouble p0,void* data)
{
  using namespace Gtk;
...
{
  "value_changed",
  (GCallback) &ScaleButton_signal_value_changed_connect_callback,
  (GCallback) &ScaleButton_signal_value_changed_connect_callback
};


using ScaleButton_signal_value_changed_functype = void (*)(GtkScaleButton* self, gdouble p0);
ScaleButton_signal_value_changed_functype ScaleButton_signal_value_changed_funcptr;
extern "C" {
static void ScaleButton_signal_value_changed_default_callback(GtkScaleButton* self, gdouble p0)
{
  ScaleButton_signal_value_changed_funcptr( self, p0);
}
} // extern "C"
} // anonymous namespace
...
void ScaleButton_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->value_changed = &ScaleButton_signal_value_changed_default_callback;
  ScaleButton_signal_value_changed_funcptr = &value_changed_callback;
}
...
bool ScaleButton::get_active() const
{
  return gtk_scale_button_get_active(const_cast<GtkScaleButton*>(gobj()));
}

bool ScaleButton::get_has_frame() const
{
  return gtk_scale_button_get_has_frame(const_cast<GtkScaleButton*>(gobj()));
}

void ScaleButton::set_has_frame(bool has_frame)
{
  gtk_scale_button_set_has_frame(gobj(), static_cast<int>(has_frame));
}
...
Glib::PropertyProxy_ReadOnly< bool > ScaleButton::property_active() const
{
  return Glib::PropertyProxy_ReadOnly< bool >(this, "active");
}

Glib::PropertyProxy< bool > ScaleButton::property_has_frame() 
{
  return Glib::PropertyProxy< bool >(this, "has-frame");
}

Glib::PropertyProxy_ReadOnly< bool > ScaleButton::property_has_frame() const
{
