...
extern "C" {
static void ScrolledWindow_signal_edge_overshot_connect_callback(GtkScrolledWindow* self, GtkPositionType p0,void* data)
{
  using namespace Gtk;
...
{
  "edge-overshot",
  (GCallback) &ScrolledWindow_signal_edge_overshot_connect_callback,
  (GCallback) &ScrolledWindow_signal_edge_overshot_connect_callback
};


extern "C" {
static void ScrolledWindow_signal_edge_reached_connect_callback(GtkScrolledWindow* self, GtkPositionType p0,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(Gtk::PositionType)>;
...
{
  "edge-reached",
  (GCallback) &ScrolledWindow_signal_edge_reached_connect_callback,
  (GCallback) &ScrolledWindow_signal_edge_reached_connect_callback
};
