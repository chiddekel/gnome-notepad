...
public:
   ...
   * @newin{4,14}
   * 
   * @param activates_default <tt>true</tt> to activate window’s default widget on activation.
   */
   ...
   * @newin{4,14}
   * 
   * @return <tt>true</tt> if the spin button will activate the default widget.
   */
