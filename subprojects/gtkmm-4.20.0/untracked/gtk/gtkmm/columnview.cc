...
extern "C" {
static void ColumnView_signal_activate_connect_callback(GtkColumnView* self, guint p0,void* data)
{
  using namespace Gtk;
...
{
  "activate",
  (GCallback) &ColumnView_signal_activate_connect_callback,
  (GCallback) &ColumnView_signal_activate_connect_callback
};
...
void ColumnView::set_tab_behavior(ListTabBehavior tab_behavior)
{
  gtk_column_view_set_tab_behavior(gobj(), static_cast<GtkListTabBehavior>(tab_behavior));
}

ListTabBehavior ColumnView::get_tab_behavior() const
{
  return static_cast<ListTabBehavior>(gtk_column_view_get_tab_behavior(const_cast<GtkColumnView*>(gobj())));
}

void ColumnView::set_row_factory(const Glib::RefPtr<ListItemFactory>& factory)
{
  gtk_column_view_set_row_factory(gobj(), Glib::unwrap(factory));
}

Glib::RefPtr<ListItemFactory> ColumnView::get_row_factory()
{
  auto retvalue = Glib::wrap(gtk_column_view_get_row_factory(gobj()));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}

Glib::RefPtr<const ListItemFactory> ColumnView::get_row_factory() const
{
  return const_cast<ColumnView*>(this)->get_row_factory();
}

void ColumnView::set_header_factory(const Glib::RefPtr<ListItemFactory>& factory)
{
  gtk_column_view_set_header_factory(gobj(), Glib::unwrap(factory));
}

Glib::RefPtr<ListItemFactory> ColumnView::get_header_factory()
{
  auto retvalue = Glib::wrap(gtk_column_view_get_header_factory(gobj()));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}

Glib::RefPtr<const ListItemFactory> ColumnView::get_header_factory() const
{
  return const_cast<ColumnView*>(this)->get_header_factory();
}

void ColumnView::scroll_to(guint pos, const Glib::RefPtr<ColumnViewColumn>& column, ListScrollFlags flags, const Glib::RefPtr<const ScrollInfo>& scroll)
{
  gtk_column_view_scroll_to(gobj(), pos, Glib::unwrap(column), static_cast<GtkListScrollFlags>(flags), const_cast<GtkScrollInfo*>(Glib::unwrap_copy(scroll)));
}
...
static_assert(Glib::Traits::ValueCompatibleWithWrapProperty<ListTabBehavior>::value,
  "Type ListTabBehavior cannot be used in _WRAP_PROPERTY. "
  "There is no suitable template specialization of Glib::Value<>.");

Glib::PropertyProxy< ListTabBehavior > ColumnView::property_tab_behavior() 
{
  return Glib::PropertyProxy< ListTabBehavior >(this, "tab-behavior");
}

Glib::PropertyProxy_ReadOnly< ListTabBehavior > ColumnView::property_tab_behavior() const
{
  return Glib::PropertyProxy_ReadOnly< ListTabBehavior >(this, "tab-behavior");
}
...
Glib::PropertyProxy< Glib::RefPtr<ListItemFactory> > ColumnView::property_row_factory() 
{
  return Glib::PropertyProxy< Glib::RefPtr<ListItemFactory> >(this, "row-factory");
}

Glib::PropertyProxy_ReadOnly< Glib::RefPtr<ListItemFactory> > ColumnView::property_row_factory() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::RefPtr<ListItemFactory> >(this, "row-factory");
}
...
Glib::PropertyProxy< Glib::RefPtr<ListItemFactory> > ColumnView::property_header_factory() 
{
  return Glib::PropertyProxy< Glib::RefPtr<ListItemFactory> >(this, "header-factory");
}

Glib::PropertyProxy_ReadOnly< Glib::RefPtr<ListItemFactory> > ColumnView::property_header_factory() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::RefPtr<ListItemFactory> >(this, "header-factory");
}
