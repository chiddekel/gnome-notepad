...
extern "C" {
static void AppChooserButton_signal_custom_item_activated_connect_callback(GtkAppChooserButton* self, const gchar* p0,void* data)
{
  using namespace Gtk;
...
static const Glib::SignalProxyInfo AppChooserButton_signal_custom_item_activated_info =
{
  ...
  (GCallback) &AppChooserButton_signal_custom_item_activated_connect_callback,
  (GCallback) &AppChooserButton_signal_custom_item_activated_connect_callback
};
