...
namespace
{
using Frame_compute_child_allocation_vfunc_functype = void (*)(GtkFrame* self, GtkAllocation* allocation);
Frame_compute_child_allocation_vfunc_functype Frame_compute_child_allocation_vfunc_funcptr;
extern "C" {
static void Frame_compute_child_allocation_vfunc_c_callback(GtkFrame* self, GtkAllocation* allocation)
{
  Frame_compute_child_allocation_vfunc_funcptr( self, allocation);
}
} // extern "C"
} // anonymous namespace
...
void Frame_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->compute_child_allocation = &Frame_compute_child_allocation_vfunc_c_callback;
  Frame_compute_child_allocation_vfunc_funcptr = &compute_child_allocation_vfunc_callback;
