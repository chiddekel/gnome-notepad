...
extern "C" {
static void IconView_signal_item_activated_connect_callback(GtkIconView* self, GtkTreePath* p0,void* data)
{
  using namespace Gtk;
...
{
  "item_activated",
  (GCallback) &IconView_signal_item_activated_connect_callback,
  (GCallback) &IconView_signal_item_activated_connect_callback
};
