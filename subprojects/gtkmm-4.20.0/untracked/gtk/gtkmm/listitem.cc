...
bool ListItem::get_focusable() const
{
  return gtk_list_item_get_focusable(const_cast<GtkListItem*>(gobj()));
}

void ListItem::set_focusable(bool focusable)
{
  gtk_list_item_set_focusable(gobj(), static_cast<int>(focusable));
}
...
void ListItem::gtk_set_accessible_description(const Glib::ustring& description)
{
  gtk_list_item_set_accessible_description(gobj(), description.c_str());
}

Glib::ustring ListItem::get_accessible_description() const
{
  return Glib::convert_const_gchar_ptr_to_ustring(gtk_list_item_get_accessible_description(const_cast<GtkListItem*>(gobj())));
}

void ListItem::gtk_set_accessible_label(const Glib::ustring& label)
{
  gtk_list_item_set_accessible_label(gobj(), label.c_str());
}

Glib::ustring ListItem::get_accessible_label() const
{
  return Glib::convert_const_gchar_ptr_to_ustring(gtk_list_item_get_accessible_label(const_cast<GtkListItem*>(gobj())));
}


Glib::PropertyProxy< Glib::ustring > ListItem::property_accessible_description() 
{
  return Glib::PropertyProxy< Glib::ustring >(this, "accessible-description");
}

Glib::PropertyProxy_ReadOnly< Glib::ustring > ListItem::property_accessible_description() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::ustring >(this, "accessible-description");
}

Glib::PropertyProxy< Glib::ustring > ListItem::property_accessible_label() 
{
  return Glib::PropertyProxy< Glib::ustring >(this, "accessible-label");
}

Glib::PropertyProxy_ReadOnly< Glib::ustring > ListItem::property_accessible_label() const
{
...
Glib::PropertyProxy< bool > ListItem::property_focusable() 
{
  return Glib::PropertyProxy< bool >(this, "focusable");
}

Glib::PropertyProxy_ReadOnly< bool > ListItem::property_focusable() const
{
