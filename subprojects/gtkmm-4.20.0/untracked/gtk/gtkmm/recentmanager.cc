...
using RecentManager_signal_changed_functype = void (*)(GtkRecentManager* self);
RecentManager_signal_changed_functype RecentManager_signal_changed_funcptr;
extern "C" {
static void RecentManager_signal_changed_default_callback(GtkRecentManager* self)
{
  RecentManager_signal_changed_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void RecentManager_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->changed = &RecentManager_signal_changed_default_callback;
  RecentManager_signal_changed_funcptr = &changed_callback;
}
