...
{
  gtk_calendar_set_day(gobj(), day);
}

int Calendar::get_day() const
{
  return gtk_calendar_get_day(const_cast<GtkCalendar*>(gobj()));
}

void Calendar::set_month(int month)
{
  gtk_calendar_set_month(gobj(), month);
}

int Calendar::get_month() const
{
  return gtk_calendar_get_month(const_cast<GtkCalendar*>(gobj()));
}

void Calendar::set_year(int year)
{
  gtk_calendar_set_year(gobj(), year);
}

int Calendar::get_year() const
{
  return gtk_calendar_get_year(const_cast<GtkCalendar*>(gobj()));
}

void Calendar::set_date(const Glib::DateTime& day)
{
  gtk_calendar_set_date(gobj(), const_cast<GDateTime*>(day.gobj()));
}
...
Glib::PropertyProxy< Glib::DateTime > Calendar::property_date() 
{
  return Glib::PropertyProxy< Glib::DateTime >(this, "date");
}

Glib::PropertyProxy_ReadOnly< Glib::DateTime > Calendar::property_date() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::DateTime >(this, "date");
}
