...
extern "C" {
static void SelectionModel_signal_selection_changed_connect_callback(GtkSelectionModel* self, guint p0,guint p1,void* data)
{
  using namespace Gtk;
...
{
  "selection-changed",
  (GCallback) &SelectionModel_signal_selection_changed_connect_callback,
  (GCallback) &SelectionModel_signal_selection_changed_connect_callback
};


using SelectionModel_is_selected_vfunc_functype = gboolean (*)(GtkSelectionModel* self, guint position);
SelectionModel_is_selected_vfunc_functype SelectionModel_is_selected_vfunc_funcptr;
extern "C" {
static gboolean SelectionModel_is_selected_vfunc_c_callback(GtkSelectionModel* self, guint position)
{
  return SelectionModel_is_selected_vfunc_funcptr( self, position);
}
} // extern "C"
using SelectionModel_get_selection_in_range_vfunc_functype = GtkBitset* (*)(GtkSelectionModel* self, guint position, guint n_items);
SelectionModel_get_selection_in_range_vfunc_functype SelectionModel_get_selection_in_range_vfunc_funcptr;
extern "C" {
static GtkBitset* SelectionModel_get_selection_in_range_vfunc_c_callback(GtkSelectionModel* self, guint position, guint n_items)
{
  return SelectionModel_get_selection_in_range_vfunc_funcptr( self, position, n_items);
}
} // extern "C"
using SelectionModel_select_item_vfunc_functype = gboolean (*)(GtkSelectionModel* self, guint position, gboolean unselect_rest);
SelectionModel_select_item_vfunc_functype SelectionModel_select_item_vfunc_funcptr;
extern "C" {
static gboolean SelectionModel_select_item_vfunc_c_callback(GtkSelectionModel* self, guint position, gboolean unselect_rest)
{
  return SelectionModel_select_item_vfunc_funcptr( self, position, unselect_rest);
}
} // extern "C"
using SelectionModel_unselect_item_vfunc_functype = gboolean (*)(GtkSelectionModel* self, guint position);
SelectionModel_unselect_item_vfunc_functype SelectionModel_unselect_item_vfunc_funcptr;
extern "C" {
static gboolean SelectionModel_unselect_item_vfunc_c_callback(GtkSelectionModel* self, guint position)
{
  return SelectionModel_unselect_item_vfunc_funcptr( self, position);
}
} // extern "C"
using SelectionModel_select_range_vfunc_functype = gboolean (*)(GtkSelectionModel* self, guint position, guint n_items, gboolean unselect_rest);
SelectionModel_select_range_vfunc_functype SelectionModel_select_range_vfunc_funcptr;
extern "C" {
static gboolean SelectionModel_select_range_vfunc_c_callback(GtkSelectionModel* self, guint position, guint n_items, gboolean unselect_rest)
{
  return SelectionModel_select_range_vfunc_funcptr( self, position, n_items, unselect_rest);
}
} // extern "C"
using SelectionModel_unselect_range_vfunc_functype = gboolean (*)(GtkSelectionModel* self, guint position, guint n_items);
SelectionModel_unselect_range_vfunc_functype SelectionModel_unselect_range_vfunc_funcptr;
extern "C" {
static gboolean SelectionModel_unselect_range_vfunc_c_callback(GtkSelectionModel* self, guint position, guint n_items)
{
  return SelectionModel_unselect_range_vfunc_funcptr( self, position, n_items);
}
} // extern "C"
using SelectionModel_select_all_vfunc_functype = gboolean (*)(GtkSelectionModel* self);
SelectionModel_select_all_vfunc_functype SelectionModel_select_all_vfunc_funcptr;
extern "C" {
static gboolean SelectionModel_select_all_vfunc_c_callback(GtkSelectionModel* self)
{
  return SelectionModel_select_all_vfunc_funcptr( self);
}
} // extern "C"
using SelectionModel_unselect_all_vfunc_functype = gboolean (*)(GtkSelectionModel* self);
SelectionModel_unselect_all_vfunc_functype SelectionModel_unselect_all_vfunc_funcptr;
extern "C" {
static gboolean SelectionModel_unselect_all_vfunc_c_callback(GtkSelectionModel* self)
{
  return SelectionModel_unselect_all_vfunc_funcptr( self);
}
} // extern "C"
using SelectionModel_set_selection_vfunc_functype = gboolean (*)(GtkSelectionModel* self, GtkBitset* selected, GtkBitset* mask);
SelectionModel_set_selection_vfunc_functype SelectionModel_set_selection_vfunc_funcptr;
extern "C" {
static gboolean SelectionModel_set_selection_vfunc_c_callback(GtkSelectionModel* self, GtkBitset* selected, GtkBitset* mask)
{
  return SelectionModel_set_selection_vfunc_funcptr( self, selected, mask);
}
} // extern "C"
} // anonymous namespace
...
void SelectionModel_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->is_selected = &SelectionModel_is_selected_vfunc_c_callback;
  SelectionModel_is_selected_vfunc_funcptr = &is_selected_vfunc_callback;
  klass->get_selection_in_range = &SelectionModel_get_selection_in_range_vfunc_c_callback;
  SelectionModel_get_selection_in_range_vfunc_funcptr = &get_selection_in_range_vfunc_callback;
  klass->select_item = &SelectionModel_select_item_vfunc_c_callback;
  SelectionModel_select_item_vfunc_funcptr = &select_item_vfunc_callback;
  klass->unselect_item = &SelectionModel_unselect_item_vfunc_c_callback;
  SelectionModel_unselect_item_vfunc_funcptr = &unselect_item_vfunc_callback;
  klass->select_range = &SelectionModel_select_range_vfunc_c_callback;
  SelectionModel_select_range_vfunc_funcptr = &select_range_vfunc_callback;
  klass->unselect_range = &SelectionModel_unselect_range_vfunc_c_callback;
  SelectionModel_unselect_range_vfunc_funcptr = &unselect_range_vfunc_callback;
  klass->select_all = &SelectionModel_select_all_vfunc_c_callback;
  SelectionModel_select_all_vfunc_funcptr = &select_all_vfunc_callback;
  klass->unselect_all = &SelectionModel_unselect_all_vfunc_c_callback;
  SelectionModel_unselect_all_vfunc_funcptr = &unselect_all_vfunc_callback;
  klass->set_selection = &SelectionModel_set_selection_vfunc_c_callback;
  SelectionModel_set_selection_vfunc_funcptr = &set_selection_vfunc_callback;
