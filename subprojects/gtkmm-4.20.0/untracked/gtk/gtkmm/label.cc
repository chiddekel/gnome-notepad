...
extern "C" {
static gboolean Label_signal_activate_link_connect_callback(GtkLabel* self, const gchar* p0,void* data)
{
  using namespace Gtk;
...
{
  "activate-link",
  (GCallback) &Label_signal_activate_link_connect_callback,
