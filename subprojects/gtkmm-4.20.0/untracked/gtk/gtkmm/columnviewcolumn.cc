...
void ColumnViewColumn::set_id(const Glib::ustring& id)
{
  gtk_column_view_column_set_id(gobj(), id.c_str());
}

Glib::ustring ColumnViewColumn::get_id() const
{
  return Glib::convert_const_gchar_ptr_to_ustring(gtk_column_view_column_get_id(const_cast<GtkColumnViewColumn*>(gobj())));
}
...
Glib::PropertyProxy< Glib::ustring > ColumnViewColumn::property_id() 
{
  return Glib::PropertyProxy< Glib::ustring >(this, "id");
}

Glib::PropertyProxy_ReadOnly< Glib::ustring > ColumnViewColumn::property_id() const
{
