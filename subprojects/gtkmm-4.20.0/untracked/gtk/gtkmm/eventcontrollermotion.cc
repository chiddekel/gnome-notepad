...
extern "C" {
static void EventControllerMotion_signal_enter_connect_callback(GtkEventControllerMotion* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
...
{
  "enter",
  (GCallback) &EventControllerMotion_signal_enter_connect_callback,
  (GCallback) &EventControllerMotion_signal_enter_connect_callback
};
...
extern "C" {
static void EventControllerMotion_signal_motion_connect_callback(GtkEventControllerMotion* self, gdouble p0,gdouble p1,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot<void(double, double)>;
...
{
  "motion",
  (GCallback) &EventControllerMotion_signal_motion_connect_callback,
  (GCallback) &EventControllerMotion_signal_motion_connect_callback
};
