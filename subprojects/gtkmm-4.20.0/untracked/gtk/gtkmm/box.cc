...
void Box::set_baseline_child(int child)
{
  gtk_box_set_baseline_child(gobj(), child);
}

int Box::get_baseline_child() const
{
  return gtk_box_get_baseline_child(const_cast<GtkBox*>(gobj()));
}
...
Glib::PropertyProxy< int > Box::property_baseline_child() 
{
  return Glib::PropertyProxy< int >(this, "baseline-child");
}

Glib::PropertyProxy_ReadOnly< int > Box::property_baseline_child() const
{
