...
public:
  ...
  /** Sets the transformation for @a widget.
   * 
   * This is a convenience function that retrieves the
   * Gtk::FixedLayoutChild instance associated to
   *  @a widget and calls Gtk::FixedLayoutChild::set_transform().
   * 
   * @newin{4,20}
   * 
   * @param widget A `Gtk::Widget`, child of @a fixed.
   * @param transform The transformation assigned to @a widget
   * to reset @a widget's transform.
   */
  void set_child_transform(Widget& widget, const Glib::RefPtr<const Gsk::Transform>& transform);
  
  /** Retrieves the transformation for @a widget set using
   * set_child_transform().
   * 
   * @newin{4,20}
   * 
   ...
   */
  Glib::RefPtr<Gsk::Transform> get_child_transform(Widget& widget) const;
