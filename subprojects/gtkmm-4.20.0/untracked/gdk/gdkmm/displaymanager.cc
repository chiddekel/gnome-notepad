...
extern "C" {
static void DisplayManager_signal_display_opened_connect_callback(GdkDisplayManager* self, GdkDisplay* p0,void* data)
{
  using namespace Gdk;
...
{
  "display-opened",
  (GCallback) &DisplayManager_signal_display_opened_connect_callback,
  (GCallback) &DisplayManager_signal_display_opened_connect_callback
};
