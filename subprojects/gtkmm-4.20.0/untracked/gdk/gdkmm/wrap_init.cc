...
#include "dmabuftexturebuilder.h"
#include "drag.h"
#include "dragsurface.h"
#include "dragsurfacesize.h"
...
#include "graphene_point.h"
#include "graphene_rect.h"
#include "graphene_size.h"
#include "memorytexture.h"
#include "memorytexturebuilder.h"
#include "monitor.h"
#include "paintable.h"
#include "pixbuf.h"
...
class CicpParams_Class { public: static Glib::ObjectBase* wrap_new(GObject*); };
...
class DmabufTexture_Class { public: static Glib::ObjectBase* wrap_new(GObject*); };
class DmabufTextureBuilder_Class { public: static Glib::ObjectBase* wrap_new(GObject*); };
...
class GLTextureBuilder_Class { public: static Glib::ObjectBase* wrap_new(GObject*); };
class MemoryTexture_Class { public: static Glib::ObjectBase* wrap_new(GObject*); };
class MemoryTextureBuilder_Class { public: static Glib::ObjectBase* wrap_new(GObject*); };
...
void wrap_init()
{
  ...
  Glib::Error::register_domain(gdk_dmabuf_error_quark(), &DmabufError::throw_func);
  ...
  Glib::wrap_register(gdk_cicp_params_get_type(), &CicpParams_Class::wrap_new);
  ...
  Glib::wrap_register(gdk_dmabuf_texture_get_type(), &DmabufTexture_Class::wrap_new);
  Glib::wrap_register(gdk_dmabuf_texture_builder_get_type(), &DmabufTextureBuilder_Class::wrap_new);
  ...
  Glib::wrap_register(gdk_gl_texture_builder_get_type(), &GLTextureBuilder_Class::wrap_new);
  Glib::wrap_register(gdk_memory_texture_get_type(), &MemoryTexture_Class::wrap_new);
  Glib::wrap_register(gdk_memory_texture_builder_get_type(), &MemoryTextureBuilder_Class::wrap_new);
  ...
  g_type_ensure(CicpParams::get_type());
  ...
  g_type_ensure(DmabufTexture::get_type());
  g_type_ensure(DmabufTextureBuilder::get_type());
  ...
  g_type_ensure(GLTextureBuilder::get_type());
  g_type_ensure(MemoryTexture::get_type());
  g_type_ensure(MemoryTextureBuilder::get_type());
