...
extern "C" {
static void Device_signal_tool_changed_connect_callback(GdkDevice* self, GdkDeviceTool* p0,void* data)
{
  using namespace Gdk;
...
{
  "tool-changed",
  (GCallback) &Device_signal_tool_changed_connect_callback,
  (GCallback) &Device_signal_tool_changed_connect_callback
};
...
int Device::get_active_layout_index() const
{
  return gdk_device_get_active_layout_index(const_cast<GdkDevice*>(gobj()));
}

std::vector<Glib::ustring> Device::get_layout_names() const
{
  return Glib::ArrayHandler<Glib::ustring>::array_to_vector(gdk_device_get_layout_names(const_cast<GdkDevice*>(gobj())), Glib::OWNERSHIP_DEEP);
}
...
Glib::PropertyProxy_ReadOnly< int > Device::property_active_layout_index() const
{
  return Glib::PropertyProxy_ReadOnly< int >(this, "active-layout-index");
}
...
Glib::PropertyProxy_ReadOnly< std::vector<Glib::ustring> > Device::property_layout_names() const
{
  return Glib::PropertyProxy_ReadOnly< std::vector<Glib::ustring> >(this, "layout-names");
}
