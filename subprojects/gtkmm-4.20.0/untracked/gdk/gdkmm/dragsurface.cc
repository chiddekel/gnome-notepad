...
static const Glib::SignalProxyInfo DragSurface_signal_compute_size_info =
{
  "compute-size",
  (GCallback) &DragSurface_signal_compute_size_callback,
  (GCallback) &DragSurface_signal_compute_size_callback
};
...
Glib::SignalProxy<void(DragSurfaceSize&)> DragSurface::signal_compute_size()
{
  return Glib::SignalProxy<void(DragSurfaceSize&) >(this, &DragSurface_signal_compute_size_info);
}
