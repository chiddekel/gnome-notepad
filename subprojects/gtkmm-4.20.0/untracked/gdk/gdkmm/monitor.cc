...
double Monitor::get_scale() const
{
  return gdk_monitor_get_scale(const_cast<GdkMonitor*>(gobj()));
}
...
Glib::ustring Monitor::get_description() const
{
  return Glib::convert_const_gchar_ptr_to_ustring(gdk_monitor_get_description(const_cast<GdkMonitor*>(gobj())));
}
...
Glib::PropertyProxy_ReadOnly< Glib::ustring > Monitor::property_description() const
{
...
Glib::PropertyProxy_ReadOnly< double > Monitor::property_scale() const
{
