...
public:
   ...
   * Gdk::Drag::action_is_unique() returns false for the result -
   ...
   * 
   * @param actions Supported actions of the destination, or `Gdk::DragAction::NONE` to
   ...
   * 
   * @param action The action performed by the destination or `Gdk::DragAction::NONE` if the
   * drop failed.
   */
