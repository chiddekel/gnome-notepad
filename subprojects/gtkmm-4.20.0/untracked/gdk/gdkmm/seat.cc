...
extern "C" {
static void Seat_signal_device_added_connect_callback(GdkSeat* self, GdkDevice* p0,void* data)
{
  using namespace Gdk;
...
{
  "device-added",
  (GCallback) &Seat_signal_device_added_connect_callback,
  (GCallback) &Seat_signal_device_added_connect_callback
};


extern "C" {
static void Seat_signal_device_removed_connect_callback(GdkSeat* self, GdkDevice* p0,void* data)
{
  using namespace Gdk;
  using SlotType = sigc::slot<void(const Glib::RefPtr<Device>&)>;
...
{
  "device-removed",
  (GCallback) &Seat_signal_device_removed_connect_callback,
  (GCallback) &Seat_signal_device_removed_connect_callback
};


extern "C" {
static void Seat_signal_tool_added_connect_callback(GdkSeat* self, GdkDeviceTool* p0,void* data)
{
  using namespace Gdk;
...
{
  "tool-added",
  (GCallback) &Seat_signal_tool_added_connect_callback,
  (GCallback) &Seat_signal_tool_added_connect_callback
};


extern "C" {
static void Seat_signal_tool_removed_connect_callback(GdkSeat* self, GdkDeviceTool* p0,void* data)
{
  using namespace Gdk;
  using SlotType = sigc::slot<void(const Glib::RefPtr<DeviceTool>&)>;
...
{
  "tool-removed",
  (GCallback) &Seat_signal_tool_removed_connect_callback,
  (GCallback) &Seat_signal_tool_removed_connect_callback
};
