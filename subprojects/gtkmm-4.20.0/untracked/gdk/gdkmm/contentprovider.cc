...
using ContentProvider_signal_content_changed_functype = void (*)(GdkContentProvider* self);
ContentProvider_signal_content_changed_functype ContentProvider_signal_content_changed_funcptr;
extern "C" {
static void ContentProvider_signal_content_changed_default_callback(GdkContentProvider* self)
{
  ContentProvider_signal_content_changed_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void ContentProvider_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->content_changed = &ContentProvider_signal_content_changed_default_callback;
  ContentProvider_signal_content_changed_funcptr = &content_changed_callback;
}
...
void ContentProvider::write_mime_type_async(const Glib::ustring& mime_type, const Glib::RefPtr<Gio::OutputStream>& stream, int io_priority, const Gio::SlotAsyncReady& slot, const Glib::RefPtr<Gio::Cancellable>& cancellable) const
{
  ...
  gdk_content_provider_write_mime_type_async(const_cast<GdkContentProvider*>(gobj()), mime_type.c_str(), Glib::unwrap(stream), io_priority, const_cast<GCancellable*>(Glib::unwrap(cancellable)), &gdkmm_SignalProxy_async_callback, slot_copy);
}
...
void ContentProvider::write_mime_type_async(const Glib::ustring& mime_type, const Glib::RefPtr<Gio::OutputStream>& stream, int io_priority, const Gio::SlotAsyncReady& slot) const
{
  ...
  gdk_content_provider_write_mime_type_async(const_cast<GdkContentProvider*>(gobj()), mime_type.c_str(), Glib::unwrap(stream), io_priority, nullptr, &gdkmm_SignalProxy_async_callback, slot_copy);
}
