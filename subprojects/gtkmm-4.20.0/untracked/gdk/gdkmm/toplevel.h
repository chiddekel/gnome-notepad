...
/** 
 *  @var TitlebarGesture::DOUBLE_CLICK
 * Double click gesture.
 * 
 *  @var TitlebarGesture::RIGHT_CLICK
 * Right click gesture.
 * 
 *  @var TitlebarGesture::MIDDLE_CLICK
...
template <>
class GDKMM_API Value<Gdk::TitlebarGesture> : public Glib::Value_Enum<Gdk::TitlebarGesture>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
public:
   ...
   * @ingroup gdkmmEnums
   * @par Bitwise operators:
   * <tt>Toplevel::Capabilities operator|(Toplevel::Capabilities, Toplevel::Capabilities)</tt><br>
   * <tt>Toplevel::Capabilities operator&(Toplevel::Capabilities, Toplevel::Capabilities)</tt><br>
   * <tt>Toplevel::Capabilities operator^(Toplevel::Capabilities, Toplevel::Capabilities)</tt><br>
   * <tt>Toplevel::Capabilities operator~(Toplevel::Capabilities)</tt><br>
   * <tt>Toplevel::Capabilities& operator|=(Toplevel::Capabilities&, Toplevel::Capabilities)</tt><br>
   * <tt>Toplevel::Capabilities& operator&=(Toplevel::Capabilities&, Toplevel::Capabilities)</tt><br>
   * <tt>Toplevel::Capabilities& operator^=(Toplevel::Capabilities&, Toplevel::Capabilities)</tt><br>
   */
  ...
  {
    EDGE_CONSTRAINTS = 1 << 0,
    INHIBIT_SHORTCUTS = 1 << 1,
    TITLEBAR_GESTURES = 1 << 2,
    WINDOW_MENU = 1 << 3,
    MAXIMIZE = 1 << 4,
    FULLSCREEN = 1 << 5,
    MINIMIZE = 1 << 6,
   ...
   * @newin{4,20}
   * 
   * @param gesture A `Gdk::TitlebarGesture`.
   * @return Whether the gesture was performed.
   */
  bool titlebar_gesture(TitlebarGesture gesture);
...
/** The fullscreen mode of the surface.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< Capabilities > property_capabilities() const;
   ...
   * For example, a gravity of `Gdk::Gravity::NORTH_EAST` means that we
   ...
   * resizes started with Gdk::Toplevel::begin_resize().
   * 
   * @newin{4,20}
   *
   * Default value: Gdk::Gravity::NORTH_EAST
   *
   * @return A PropertyProxy that allows you to get or set the value of the property,
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< Gravity > property_gravity() ;
...
/** The gravity to use when resizing a surface programmatically.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< Gravity > property_gravity() const;
...
/** @ingroup gdkmmEnums */
inline constexpr Toplevel::Capabilities operator|(Toplevel::Capabilities lhs, Toplevel::Capabilities rhs)
  { return static_cast<Toplevel::Capabilities>(static_cast<unsigned>(lhs) | static_cast<unsigned>(rhs)); }
...
/** @ingroup gdkmmEnums */
inline constexpr Toplevel::Capabilities operator~(Toplevel::Capabilities flags)
  { return static_cast<Toplevel::Capabilities>(~static_cast<unsigned>(flags)); }

/** @ingroup gdkmmEnums */
inline Toplevel::Capabilities& operator|=(Toplevel::Capabilities& lhs, Toplevel::Capabilities rhs)
  { return (lhs = static_cast<Toplevel::Capabilities>(static_cast<unsigned>(lhs) | static_cast<unsigned>(rhs))); }
...
template <>
class GDKMM_API Value<Gdk::Toplevel::Capabilities> : public Glib::Value_Flags<Gdk::Toplevel::Capabilities>
{
public:
  static GType value_type() G_GNUC_CONST;
};
