...
using Paintable_snapshot_vfunc_functype = void (*)(GdkPaintable* self, GdkSnapshot* snapshot, double width, double height);
Paintable_snapshot_vfunc_functype Paintable_snapshot_vfunc_funcptr;
extern "C" {
static void Paintable_snapshot_vfunc_c_callback(GdkPaintable* self, GdkSnapshot* snapshot, double width, double height)
{
  Paintable_snapshot_vfunc_funcptr( self, snapshot, width, height);
}
} // extern "C"
using Paintable_get_current_image_vfunc_functype = GdkPaintable* (*)(GdkPaintable* self);
Paintable_get_current_image_vfunc_functype Paintable_get_current_image_vfunc_funcptr;
extern "C" {
static GdkPaintable* Paintable_get_current_image_vfunc_c_callback(GdkPaintable* self)
{
  return Paintable_get_current_image_vfunc_funcptr( self);
}
} // extern "C"
using Paintable_get_flags_vfunc_functype = GdkPaintableFlags (*)(GdkPaintable* self);
Paintable_get_flags_vfunc_functype Paintable_get_flags_vfunc_funcptr;
extern "C" {
static GdkPaintableFlags Paintable_get_flags_vfunc_c_callback(GdkPaintable* self)
{
  return Paintable_get_flags_vfunc_funcptr( self);
}
} // extern "C"
using Paintable_get_intrinsic_width_vfunc_functype = int (*)(GdkPaintable* self);
Paintable_get_intrinsic_width_vfunc_functype Paintable_get_intrinsic_width_vfunc_funcptr;
extern "C" {
static int Paintable_get_intrinsic_width_vfunc_c_callback(GdkPaintable* self)
{
  return Paintable_get_intrinsic_width_vfunc_funcptr( self);
}
} // extern "C"
using Paintable_get_intrinsic_height_vfunc_functype = int (*)(GdkPaintable* self);
Paintable_get_intrinsic_height_vfunc_functype Paintable_get_intrinsic_height_vfunc_funcptr;
extern "C" {
static int Paintable_get_intrinsic_height_vfunc_c_callback(GdkPaintable* self)
{
  return Paintable_get_intrinsic_height_vfunc_funcptr( self);
}
} // extern "C"
using Paintable_get_intrinsic_aspect_ratio_vfunc_functype = double (*)(GdkPaintable* self);
Paintable_get_intrinsic_aspect_ratio_vfunc_functype Paintable_get_intrinsic_aspect_ratio_vfunc_funcptr;
extern "C" {
static double Paintable_get_intrinsic_aspect_ratio_vfunc_c_callback(GdkPaintable* self)
{
  return Paintable_get_intrinsic_aspect_ratio_vfunc_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void Paintable_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->snapshot = &Paintable_snapshot_vfunc_c_callback;
  Paintable_snapshot_vfunc_funcptr = &snapshot_vfunc_callback;
  klass->get_current_image = &Paintable_get_current_image_vfunc_c_callback;
  Paintable_get_current_image_vfunc_funcptr = &get_current_image_vfunc_callback;
  klass->get_flags = &Paintable_get_flags_vfunc_c_callback;
  Paintable_get_flags_vfunc_funcptr = &get_flags_vfunc_callback;
  klass->get_intrinsic_width = &Paintable_get_intrinsic_width_vfunc_c_callback;
  Paintable_get_intrinsic_width_vfunc_funcptr = &get_intrinsic_width_vfunc_callback;
  klass->get_intrinsic_height = &Paintable_get_intrinsic_height_vfunc_c_callback;
  Paintable_get_intrinsic_height_vfunc_funcptr = &get_intrinsic_height_vfunc_callback;
  klass->get_intrinsic_aspect_ratio = &Paintable_get_intrinsic_aspect_ratio_vfunc_c_callback;
  Paintable_get_intrinsic_aspect_ratio_vfunc_funcptr = &get_intrinsic_aspect_ratio_vfunc_callback;
