...
extern "C" {
static void Display_signal_closed_connect_callback(GdkDisplay* self, gboolean p0,void* data)
{
  using namespace Gdk;
...
{
  "closed",
  (GCallback) &Display_signal_closed_connect_callback,
  (GCallback) &Display_signal_closed_connect_callback
};
...
extern "C" {
static void Display_signal_seat_added_connect_callback(GdkDisplay* self, GdkSeat* p0,void* data)
{
  using namespace Gdk;
...
{
  "seat-added",
  (GCallback) &Display_signal_seat_added_connect_callback,
  (GCallback) &Display_signal_seat_added_connect_callback
};


extern "C" {
static void Display_signal_seat_removed_connect_callback(GdkDisplay* self, GdkSeat* p0,void* data)
{
  using namespace Gdk;
  using SlotType = sigc::slot<void(const Glib::RefPtr<Seat>&)>;
...
{
  "seat-removed",
  (GCallback) &Display_signal_seat_removed_connect_callback,
  (GCallback) &Display_signal_seat_removed_connect_callback
};


extern "C" {
static void Display_signal_setting_changed_connect_callback(GdkDisplay* self, const gchar* p0,void* data)
{
  using namespace Gdk;
...
{
  "setting-changed",
  (GCallback) &Display_signal_setting_changed_connect_callback,
  (GCallback) &Display_signal_setting_changed_connect_callback
};
...
bool Display::supports_shadow_width() const
{
  return gdk_display_supports_shadow_width(const_cast<GdkDisplay*>(gobj()));
}
...
Glib::RefPtr<DmabufFormats> Display::get_dmabuf_formats()
{
  auto retvalue = Glib::wrap(gdk_display_get_dmabuf_formats(gobj()));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}

Glib::RefPtr<const DmabufFormats> Display::get_dmabuf_formats() const
{
  return const_cast<Display*>(this)->get_dmabuf_formats();
}
...
Glib::PropertyProxy_ReadOnly< bool > Display::property_shadow_width() const
{
  return Glib::PropertyProxy_ReadOnly< bool >(this, "shadow-width");
}
...
static_assert(Glib::Traits::ValueCompatibleWithWrapProperty<Glib::RefPtr<DmabufFormats>>::value,
  "Type Glib::RefPtr<DmabufFormats> cannot be used in _WRAP_PROPERTY. "
  "There is no suitable template specialization of Glib::Value<>.");

Glib::PropertyProxy_ReadOnly< Glib::RefPtr<DmabufFormats> > Display::property_dmabuf_formats() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::RefPtr<DmabufFormats> >(this, "dmabuf-formats");
}
