...
using PixbufLoader_signal_area_prepared_functype = void (*)(GdkPixbufLoader* self);
PixbufLoader_signal_area_prepared_functype PixbufLoader_signal_area_prepared_funcptr;
extern "C" {
static void PixbufLoader_signal_area_prepared_default_callback(GdkPixbufLoader* self)
{
  PixbufLoader_signal_area_prepared_funcptr( self);
}
} // extern "C"


extern "C" {
static void PixbufLoader_signal_area_updated_connect_callback(GdkPixbufLoader* self, gint p0,gint p1,gint p2,gint p3,void* data)
{
  using namespace Gdk;
...
{
  "area_updated",
  (GCallback) &PixbufLoader_signal_area_updated_connect_callback,
  (GCallback) &PixbufLoader_signal_area_updated_connect_callback
};


using PixbufLoader_signal_area_updated_functype = void (*)(GdkPixbufLoader* self, gint p0, gint p1, gint p2, gint p3);
PixbufLoader_signal_area_updated_functype PixbufLoader_signal_area_updated_funcptr;
extern "C" {
static void PixbufLoader_signal_area_updated_default_callback(GdkPixbufLoader* self, gint p0, gint p1, gint p2, gint p3)
{
  PixbufLoader_signal_area_updated_funcptr( self, p0, p1, p2, p3);
}
} // extern "C"
...
using PixbufLoader_signal_closed_functype = void (*)(GdkPixbufLoader* self);
PixbufLoader_signal_closed_functype PixbufLoader_signal_closed_funcptr;
extern "C" {
static void PixbufLoader_signal_closed_default_callback(GdkPixbufLoader* self)
{
  PixbufLoader_signal_closed_funcptr( self);
}
} // extern "C"


extern "C" {
static void PixbufLoader_signal_size_prepared_connect_callback(GdkPixbufLoader* self, gint p0,gint p1,void* data)
{
  using namespace Gdk;
...
{
  "size_prepared",
  (GCallback) &PixbufLoader_signal_size_prepared_connect_callback,
  (GCallback) &PixbufLoader_signal_size_prepared_connect_callback
};


using PixbufLoader_signal_size_prepared_functype = void (*)(GdkPixbufLoader* self, gint p0, gint p1);
PixbufLoader_signal_size_prepared_functype PixbufLoader_signal_size_prepared_funcptr;
extern "C" {
static void PixbufLoader_signal_size_prepared_default_callback(GdkPixbufLoader* self, gint p0, gint p1)
{
  PixbufLoader_signal_size_prepared_funcptr( self, p0, p1);
}
} // extern "C"
} // anonymous namespace
...
void PixbufLoader_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->area_prepared = &PixbufLoader_signal_area_prepared_default_callback;
  PixbufLoader_signal_area_prepared_funcptr = &area_prepared_callback;
  klass->area_updated = &PixbufLoader_signal_area_updated_default_callback;
  PixbufLoader_signal_area_updated_funcptr = &area_updated_callback;
  klass->closed = &PixbufLoader_signal_closed_default_callback;
  PixbufLoader_signal_closed_funcptr = &closed_callback;
  klass->size_prepared = &PixbufLoader_signal_size_prepared_default_callback;
  PixbufLoader_signal_size_prepared_funcptr = &size_prepared_callback;
}
