...
public:
   ...
   * ”device pixels” (see Gdk::Surface::get_scale()).
   * 
   ...
   * @return True if @a layout and @a other have identical layout properties,
   * otherwise false.
   */
   ...
   * the value pointed to by @a maximized is set to true if it should go
   ...
   * the value pointed to by @a fullscreen is set to true if it should go
