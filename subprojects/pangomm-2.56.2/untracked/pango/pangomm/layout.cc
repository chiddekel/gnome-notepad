...
void Layout::set_justify_last_line(bool justify)
{
  pango_layout_set_justify_last_line(gobj(), static_cast<int>(justify));
}

bool Layout::get_justify_last_line() const
{
  return pango_layout_get_justify_last_line(const_cast<PangoLayout*>(gobj()));
}
...
Direction Layout::get_direction(int index) const
{
  return static_cast<Direction>(pango_layout_get_direction(const_cast<PangoLayout*>(gobj()), index));
}
...
void Layout::get_caret_pos(int index, Rectangle& strong_pos, Rectangle& weak_pos) const
{
  pango_layout_get_caret_pos(const_cast<PangoLayout*>(gobj()), index, (strong_pos).gobj(), (weak_pos).gobj());
}
