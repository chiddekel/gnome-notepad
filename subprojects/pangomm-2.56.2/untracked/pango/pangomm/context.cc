...
void Context::set_round_glyph_positions(bool round_positions)
{
  pango_context_set_round_glyph_positions(gobj(), static_cast<int>(round_positions));
}

bool Context::get_round_glyph_positions() const
{
  return pango_context_get_round_glyph_positions(const_cast<PangoContext*>(gobj()));
}
