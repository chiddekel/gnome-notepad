...
bool LayoutLine::is_paragraph_start() const
{
  return pango_layout_line_is_paragraph_start(const_cast<PangoLayoutLine*>(gobj()));
}

Direction LayoutLine::get_resolved_direction() const
{
  return static_cast<Direction>(pango_layout_line_get_resolved_direction(const_cast<PangoLayoutLine*>(gobj())));
}
