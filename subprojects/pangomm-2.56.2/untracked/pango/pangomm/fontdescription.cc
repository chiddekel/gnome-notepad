...
void FontDescription::set_features(const Glib::ustring& features)
{
  pango_font_description_set_features(gobj(), features.empty() ? nullptr : features.c_str());
}

Glib::ustring FontDescription::get_features() const
{
  return Glib::convert_const_gchar_ptr_to_ustring(pango_font_description_get_features(const_cast<PangoFontDescription*>(gobj())));
}
