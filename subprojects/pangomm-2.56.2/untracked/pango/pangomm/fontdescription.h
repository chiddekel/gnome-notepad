 ...
 * The font gravity is specified. @newin{1,16}
 * 
 *  @var FontMask::VARIATIONS
 * OpenType font variations are specified. @newin{1,42}
 * 
 *  @var FontMask::FEATURES
 * OpenType font features are specified. @newin{1,56}
 */
