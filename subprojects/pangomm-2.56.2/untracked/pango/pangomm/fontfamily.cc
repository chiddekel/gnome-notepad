...
Glib::PropertyProxy_ReadOnly< GType > FontFamily::property_item_type() const
{
  return Glib::PropertyProxy_ReadOnly< GType >(this, "item-type");
}

Glib::PropertyProxy_ReadOnly< unsigned int > FontFamily::property_n_items() const
{
  return Glib::PropertyProxy_ReadOnly< unsigned int >(this, "n-items");
}

Glib::PropertyProxy_ReadOnly< Glib::ustring > FontFamily::property_name() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::ustring >(this, "name");
}

Glib::PropertyProxy_ReadOnly< bool > FontFamily::property_is_monospace() const
{
  return Glib::PropertyProxy_ReadOnly< bool >(this, "is-monospace");
}

Glib::PropertyProxy_ReadOnly< bool > FontFamily::property_is_variable() const
{
  return Glib::PropertyProxy_ReadOnly< bool >(this, "is-variable");
}
