...
namespace
{
using AsyncResult_get_source_object_vfunc_functype = GObject* (*)(GAsyncResult* self);
AsyncResult_get_source_object_vfunc_functype AsyncResult_get_source_object_vfunc_funcptr;
extern "C" {
static GObject* AsyncResult_get_source_object_vfunc_c_callback(GAsyncResult* self)
{
  return AsyncResult_get_source_object_vfunc_funcptr( self);
}
} // extern "C"
using AsyncResult_is_tagged_vfunc_functype = gboolean (*)(GAsyncResult* self, gpointer source_tag);
AsyncResult_is_tagged_vfunc_functype AsyncResult_is_tagged_vfunc_funcptr;
extern "C" {
static gboolean AsyncResult_is_tagged_vfunc_c_callback(GAsyncResult* self, gpointer source_tag)
{
  return AsyncResult_is_tagged_vfunc_funcptr( self, source_tag);
}
} // extern "C"
} // anonymous namespace
...
void AsyncResult_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->get_source_object = &AsyncResult_get_source_object_vfunc_c_callback;
  AsyncResult_get_source_object_vfunc_funcptr = &get_source_object_vfunc_callback;
  klass->is_tagged = &AsyncResult_is_tagged_vfunc_c_callback;
  AsyncResult_is_tagged_vfunc_funcptr = &is_tagged_vfunc_callback;
