...
extern "C" {
static void MountOperation_signal_ask_password_connect_callback(GMountOperation* self, const gchar* p0,const gchar* p1,const gchar* p2,GAskPasswordFlags p3,void* data)
{
  using namespace Gio;
...
{
  "ask_password",
  (GCallback) &MountOperation_signal_ask_password_connect_callback,
  (GCallback) &MountOperation_signal_ask_password_connect_callback
};


using MountOperation_signal_ask_password_functype = void (*)(GMountOperation* self, const gchar* p0, const gchar* p1, const gchar* p2, GAskPasswordFlags p3);
MountOperation_signal_ask_password_functype MountOperation_signal_ask_password_funcptr;
extern "C" {
static void MountOperation_signal_ask_password_default_callback(GMountOperation* self, const gchar* p0, const gchar* p1, const gchar* p2, GAskPasswordFlags p3)
{
  MountOperation_signal_ask_password_funcptr( self, p0, p1, p2, p3);
}
} // extern "C"


extern "C" {
static void MountOperation_signal_ask_question_connect_callback(GMountOperation* self, const gchar* p0,const gchar** p1,void* data)
{
  using namespace Gio;
...
{
  "ask_question",
  (GCallback) &MountOperation_signal_ask_question_connect_callback,
  (GCallback) &MountOperation_signal_ask_question_connect_callback
};


using MountOperation_signal_ask_question_functype = void (*)(GMountOperation* self, const gchar* p0, const gchar** p1);
MountOperation_signal_ask_question_functype MountOperation_signal_ask_question_funcptr;
extern "C" {
static void MountOperation_signal_ask_question_default_callback(GMountOperation* self, const gchar* p0, const gchar** p1)
{
  MountOperation_signal_ask_question_funcptr( self, p0, p1);
}
} // extern "C"


extern "C" {
static void MountOperation_signal_reply_connect_callback(GMountOperation* self, GMountOperationResult p0,void* data)
{
  using namespace Gio;
...
{
  "reply",
  (GCallback) &MountOperation_signal_reply_connect_callback,
  (GCallback) &MountOperation_signal_reply_connect_callback
};


using MountOperation_signal_reply_functype = void (*)(GMountOperation* self, GMountOperationResult p0);
MountOperation_signal_reply_functype MountOperation_signal_reply_funcptr;
extern "C" {
static void MountOperation_signal_reply_default_callback(GMountOperation* self, GMountOperationResult p0)
{
  MountOperation_signal_reply_funcptr( self, p0);
}
} // extern "C"
...
using MountOperation_signal_aborted_functype = void (*)(GMountOperation* self);
MountOperation_signal_aborted_functype MountOperation_signal_aborted_funcptr;
extern "C" {
static void MountOperation_signal_aborted_default_callback(GMountOperation* self)
{
  MountOperation_signal_aborted_funcptr( self);
}
} // extern "C"


extern "C" {
static void MountOperation_signal_show_unmount_progress_connect_callback(GMountOperation* self, const gchar* p0,gint64 p1,gint64 p2,void* data)
{
  using namespace Gio;
...
static const Glib::SignalProxyInfo MountOperation_signal_show_unmount_progress_info =
{
  ...
  (GCallback) &MountOperation_signal_show_unmount_progress_connect_callback,
  (GCallback) &MountOperation_signal_show_unmount_progress_connect_callback
};


using MountOperation_signal_show_unmount_progress_functype = void (*)(GMountOperation* self, const gchar* p0, gint64 p1, gint64 p2);
MountOperation_signal_show_unmount_progress_functype MountOperation_signal_show_unmount_progress_funcptr;
extern "C" {
static void MountOperation_signal_show_unmount_progress_default_callback(GMountOperation* self, const gchar* p0, gint64 p1, gint64 p2)
{
  MountOperation_signal_show_unmount_progress_funcptr( self, p0, p1, p2);
}
} // extern "C"
} // anonymous namespace
...
void MountOperation_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->ask_password = &MountOperation_signal_ask_password_default_callback;
  MountOperation_signal_ask_password_funcptr = &ask_password_callback;
  klass->ask_question = &MountOperation_signal_ask_question_default_callback;
  MountOperation_signal_ask_question_funcptr = &ask_question_callback;
  klass->reply = &MountOperation_signal_reply_default_callback;
  MountOperation_signal_reply_funcptr = &reply_callback;
  klass->aborted = &MountOperation_signal_aborted_default_callback;
  MountOperation_signal_aborted_funcptr = &aborted_callback;
  klass->show_unmount_progress = &MountOperation_signal_show_unmount_progress_default_callback;
  MountOperation_signal_show_unmount_progress_funcptr = &show_unmount_progress_callback;
}
