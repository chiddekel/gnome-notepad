...
namespace
{
using Action_get_name_vfunc_functype = const gchar* (*)(GAction* self);
Action_get_name_vfunc_functype Action_get_name_vfunc_funcptr;
extern "C" {
static const gchar* Action_get_name_vfunc_c_callback(GAction* self)
{
  return Action_get_name_vfunc_funcptr( self);
}
} // extern "C"
using Action_get_parameter_type_vfunc_functype = const GVariantType* (*)(GAction* self);
Action_get_parameter_type_vfunc_functype Action_get_parameter_type_vfunc_funcptr;
extern "C" {
static const GVariantType* Action_get_parameter_type_vfunc_c_callback(GAction* self)
{
  return Action_get_parameter_type_vfunc_funcptr( self);
}
} // extern "C"
using Action_get_state_type_vfunc_functype = const GVariantType* (*)(GAction* self);
Action_get_state_type_vfunc_functype Action_get_state_type_vfunc_funcptr;
extern "C" {
static const GVariantType* Action_get_state_type_vfunc_c_callback(GAction* self)
{
  return Action_get_state_type_vfunc_funcptr( self);
}
} // extern "C"
using Action_get_state_hint_vfunc_functype = GVariant* (*)(GAction* self);
Action_get_state_hint_vfunc_functype Action_get_state_hint_vfunc_funcptr;
extern "C" {
static GVariant* Action_get_state_hint_vfunc_c_callback(GAction* self)
{
  return Action_get_state_hint_vfunc_funcptr( self);
}
} // extern "C"
using Action_get_enabled_vfunc_functype = gboolean (*)(GAction* self);
Action_get_enabled_vfunc_functype Action_get_enabled_vfunc_funcptr;
extern "C" {
static gboolean Action_get_enabled_vfunc_c_callback(GAction* self)
{
  return Action_get_enabled_vfunc_funcptr( self);
}
} // extern "C"
using Action_get_state_vfunc_functype = GVariant* (*)(GAction* self);
Action_get_state_vfunc_functype Action_get_state_vfunc_funcptr;
extern "C" {
static GVariant* Action_get_state_vfunc_c_callback(GAction* self)
{
  return Action_get_state_vfunc_funcptr( self);
}
} // extern "C"
using Action_change_state_vfunc_functype = void (*)(GAction* self, GVariant* value);
Action_change_state_vfunc_functype Action_change_state_vfunc_funcptr;
extern "C" {
static void Action_change_state_vfunc_c_callback(GAction* self, GVariant* value)
{
  Action_change_state_vfunc_funcptr( self, value);
}
} // extern "C"
using Action_activate_vfunc_functype = void (*)(GAction* self, GVariant* parameter);
Action_activate_vfunc_functype Action_activate_vfunc_funcptr;
extern "C" {
static void Action_activate_vfunc_c_callback(GAction* self, GVariant* parameter)
{
  Action_activate_vfunc_funcptr( self, parameter);
}
} // extern "C"
} // anonymous namespace
...
void Action_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->get_name = &Action_get_name_vfunc_c_callback;
  Action_get_name_vfunc_funcptr = &get_name_vfunc_callback;
  klass->get_parameter_type = &Action_get_parameter_type_vfunc_c_callback;
  Action_get_parameter_type_vfunc_funcptr = &get_parameter_type_vfunc_callback;
  klass->get_state_type = &Action_get_state_type_vfunc_c_callback;
  Action_get_state_type_vfunc_funcptr = &get_state_type_vfunc_callback;
  klass->get_state_hint = &Action_get_state_hint_vfunc_c_callback;
  Action_get_state_hint_vfunc_funcptr = &get_state_hint_vfunc_callback;
  klass->get_enabled = &Action_get_enabled_vfunc_c_callback;
  Action_get_enabled_vfunc_funcptr = &get_enabled_vfunc_callback;
  klass->get_state = &Action_get_state_vfunc_c_callback;
  Action_get_state_vfunc_funcptr = &get_state_vfunc_callback;
  klass->change_state = &Action_change_state_vfunc_c_callback;
  Action_change_state_vfunc_funcptr = &change_state_vfunc_callback;
  klass->activate = &Action_activate_vfunc_c_callback;
  Action_activate_vfunc_funcptr = &activate_vfunc_callback;
