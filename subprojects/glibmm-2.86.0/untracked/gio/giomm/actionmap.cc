...
namespace
{
using ActionMap_lookup_action_vfunc_functype = GAction* (*)(GActionMap* self, const gchar* action_name);
ActionMap_lookup_action_vfunc_functype ActionMap_lookup_action_vfunc_funcptr;
extern "C" {
static GAction* ActionMap_lookup_action_vfunc_c_callback(GActionMap* self, const gchar* action_name)
{
  return ActionMap_lookup_action_vfunc_funcptr( self, action_name);
}
} // extern "C"
using ActionMap_add_action_vfunc_functype = void (*)(GActionMap* self, GAction* action);
ActionMap_add_action_vfunc_functype ActionMap_add_action_vfunc_funcptr;
extern "C" {
static void ActionMap_add_action_vfunc_c_callback(GActionMap* self, GAction* action)
{
  ActionMap_add_action_vfunc_funcptr( self, action);
}
} // extern "C"
using ActionMap_remove_action_vfunc_functype = void (*)(GActionMap* self, const gchar* action_name);
ActionMap_remove_action_vfunc_functype ActionMap_remove_action_vfunc_funcptr;
extern "C" {
static void ActionMap_remove_action_vfunc_c_callback(GActionMap* self, const gchar* action_name)
{
  ActionMap_remove_action_vfunc_funcptr( self, action_name);
}
} // extern "C"
} // anonymous namespace
...
void ActionMap_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->lookup_action = &ActionMap_lookup_action_vfunc_c_callback;
  ActionMap_lookup_action_vfunc_funcptr = &lookup_action_vfunc_callback;
  klass->add_action = &ActionMap_add_action_vfunc_c_callback;
  ActionMap_add_action_vfunc_funcptr = &add_action_vfunc_callback;
  klass->remove_action = &ActionMap_remove_action_vfunc_c_callback;
  ActionMap_remove_action_vfunc_funcptr = &remove_action_vfunc_callback;
