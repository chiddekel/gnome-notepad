...
extern "C" {
static void ObjectManagerClient_signal_interface_proxy_signal_connect_callback(GDBusObjectManagerClient* self, GDBusObjectProxy* p0,GDBusProxy* p1,const gchar* p2,const gchar* p3,GVariant* p4,void* data)
{
...
static const Glib::SignalProxyInfo ObjectManagerClient_signal_interface_proxy_signal_info =
{
  ...
  (GCallback) &ObjectManagerClient_signal_interface_proxy_signal_connect_callback,
  (GCallback) &ObjectManagerClient_signal_interface_proxy_signal_connect_callback
};


using ObjectManagerClient_signal_interface_proxy_signal_functype = void (*)(GDBusObjectManagerClient* self, GDBusObjectProxy* p0, GDBusProxy* p1, const gchar* p2, const gchar* p3, GVariant* p4);
ObjectManagerClient_signal_interface_proxy_signal_functype ObjectManagerClient_signal_interface_proxy_signal_funcptr;
extern "C" {
static void ObjectManagerClient_signal_interface_proxy_signal_default_callback(GDBusObjectManagerClient* self, GDBusObjectProxy* p0, GDBusProxy* p1, const gchar* p2, const gchar* p3, GVariant* p4)
{
  ObjectManagerClient_signal_interface_proxy_signal_funcptr( self, p0, p1, p2, p3, p4);
}
} // extern "C"


extern "C" {
static void ObjectManagerClient_signal_interface_proxy_properties_changed_connect_callback(GDBusObjectManagerClient* self, GDBusObjectProxy* p0,GDBusProxy* p1,GVariant* p2,const gchar*const* p3,void* data)
{
  using namespace Gio::DBus;
...
static const Glib::SignalProxyInfo ObjectManagerClient_signal_interface_proxy_properties_changed_info =
{
  ...
  (GCallback) &ObjectManagerClient_signal_interface_proxy_properties_changed_connect_callback,
  (GCallback) &ObjectManagerClient_signal_interface_proxy_properties_changed_connect_callback
};


using ObjectManagerClient_signal_interface_proxy_properties_changed_functype = void (*)(GDBusObjectManagerClient* self, GDBusObjectProxy* p0, GDBusProxy* p1, GVariant* p2, const gchar*const* p3);
ObjectManagerClient_signal_interface_proxy_properties_changed_functype ObjectManagerClient_signal_interface_proxy_properties_changed_funcptr;
extern "C" {
static void ObjectManagerClient_signal_interface_proxy_properties_changed_default_callback(GDBusObjectManagerClient* self, GDBusObjectProxy* p0, GDBusProxy* p1, GVariant* p2, const gchar*const* p3)
{
  ObjectManagerClient_signal_interface_proxy_properties_changed_funcptr( self, p0, p1, p2, p3);
}
} // extern "C"
} // anonymous namespace
...
void ObjectManagerClient_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->interface_proxy_signal = &ObjectManagerClient_signal_interface_proxy_signal_default_callback;
  ObjectManagerClient_signal_interface_proxy_signal_funcptr = &interface_proxy_signal_callback;
  klass->interface_proxy_properties_changed = &ObjectManagerClient_signal_interface_proxy_properties_changed_default_callback;
  ObjectManagerClient_signal_interface_proxy_properties_changed_funcptr = &interface_proxy_properties_changed_callback;
}
