...
public:
   ...
   * with g_cancellable_reset().
   * 
   * Note that in the event that a Gio::Cancellable::signal_cancelled() signal handler is
   ...
   * this function from a Gio::Cancellable::signal_cancelled() signal handler.
   */
  void cancel();
   ...
   * 
   * In the event that a Gio::Cancellable::signal_cancelled() signal handler is currently
