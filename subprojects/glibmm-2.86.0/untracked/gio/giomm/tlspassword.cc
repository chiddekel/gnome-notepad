...
namespace
{
using TlsPassword_get_value_vfunc_functype = const guchar* (*)(GTlsPassword* self, gsize* length);
TlsPassword_get_value_vfunc_functype TlsPassword_get_value_vfunc_funcptr;
extern "C" {
static const guchar* TlsPassword_get_value_vfunc_c_callback(GTlsPassword* self, gsize* length)
{
  return TlsPassword_get_value_vfunc_funcptr( self, length);
}
} // extern "C"
using TlsPassword_get_default_warning_vfunc_functype = const gchar* (*)(GTlsPassword* self);
TlsPassword_get_default_warning_vfunc_functype TlsPassword_get_default_warning_vfunc_funcptr;
extern "C" {
static const gchar* TlsPassword_get_default_warning_vfunc_c_callback(GTlsPassword* self)
{
  return TlsPassword_get_default_warning_vfunc_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void TlsPassword_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->get_value = &TlsPassword_get_value_vfunc_c_callback;
  TlsPassword_get_value_vfunc_funcptr = &get_value_vfunc_callback;
  klass->get_default_warning = &TlsPassword_get_default_warning_vfunc_c_callback;
  TlsPassword_get_default_warning_vfunc_funcptr = &get_default_warning_vfunc_callback;
