...
extern "C" {
static void Object_signal_interface_added_connect_callback(GDBusObject* self, GDBusInterface* p0,void* data)
{
...
{
  "interface_added",
  (GCallback) &Object_signal_interface_added_connect_callback,
  (GCallback) &Object_signal_interface_added_connect_callback
};


using Object_signal_interface_added_functype = void (*)(GDBusObject* self, GDBusInterface* p0);
Object_signal_interface_added_functype Object_signal_interface_added_funcptr;
extern "C" {
static void Object_signal_interface_added_default_callback(GDBusObject* self, GDBusInterface* p0)
{
  Object_signal_interface_added_funcptr( self, p0);
}
} // extern "C"


extern "C" {
static void Object_signal_interface_removed_connect_callback(GDBusObject* self, GDBusInterface* p0,void* data)
{
  using namespace Gio::DBus;
  using SlotType = sigc::slot<void(const Glib::RefPtr<Gio::DBus::Interface>&)>;
...
{
  "interface_removed",
  (GCallback) &Object_signal_interface_removed_connect_callback,
  (GCallback) &Object_signal_interface_removed_connect_callback
};


using Object_signal_interface_removed_functype = void (*)(GDBusObject* self, GDBusInterface* p0);
Object_signal_interface_removed_functype Object_signal_interface_removed_funcptr;
extern "C" {
static void Object_signal_interface_removed_default_callback(GDBusObject* self, GDBusInterface* p0)
{
  Object_signal_interface_removed_funcptr( self, p0);
}
} // extern "C"
using Object_get_object_path_vfunc_functype = const gchar* (*)(GDBusObject* self);
Object_get_object_path_vfunc_functype Object_get_object_path_vfunc_funcptr;
extern "C" {
static const gchar* Object_get_object_path_vfunc_c_callback(GDBusObject* self)
{
  return Object_get_object_path_vfunc_funcptr( self);
}
} // extern "C"
using Object_get_interfaces_vfunc_functype = GList* (*)(GDBusObject* self);
Object_get_interfaces_vfunc_functype Object_get_interfaces_vfunc_funcptr;
extern "C" {
static GList* Object_get_interfaces_vfunc_c_callback(GDBusObject* self)
{
  return Object_get_interfaces_vfunc_funcptr( self);
}
} // extern "C"
using Object_get_interface_vfunc_functype = GDBusInterface* (*)(GDBusObject* self, const gchar* interface_name);
Object_get_interface_vfunc_functype Object_get_interface_vfunc_funcptr;
extern "C" {
static GDBusInterface* Object_get_interface_vfunc_c_callback(GDBusObject* self, const gchar* interface_name)
{
  return Object_get_interface_vfunc_funcptr( self, interface_name);
}
} // extern "C"
} // anonymous namespace
...
void Object_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->get_object_path = &Object_get_object_path_vfunc_c_callback;
  Object_get_object_path_vfunc_funcptr = &get_object_path_vfunc_callback;
  klass->get_interfaces = &Object_get_interfaces_vfunc_c_callback;
  Object_get_interfaces_vfunc_funcptr = &get_interfaces_vfunc_callback;
  klass->get_interface = &Object_get_interface_vfunc_c_callback;
  Object_get_interface_vfunc_funcptr = &get_interface_vfunc_callback;

  klass->interface_added = &Object_signal_interface_added_default_callback;
  Object_signal_interface_added_funcptr = &interface_added_callback;
  klass->interface_removed = &Object_signal_interface_removed_default_callback;
  Object_signal_interface_removed_funcptr = &interface_removed_callback;
}
