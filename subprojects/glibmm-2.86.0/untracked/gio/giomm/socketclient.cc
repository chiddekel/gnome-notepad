...
extern "C" {
static void SocketClient_signal_event_connect_callback(GSocketClient* self, GSocketClientEvent p0,GSocketConnectable* p1,GIOStream* p2,void* data)
{
  using namespace Gio;
...
{
  "event",
  (GCallback) &SocketClient_signal_event_connect_callback,
  (GCallback) &SocketClient_signal_event_connect_callback
};


using SocketClient_signal_event_functype = void (*)(GSocketClient* self, GSocketClientEvent p0, GSocketConnectable* p1, GIOStream* p2);
SocketClient_signal_event_functype SocketClient_signal_event_funcptr;
extern "C" {
static void SocketClient_signal_event_default_callback(GSocketClient* self, GSocketClientEvent p0, GSocketConnectable* p1, GIOStream* p2)
{
  SocketClient_signal_event_funcptr( self, p0, p1, p2);
}
} // extern "C"
} // anonymous namespace
...
void SocketClient_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->event = &SocketClient_signal_event_default_callback;
  SocketClient_signal_event_funcptr = &event_callback;
}
