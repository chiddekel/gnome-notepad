...
namespace
{
using Initable_init_vfunc_functype = gboolean (*)(GInitable* self, GCancellable* cancellable, GError** error);
Initable_init_vfunc_functype Initable_init_vfunc_funcptr;
extern "C" {
static gboolean Initable_init_vfunc_c_callback(GInitable* self, GCancellable* cancellable, GError** error)
{
  return Initable_init_vfunc_funcptr( self, cancellable, error);
}
} // extern "C"
} // anonymous namespace
...
void Initable_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->init = &Initable_init_vfunc_c_callback;
  Initable_init_vfunc_funcptr = &init_vfunc_callback;
