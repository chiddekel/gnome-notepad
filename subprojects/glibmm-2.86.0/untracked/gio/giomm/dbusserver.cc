...
extern "C" {
static gboolean Server_signal_new_connection_connect_callback(GDBusServer* self, GDBusConnection* p0,void* data)
{
...
{
  "new-connection",
  (GCallback) &Server_signal_new_connection_connect_callback,
