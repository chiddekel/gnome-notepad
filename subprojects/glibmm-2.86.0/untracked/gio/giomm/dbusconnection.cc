...
extern "C" {
static void Connection_signal_closed_connect_callback(GDBusConnection* self, gboolean p0,GError* p1,void* data)
{
...
{
  "closed",
  (GCallback) &Connection_signal_closed_connect_callback,
  (GCallback) &Connection_signal_closed_connect_callback
};
