...
extern "C" {
static gboolean SocketService_signal_incoming_connect_callback(GSocketService* self, GSocketConnection* p0,GObject* p1,void* data)
{
  using namespace Gio;
...
{
  "incoming",
  (GCallback) &SocketService_signal_incoming_connect_callback,
  (GCallback) &SocketService_signal_incoming_notify_callback
};


using SocketService_signal_incoming_functype = gboolean (*)(GSocketService* self, GSocketConnection* p0, GObject* p1);
SocketService_signal_incoming_functype SocketService_signal_incoming_funcptr;
extern "C" {
static gboolean SocketService_signal_incoming_default_callback(GSocketService* self, GSocketConnection* p0, GObject* p1)
{
  return SocketService_signal_incoming_funcptr( self, p0, p1);
}
} // extern "C"
} // anonymous namespace
...
void SocketService_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->incoming = &SocketService_signal_incoming_default_callback;
  SocketService_signal_incoming_funcptr = &incoming_callback;
}
