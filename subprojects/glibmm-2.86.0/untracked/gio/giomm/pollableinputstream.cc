...
namespace
{
using PollableInputStream_can_poll_vfunc_functype = gboolean (*)(GPollableInputStream* self);
PollableInputStream_can_poll_vfunc_functype PollableInputStream_can_poll_vfunc_funcptr;
extern "C" {
static gboolean PollableInputStream_can_poll_vfunc_c_callback(GPollableInputStream* self)
{
  return PollableInputStream_can_poll_vfunc_funcptr( self);
}
} // extern "C"
using PollableInputStream_is_readable_vfunc_functype = gboolean (*)(GPollableInputStream* self);
PollableInputStream_is_readable_vfunc_functype PollableInputStream_is_readable_vfunc_funcptr;
extern "C" {
static gboolean PollableInputStream_is_readable_vfunc_c_callback(GPollableInputStream* self)
{
  return PollableInputStream_is_readable_vfunc_funcptr( self);
}
} // extern "C"
using PollableInputStream_read_nonblocking_vfunc_functype = gssize (*)(GPollableInputStream* self, void* buffer, gsize count, GError** error);
PollableInputStream_read_nonblocking_vfunc_functype PollableInputStream_read_nonblocking_vfunc_funcptr;
extern "C" {
static gssize PollableInputStream_read_nonblocking_vfunc_c_callback(GPollableInputStream* self, void* buffer, gsize count, GError** error)
{
  return PollableInputStream_read_nonblocking_vfunc_funcptr( self, buffer, count, error);
}
} // extern "C"
} // anonymous namespace
...
void PollableInputStream_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->can_poll = &PollableInputStream_can_poll_vfunc_c_callback;
  PollableInputStream_can_poll_vfunc_funcptr = &can_poll_vfunc_callback;
  klass->is_readable = &PollableInputStream_is_readable_vfunc_c_callback;
  PollableInputStream_is_readable_vfunc_funcptr = &is_readable_vfunc_callback;
  klass->read_nonblocking = &PollableInputStream_read_nonblocking_vfunc_c_callback;
  PollableInputStream_read_nonblocking_vfunc_funcptr = &read_nonblocking_vfunc_callback;
