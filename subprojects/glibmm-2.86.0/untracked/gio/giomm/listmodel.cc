...
extern "C" {
static void ListModel_signal_items_changed_connect_callback(GListModel* self, guint p0,guint p1,guint p2,void* data)
{
  using namespace Gio;
...
{
  "items-changed",
  (GCallback) &ListModel_signal_items_changed_connect_callback,
  (GCallback) &ListModel_signal_items_changed_connect_callback
};


using ListModel_get_item_type_vfunc_functype = GType (*)(GListModel* self);
ListModel_get_item_type_vfunc_functype ListModel_get_item_type_vfunc_funcptr;
extern "C" {
static GType ListModel_get_item_type_vfunc_c_callback(GListModel* self)
{
  return ListModel_get_item_type_vfunc_funcptr( self);
}
} // extern "C"
using ListModel_get_n_items_vfunc_functype = guint (*)(GListModel* self);
ListModel_get_n_items_vfunc_functype ListModel_get_n_items_vfunc_funcptr;
extern "C" {
static guint ListModel_get_n_items_vfunc_c_callback(GListModel* self)
{
  return ListModel_get_n_items_vfunc_funcptr( self);
}
} // extern "C"
using ListModel_get_item_vfunc_functype = gpointer (*)(GListModel* self, guint position);
ListModel_get_item_vfunc_functype ListModel_get_item_vfunc_funcptr;
extern "C" {
static gpointer ListModel_get_item_vfunc_c_callback(GListModel* self, guint position)
{
  return ListModel_get_item_vfunc_funcptr( self, position);
}
} // extern "C"
} // anonymous namespace
...
void ListModel_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->get_item_type = &ListModel_get_item_type_vfunc_c_callback;
  ListModel_get_item_type_vfunc_funcptr = &get_item_type_vfunc_callback;
  klass->get_n_items = &ListModel_get_n_items_vfunc_c_callback;
  ListModel_get_n_items_vfunc_funcptr = &get_n_items_vfunc_callback;
  klass->get_item = &ListModel_get_item_vfunc_c_callback;
  ListModel_get_item_vfunc_funcptr = &get_item_vfunc_callback;
