...
namespace
{
using TlsInteraction_ask_password_vfunc_functype = GTlsInteractionResult (*)(GTlsInteraction* self, GTlsPassword* password, GCancellable* cancellable, GError** error);
TlsInteraction_ask_password_vfunc_functype TlsInteraction_ask_password_vfunc_funcptr;
extern "C" {
static GTlsInteractionResult TlsInteraction_ask_password_vfunc_c_callback(GTlsInteraction* self, GTlsPassword* password, GCancellable* cancellable, GError** error)
{
  return TlsInteraction_ask_password_vfunc_funcptr( self, password, cancellable, error);
}
} // extern "C"
using TlsInteraction_ask_password_async_vfunc_functype = void (*)(GTlsInteraction* self, GTlsPassword* password, GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data);
TlsInteraction_ask_password_async_vfunc_functype TlsInteraction_ask_password_async_vfunc_funcptr;
extern "C" {
static void TlsInteraction_ask_password_async_vfunc_c_callback(GTlsInteraction* self, GTlsPassword* password, GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
  TlsInteraction_ask_password_async_vfunc_funcptr( self, password, cancellable, callback, user_data);
}
} // extern "C"
using TlsInteraction_ask_password_finish_vfunc_functype = GTlsInteractionResult (*)(GTlsInteraction* self, GAsyncResult* result, GError** error);
TlsInteraction_ask_password_finish_vfunc_functype TlsInteraction_ask_password_finish_vfunc_funcptr;
extern "C" {
static GTlsInteractionResult TlsInteraction_ask_password_finish_vfunc_c_callback(GTlsInteraction* self, GAsyncResult* result, GError** error)
{
  return TlsInteraction_ask_password_finish_vfunc_funcptr( self, result, error);
}
} // extern "C"
} // anonymous namespace
...
void TlsInteraction_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->ask_password = &TlsInteraction_ask_password_vfunc_c_callback;
  TlsInteraction_ask_password_vfunc_funcptr = &ask_password_vfunc_callback;
  klass->ask_password_async = &TlsInteraction_ask_password_async_vfunc_c_callback;
  TlsInteraction_ask_password_async_vfunc_funcptr = &ask_password_async_vfunc_callback;
  klass->ask_password_finish = &TlsInteraction_ask_password_finish_vfunc_c_callback;
  TlsInteraction_ask_password_finish_vfunc_funcptr = &ask_password_finish_vfunc_callback;
...
void TlsInteraction::ask_password_async(const Glib::RefPtr<TlsPassword>& password, const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable)
{
  ...
  g_tls_interaction_ask_password_async(gobj(), Glib::unwrap(password), const_cast<GCancellable*>(Glib::unwrap(cancellable)), &giomm_SignalProxy_async_callback, slot_copy);
}
...
void TlsInteraction::ask_password_async(const Glib::RefPtr<TlsPassword>& password, const SlotAsyncReady& slot)
{
  ...
  g_tls_interaction_ask_password_async(gobj(), Glib::unwrap(password), nullptr, &giomm_SignalProxy_async_callback, slot_copy);
}
...
void TlsInteraction::request_certificate_async(const Glib::RefPtr<TlsConnection>& connection, TlsCertificateRequestFlags flags, const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable)
{
  ...
  g_tls_interaction_request_certificate_async(gobj(), Glib::unwrap(connection), static_cast<GTlsCertificateRequestFlags>(flags), const_cast<GCancellable*>(Glib::unwrap(cancellable)), &giomm_SignalProxy_async_callback, slot_copy);
}
...
void TlsInteraction::request_certificate_async(const Glib::RefPtr<TlsConnection>& connection, TlsCertificateRequestFlags flags, const SlotAsyncReady& slot)
{
  ...
  g_tls_interaction_request_certificate_async(gobj(), Glib::unwrap(connection), static_cast<GTlsCertificateRequestFlags>(flags), nullptr, &giomm_SignalProxy_async_callback, slot_copy);
}
...
void Gio::TlsInteraction::ask_password_async_vfunc(const Glib::RefPtr<TlsPassword>& password, const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable) 
{
  ...
  if(base && base->ask_password_async)
  {
    (*base->ask_password_async)(gobj(),Glib::unwrap(password),const_cast<GCancellable*>(Glib::unwrap(cancellable)),&giomm_SignalProxy_async_callback,slot_copy);
  }
}
