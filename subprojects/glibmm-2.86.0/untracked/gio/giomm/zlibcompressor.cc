...
int ZlibCompressor::get_os() const
{
  return g_zlib_compressor_get_os(const_cast<GZlibCompressor*>(gobj()));
}

void ZlibCompressor::set_os(int os) const
{
  g_zlib_compressor_set_os(const_cast<GZlibCompressor*>(gobj()), os);
}
...
Glib::PropertyProxy< int > ZlibCompressor::property_os() 
{
  return Glib::PropertyProxy< int >(this, "os");
}

Glib::PropertyProxy_ReadOnly< int > ZlibCompressor::property_os() const
{
  return Glib::PropertyProxy_ReadOnly< int >(this, "os");
}
