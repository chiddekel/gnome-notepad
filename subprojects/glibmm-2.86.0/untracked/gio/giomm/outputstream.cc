...
namespace
{
using OutputStream_write_fn_vfunc_functype = gssize (*)(GOutputStream* self, const void* buffer, gsize count, GCancellable* cancellable, GError** error);
OutputStream_write_fn_vfunc_functype OutputStream_write_fn_vfunc_funcptr;
extern "C" {
static gssize OutputStream_write_fn_vfunc_c_callback(GOutputStream* self, const void* buffer, gsize count, GCancellable* cancellable, GError** error)
{
  return OutputStream_write_fn_vfunc_funcptr( self, buffer, count, cancellable, error);
}
} // extern "C"
using OutputStream_splice_vfunc_functype = gssize (*)(GOutputStream* self, GInputStream* source, GOutputStreamSpliceFlags flags, GCancellable* cancellable, GError** error);
OutputStream_splice_vfunc_functype OutputStream_splice_vfunc_funcptr;
extern "C" {
static gssize OutputStream_splice_vfunc_c_callback(GOutputStream* self, GInputStream* source, GOutputStreamSpliceFlags flags, GCancellable* cancellable, GError** error)
{
  return OutputStream_splice_vfunc_funcptr( self, source, flags, cancellable, error);
}
} // extern "C"
using OutputStream_flush_vfunc_functype = gboolean (*)(GOutputStream* self, GCancellable* cancellable, GError** error);
OutputStream_flush_vfunc_functype OutputStream_flush_vfunc_funcptr;
extern "C" {
static gboolean OutputStream_flush_vfunc_c_callback(GOutputStream* self, GCancellable* cancellable, GError** error)
{
  return OutputStream_flush_vfunc_funcptr( self, cancellable, error);
}
} // extern "C"
using OutputStream_close_fn_vfunc_functype = gboolean (*)(GOutputStream* self, GCancellable* cancellable, GError** error);
OutputStream_close_fn_vfunc_functype OutputStream_close_fn_vfunc_funcptr;
extern "C" {
static gboolean OutputStream_close_fn_vfunc_c_callback(GOutputStream* self, GCancellable* cancellable, GError** error)
{
  return OutputStream_close_fn_vfunc_funcptr( self, cancellable, error);
}
} // extern "C"
} // anonymous namespace
...
void OutputStream_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->write_fn = &OutputStream_write_fn_vfunc_c_callback;
  OutputStream_write_fn_vfunc_funcptr = &write_fn_vfunc_callback;
  klass->splice = &OutputStream_splice_vfunc_c_callback;
  OutputStream_splice_vfunc_funcptr = &splice_vfunc_callback;
  klass->flush = &OutputStream_flush_vfunc_c_callback;
  OutputStream_flush_vfunc_funcptr = &flush_vfunc_callback;
  klass->close_fn = &OutputStream_close_fn_vfunc_c_callback;
  OutputStream_close_fn_vfunc_funcptr = &close_fn_vfunc_callback;
