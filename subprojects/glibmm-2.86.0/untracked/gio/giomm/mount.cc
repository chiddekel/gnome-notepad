...
using Mount_signal_changed_functype = void (*)(GMount* self);
Mount_signal_changed_functype Mount_signal_changed_funcptr;
extern "C" {
static void Mount_signal_changed_default_callback(GMount* self)
{
  Mount_signal_changed_funcptr( self);
}
} // extern "C"
...
using Mount_signal_unmounted_functype = void (*)(GMount* self);
Mount_signal_unmounted_functype Mount_signal_unmounted_funcptr;
extern "C" {
static void Mount_signal_unmounted_default_callback(GMount* self)
{
  Mount_signal_unmounted_funcptr( self);
}
} // extern "C"
...
using Mount_signal_pre_unmount_functype = void (*)(GMount* self);
Mount_signal_pre_unmount_functype Mount_signal_pre_unmount_funcptr;
extern "C" {
static void Mount_signal_pre_unmount_default_callback(GMount* self)
{
  Mount_signal_pre_unmount_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void Mount_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->changed = &Mount_signal_changed_default_callback;
  Mount_signal_changed_funcptr = &changed_callback;
  klass->unmounted = &Mount_signal_unmounted_default_callback;
  Mount_signal_unmounted_funcptr = &unmounted_callback;
  klass->pre_unmount = &Mount_signal_pre_unmount_default_callback;
  Mount_signal_pre_unmount_funcptr = &pre_unmount_callback;
}
