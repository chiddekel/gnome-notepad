...
extern "C" {
static gboolean TlsConnection_signal_accept_certificate_connect_callback(GTlsConnection* self, GTlsCertificate* p0,GTlsCertificateFlags p1,void* data)
{
  using namespace Gio;
...
{
  "accept_certificate",
  (GCallback) &TlsConnection_signal_accept_certificate_connect_callback,
  (GCallback) &TlsConnection_signal_accept_certificate_notify_callback
};


using TlsConnection_signal_accept_certificate_functype = gboolean (*)(GTlsConnection* self, GTlsCertificate* p0, GTlsCertificateFlags p1);
TlsConnection_signal_accept_certificate_functype TlsConnection_signal_accept_certificate_funcptr;
extern "C" {
static gboolean TlsConnection_signal_accept_certificate_default_callback(GTlsConnection* self, GTlsCertificate* p0, GTlsCertificateFlags p1)
{
  return TlsConnection_signal_accept_certificate_funcptr( self, p0, p1);
}
} // extern "C"
using TlsConnection_handshake_vfunc_functype = gboolean (*)(GTlsConnection* self, GCancellable* cancellable, GError** error);
TlsConnection_handshake_vfunc_functype TlsConnection_handshake_vfunc_funcptr;
extern "C" {
static gboolean TlsConnection_handshake_vfunc_c_callback(GTlsConnection* self, GCancellable* cancellable, GError** error)
{
  return TlsConnection_handshake_vfunc_funcptr( self, cancellable, error);
}
} // extern "C"
using TlsConnection_handshake_async_vfunc_functype = void (*)(GTlsConnection* self, int io_priority, GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data);
TlsConnection_handshake_async_vfunc_functype TlsConnection_handshake_async_vfunc_funcptr;
extern "C" {
static void TlsConnection_handshake_async_vfunc_c_callback(GTlsConnection* self, int io_priority, GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
  TlsConnection_handshake_async_vfunc_funcptr( self, io_priority, cancellable, callback, user_data);
}
} // extern "C"
using TlsConnection_handshake_finish_vfunc_functype = gboolean (*)(GTlsConnection* self, GAsyncResult* result, GError** error);
TlsConnection_handshake_finish_vfunc_functype TlsConnection_handshake_finish_vfunc_funcptr;
extern "C" {
static gboolean TlsConnection_handshake_finish_vfunc_c_callback(GTlsConnection* self, GAsyncResult* result, GError** error)
{
  return TlsConnection_handshake_finish_vfunc_funcptr( self, result, error);
}
} // extern "C"
} // anonymous namespace
...
void TlsConnection_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->handshake = &TlsConnection_handshake_vfunc_c_callback;
  TlsConnection_handshake_vfunc_funcptr = &handshake_vfunc_callback;
  klass->handshake_async = &TlsConnection_handshake_async_vfunc_c_callback;
  TlsConnection_handshake_async_vfunc_funcptr = &handshake_async_vfunc_callback;
  klass->handshake_finish = &TlsConnection_handshake_finish_vfunc_c_callback;
  TlsConnection_handshake_finish_vfunc_funcptr = &handshake_finish_vfunc_callback;

  klass->accept_certificate = &TlsConnection_signal_accept_certificate_default_callback;
  TlsConnection_signal_accept_certificate_funcptr = &accept_certificate_callback;
}
...
void TlsConnection::handshake_async(const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable, int io_priority)
{
  ...
  g_tls_connection_handshake_async(gobj(), io_priority, const_cast<GCancellable*>(Glib::unwrap(cancellable)), &giomm_SignalProxy_async_callback, slot_copy);
}
...
void TlsConnection::handshake_async(const SlotAsyncReady& slot, int io_priority)
{
  ...
  g_tls_connection_handshake_async(gobj(), io_priority, nullptr, &giomm_SignalProxy_async_callback, slot_copy);
}
...
void Gio::TlsConnection::handshake_async_vfunc(const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable, int io_priority) 
{
  ...
  if(base && base->handshake_async)
  {
    (*base->handshake_async)(gobj(),io_priority,const_cast<GCancellable*>(Glib::unwrap(cancellable)),&giomm_SignalProxy_async_callback,slot_copy);
  }
}
