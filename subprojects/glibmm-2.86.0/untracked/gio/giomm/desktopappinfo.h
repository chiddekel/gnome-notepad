...
public:
   ...
   * @return A new GioUnix::DesktopAppInfo, or <tt>nullptr</tt> if no
   ...
   * @return A new GioUnix::DesktopAppInfo or <tt>nullptr</tt> on error.
   */
  ...
  /** When @a info was created from a known filename, return it.
   * 
   * In some situations such as a GioUnix::DesktopAppInfo returned
   * from GioUnix::DesktopAppInfo::new_from_keyfile(), this function
   ...
   * returned from GioUnix::DesktopAppInfo::list_actions().
   * 
   ...
   * GioUnix::DesktopAppInfo::list_actions().
