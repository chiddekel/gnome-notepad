...
namespace
{
using InputStream_read_fn_vfunc_functype = gssize (*)(GInputStream* self, void* buffer, gsize count, GCancellable* cancellable, GError** error);
InputStream_read_fn_vfunc_functype InputStream_read_fn_vfunc_funcptr;
extern "C" {
static gssize InputStream_read_fn_vfunc_c_callback(GInputStream* self, void* buffer, gsize count, GCancellable* cancellable, GError** error)
{
  return InputStream_read_fn_vfunc_funcptr( self, buffer, count, cancellable, error);
}
} // extern "C"
using InputStream_skip_vfunc_functype = gssize (*)(GInputStream* self, gsize count, GCancellable* cancellable, GError** error);
InputStream_skip_vfunc_functype InputStream_skip_vfunc_funcptr;
extern "C" {
static gssize InputStream_skip_vfunc_c_callback(GInputStream* self, gsize count, GCancellable* cancellable, GError** error)
{
  return InputStream_skip_vfunc_funcptr( self, count, cancellable, error);
}
} // extern "C"
using InputStream_close_fn_vfunc_functype = gboolean (*)(GInputStream* self, GCancellable* cancellable, GError** error);
InputStream_close_fn_vfunc_functype InputStream_close_fn_vfunc_funcptr;
extern "C" {
static gboolean InputStream_close_fn_vfunc_c_callback(GInputStream* self, GCancellable* cancellable, GError** error)
{
  return InputStream_close_fn_vfunc_funcptr( self, cancellable, error);
}
} // extern "C"
} // anonymous namespace
...
void InputStream_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->read_fn = &InputStream_read_fn_vfunc_c_callback;
  InputStream_read_fn_vfunc_funcptr = &read_fn_vfunc_callback;
  klass->skip = &InputStream_skip_vfunc_c_callback;
  InputStream_skip_vfunc_funcptr = &skip_vfunc_callback;
  klass->close_fn = &InputStream_close_fn_vfunc_c_callback;
  InputStream_close_fn_vfunc_funcptr = &close_fn_vfunc_callback;
