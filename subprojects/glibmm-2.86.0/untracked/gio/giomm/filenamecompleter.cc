...
using FilenameCompleter_signal_got_completion_data_functype = void (*)(GFilenameCompleter* self);
FilenameCompleter_signal_got_completion_data_functype FilenameCompleter_signal_got_completion_data_funcptr;
extern "C" {
static void FilenameCompleter_signal_got_completion_data_default_callback(GFilenameCompleter* self)
{
  FilenameCompleter_signal_got_completion_data_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void FilenameCompleter_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->got_completion_data = &FilenameCompleter_signal_got_completion_data_default_callback;
  FilenameCompleter_signal_got_completion_data_funcptr = &got_completion_data_callback;
}
