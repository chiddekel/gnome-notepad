...
public:
   ...
   * 
   * If not overridden this value will be inherited from Gio::InetSocketAddress::property_address().
   * 
   * @newin{2,32}
   * 
   ...
   * 
   * If unset this property is inherited from Gio::InetSocketAddress::property_address().
   * 
   * @newin{2,32}
   *
   * Default value: 0
