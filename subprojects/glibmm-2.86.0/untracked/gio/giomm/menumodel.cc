...
extern "C" {
static void MenuModel_signal_items_changed_connect_callback(GMenuModel* self, gint p0,gint p1,gint p2,void* data)
{
  using namespace Gio;
...
{
  "items-changed",
  (GCallback) &MenuModel_signal_items_changed_connect_callback,
  (GCallback) &MenuModel_signal_items_changed_connect_callback
};
