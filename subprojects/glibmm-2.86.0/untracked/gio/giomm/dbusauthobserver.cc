...
extern "C" {
static gboolean AuthObserver_signal_authorize_authenticated_peer_connect_callback(GDBusAuthObserver* self, GIOStream* p0,GCredentials* p1,void* data)
{
...
static const Glib::SignalProxyInfo AuthObserver_signal_authorize_authenticated_peer_info =
{
  ...
  (GCallback) &AuthObserver_signal_authorize_authenticated_peer_connect_callback,
  (GCallback) &AuthObserver_signal_authorize_authenticated_peer_notify_callback
};


extern "C" {
static gboolean AuthObserver_signal_allow_mechanism_connect_callback(GDBusAuthObserver* self, const gchar* p0,void* data)
{
  using namespace Gio::DBus;
...
{
  "allow_mechanism",
  (GCallback) &AuthObserver_signal_allow_mechanism_connect_callback,
