...
InetAddress::InetAddress(const guint8* bytes, SocketFamily family, guint32 flowinfo, guint32 scope_id)
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(nullptr),
  Glib::Object(Glib::ConstructParams(inetaddress_class_.init(), "bytes", bytes, "family", static_cast<GSocketFamily>(family), "flowinfo", flowinfo, "scope_id", scope_id, nullptr))
{
...
Glib::RefPtr<InetAddress> InetAddress::create(const guint8* bytes, SocketFamily family, guint32 flowinfo, guint32 scope_id)
{
  return Glib::make_refptr_for_instance<InetAddress>( new InetAddress(bytes, family, flowinfo, scope_id) );
}
...
guint32 InetAddress::get_scope_id() const
{
  return g_inet_address_get_scope_id(const_cast<GInetAddress*>(gobj()));
}

guint32 InetAddress::get_flowinfo() const
{
  return g_inet_address_get_flowinfo(const_cast<GInetAddress*>(gobj()));
}
...
Glib::PropertyProxy_ReadOnly< guint > InetAddress::property_flowinfo() const
{
  return Glib::PropertyProxy_ReadOnly< guint >(this, "flowinfo");
}

Glib::PropertyProxy_ReadOnly< guint > InetAddress::property_scope_id() const
{
