...
namespace
{
using SocketControlMessage_get_size_vfunc_functype = gsize (*)(GSocketControlMessage* self);
SocketControlMessage_get_size_vfunc_functype SocketControlMessage_get_size_vfunc_funcptr;
extern "C" {
static gsize SocketControlMessage_get_size_vfunc_c_callback(GSocketControlMessage* self)
{
  return SocketControlMessage_get_size_vfunc_funcptr( self);
}
} // extern "C"
using SocketControlMessage_get_level_vfunc_functype = int (*)(GSocketControlMessage* self);
SocketControlMessage_get_level_vfunc_functype SocketControlMessage_get_level_vfunc_funcptr;
extern "C" {
static int SocketControlMessage_get_level_vfunc_c_callback(GSocketControlMessage* self)
{
  return SocketControlMessage_get_level_vfunc_funcptr( self);
}
} // extern "C"
using SocketControlMessage_get_type_vfunc_functype = int (*)(GSocketControlMessage* self);
SocketControlMessage_get_type_vfunc_functype SocketControlMessage_get_type_vfunc_funcptr;
extern "C" {
static int SocketControlMessage_get_type_vfunc_c_callback(GSocketControlMessage* self)
{
  return SocketControlMessage_get_type_vfunc_funcptr( self);
}
} // extern "C"
using SocketControlMessage_serialize_vfunc_functype = void (*)(GSocketControlMessage* self, gpointer data);
SocketControlMessage_serialize_vfunc_functype SocketControlMessage_serialize_vfunc_funcptr;
extern "C" {
static void SocketControlMessage_serialize_vfunc_c_callback(GSocketControlMessage* self, gpointer data)
{
  SocketControlMessage_serialize_vfunc_funcptr( self, data);
}
} // extern "C"
} // anonymous namespace
...
void SocketControlMessage_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  SocketControlMessage_deserialize_vfunc_funcptr = &deserialize_vfunc_callback;
    klass->get_size = &SocketControlMessage_get_size_vfunc_c_callback;
  SocketControlMessage_get_size_vfunc_funcptr = &get_size_vfunc_callback;
  klass->get_level = &SocketControlMessage_get_level_vfunc_c_callback;
  SocketControlMessage_get_level_vfunc_funcptr = &get_level_vfunc_callback;
  klass->get_type = &SocketControlMessage_get_type_vfunc_c_callback;
  SocketControlMessage_get_type_vfunc_funcptr = &get_type_vfunc_callback;
  klass->serialize = &SocketControlMessage_serialize_vfunc_c_callback;
  SocketControlMessage_serialize_vfunc_funcptr = &serialize_vfunc_callback;
