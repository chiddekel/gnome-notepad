...
bool Resource::has_children(const std::string& path) const
{
  return g_resource_has_children(const_cast<GResource*>(gobj()), path.c_str());
}
...
bool Resource::has_children_global(const std::string& path)
{
  return g_resources_has_children(path.c_str());
}
