...
extern "C" {
static void FileMonitor_signal_changed_connect_callback(GFileMonitor* self, GFile* p0,GFile* p1,GFileMonitorEvent p2,void* data)
{
  using namespace Gio;
...
{
  "changed",
  (GCallback) &FileMonitor_signal_changed_connect_callback,
  (GCallback) &FileMonitor_signal_changed_connect_callback
};


using FileMonitor_signal_changed_functype = void (*)(GFileMonitor* self, GFile* p0, GFile* p1, GFileMonitorEvent p2);
FileMonitor_signal_changed_functype FileMonitor_signal_changed_funcptr;
extern "C" {
static void FileMonitor_signal_changed_default_callback(GFileMonitor* self, GFile* p0, GFile* p1, GFileMonitorEvent p2)
{
  FileMonitor_signal_changed_funcptr( self, p0, p1, p2);
}
} // extern "C"
} // anonymous namespace
...
void FileMonitor_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->changed = &FileMonitor_signal_changed_default_callback;
  FileMonitor_signal_changed_funcptr = &changed_callback;
}
