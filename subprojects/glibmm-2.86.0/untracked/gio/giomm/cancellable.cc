...
using Cancellable_signal_cancelled_functype = void (*)(GCancellable* self);
Cancellable_signal_cancelled_functype Cancellable_signal_cancelled_funcptr;
extern "C" {
static void Cancellable_signal_cancelled_default_callback(GCancellable* self)
{
  Cancellable_signal_cancelled_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void Cancellable_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->cancelled = &Cancellable_signal_cancelled_default_callback;
  Cancellable_signal_cancelled_funcptr = &cancelled_callback;
}
