...
Glib::DBusObjectPathString Message::get_arg0_path() const
{
  return Glib::convert_const_gchar_ptr_to_dbus_object_path_string(g_dbus_message_get_arg0_path(const_cast<GDBusMessage*>(gobj())));
}
