...
using Resolver_signal_reload_functype = void (*)(GResolver* self);
Resolver_signal_reload_functype Resolver_signal_reload_funcptr;
extern "C" {
static void Resolver_signal_reload_default_callback(GResolver* self)
{
  Resolver_signal_reload_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void Resolver_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->reload = &Resolver_signal_reload_default_callback;
  Resolver_signal_reload_funcptr = &reload_callback;
}
...
void Resolver::lookup_by_name_with_flags_async(const Glib::ustring& hostname, NameLookupFlags flags, const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable)
{
  ...
  g_resolver_lookup_by_name_with_flags_async(gobj(), hostname.c_str(), static_cast<GResolverNameLookupFlags>(flags), const_cast<GCancellable*>(Glib::unwrap(cancellable)), &giomm_SignalProxy_async_callback, slot_copy);
}
...
unsigned Resolver::get_timeout() const
{
  return g_resolver_get_timeout(const_cast<GResolver*>(gobj()));
}

void Resolver::set_timeout(unsigned timeout_ms)
{
  g_resolver_set_timeout(gobj(), timeout_ms);
}
...
Glib::PropertyProxy< unsigned int > Resolver::property_timeout() 
{
  return Glib::PropertyProxy< unsigned int >(this, "timeout");
}

Glib::PropertyProxy_ReadOnly< unsigned int > Resolver::property_timeout() const
{
  return Glib::PropertyProxy_ReadOnly< unsigned int >(this, "timeout");
}
