...
namespace
{
using Converter_convert_vfunc_functype = GConverterResult (*)(GConverter* self, const void* inbuf, gsize inbuf_size, void* outbuf, gsize outbuf_size, GConverterFlags flags, gsize* bytes_read, gsize* bytes_written, GError** error);
Converter_convert_vfunc_functype Converter_convert_vfunc_funcptr;
extern "C" {
static GConverterResult Converter_convert_vfunc_c_callback(GConverter* self, const void* inbuf, gsize inbuf_size, void* outbuf, gsize outbuf_size, GConverterFlags flags, gsize* bytes_read, gsize* bytes_written, GError** error)
{
  return Converter_convert_vfunc_funcptr( self, inbuf, inbuf_size, outbuf, outbuf_size, flags, bytes_read, bytes_written, error);
}
} // extern "C"
using Converter_reset_vfunc_functype = void (*)(GConverter* self);
Converter_reset_vfunc_functype Converter_reset_vfunc_funcptr;
extern "C" {
static void Converter_reset_vfunc_c_callback(GConverter* self)
{
  Converter_reset_vfunc_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void Converter_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->convert = &Converter_convert_vfunc_c_callback;
  Converter_convert_vfunc_funcptr = &convert_vfunc_callback;
  klass->reset = &Converter_reset_vfunc_c_callback;
  Converter_reset_vfunc_funcptr = &reset_vfunc_callback;
...
Glib::RefPtr<Glib::Bytes> Converter::convert(const Glib::RefPtr<const Glib::Bytes>& bytes)
{
  GError* gerror = nullptr;
  auto retvalue = Glib::wrap(g_converter_convert_bytes(gobj(), const_cast<GBytes*>(Glib::unwrap<Glib::Bytes>(bytes)), &(gerror)));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
