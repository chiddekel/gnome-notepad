...
extern "C" {
static void NetworkMonitor_signal_network_changed_connect_callback(GNetworkMonitor* self, gboolean p0,void* data)
{
  using namespace Gio;
...
{
  "network-changed",
  (GCallback) &NetworkMonitor_signal_network_changed_connect_callback,
  (GCallback) &NetworkMonitor_signal_network_changed_connect_callback
};


using NetworkMonitor_signal_network_changed_functype = void (*)(GNetworkMonitor* self, gboolean p0);
NetworkMonitor_signal_network_changed_functype NetworkMonitor_signal_network_changed_funcptr;
extern "C" {
static void NetworkMonitor_signal_network_changed_default_callback(GNetworkMonitor* self, gboolean p0)
{
  NetworkMonitor_signal_network_changed_funcptr( self, p0);
}
} // extern "C"
} // anonymous namespace
...
void NetworkMonitor_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->network_changed = &NetworkMonitor_signal_network_changed_default_callback;
  NetworkMonitor_signal_network_changed_funcptr = &network_changed_callback;
}
...
Glib::RefPtr<NetworkMonitor> NetworkMonitor::get_default()
{
  ...
  auto retvalue = Glib::wrap(g_network_monitor_get_default());
  if(retvalue)
