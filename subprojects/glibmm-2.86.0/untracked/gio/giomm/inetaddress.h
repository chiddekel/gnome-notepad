...
protected:
    ...
    explicit InetAddress(const guint8* bytes, SocketFamily family, guint32 flowinfo, guint32 scope_id);
...
public:
  ...
  /** Creates a new %Gio::InetAddress from the given @c family, @c bytes and @c scope_id.
   *
   * @c bytes must be 4 bytes for Gio::SocketFamily::IPV4 and 16 bytes for
   * Gio::SocketFamily::IPV6.
   *
   * @param bytes Raw address data.
   * @param family The address family of @c bytes.
   * @param scope_id The scope-id of the address.
   * @return A new internet address corresponding to @c family, @c bytes and @c scope_id
   * @newin{2,86}
   */
  
  static Glib::RefPtr<InetAddress> create(const guint8* bytes, SocketFamily family, guint32 flowinfo, guint32 scope_id);
  ...
  /** Gets the value of Gio::InetAddress::property_scope_id().
   * 
   * @newin{2,86}
   * 
   * @return The scope-id for the address, `0` if unset or not IPv6 address.
   */
  guint32 get_scope_id() const;
  
  /** Gets the value of Gio::InetAddress::property_flowinfo().
   * 
   * @newin{2,86}
   * 
   * @return The flowinfo for the address, `0` if unset or not IPv6 address.
   */
   ...
   * See Gio::InetAddress::get_flowinfo().
   * 
   * @newin{2,86}
   *
   * Default value: 0
   ...
   * See Gio::InetAddress::get_scope_id().
   * 
   * @newin{2,86}
   *
   * Default value: 0
