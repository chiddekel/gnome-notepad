...
using Application_signal_startup_functype = void (*)(GApplication* self);
Application_signal_startup_functype Application_signal_startup_funcptr;
extern "C" {
static void Application_signal_startup_default_callback(GApplication* self)
{
  Application_signal_startup_funcptr( self);
}
} // extern "C"
...
using Application_signal_shutdown_functype = void (*)(GApplication* self);
Application_signal_shutdown_functype Application_signal_shutdown_funcptr;
extern "C" {
static void Application_signal_shutdown_default_callback(GApplication* self)
{
  Application_signal_shutdown_funcptr( self);
}
} // extern "C"
...
using Application_signal_activate_functype = void (*)(GApplication* self);
Application_signal_activate_functype Application_signal_activate_funcptr;
extern "C" {
static void Application_signal_activate_default_callback(GApplication* self)
{
  Application_signal_activate_funcptr( self);
}
} // extern "C"


extern "C" {
static gint Application_signal_command_line_connect_callback(GApplication* self, GApplicationCommandLine* p0,void* data)
{
  using namespace Gio;
...
{
  "command-line",
  (GCallback) &Application_signal_command_line_connect_callback,
  (GCallback) &Application_signal_command_line_notify_callback
};


using Application_signal_command_line_functype = gint (*)(GApplication* self, GApplicationCommandLine* p0);
Application_signal_command_line_functype Application_signal_command_line_funcptr;
extern "C" {
static gint Application_signal_command_line_default_callback(GApplication* self, GApplicationCommandLine* p0)
{
  return Application_signal_command_line_funcptr( self, p0);
}
} // extern "C"


extern "C" {
static gint Application_signal_handle_local_options_connect_callback(GApplication* self, GVariantDict* p0,void* data)
{
  using namespace Gio;
...
static const Glib::SignalProxyInfo Application_signal_handle_local_options_info =
{
  ...
  (GCallback) &Application_signal_handle_local_options_connect_callback,
  (GCallback) &Application_signal_handle_local_options_notify_callback
};


using Application_signal_handle_local_options_functype = gint (*)(GApplication* self, GVariantDict* p0);
Application_signal_handle_local_options_functype Application_signal_handle_local_options_funcptr;
extern "C" {
static gint Application_signal_handle_local_options_default_callback(GApplication* self, GVariantDict* p0)
{
  return Application_signal_handle_local_options_funcptr( self, p0);
}
} // extern "C"


extern "C" {
static gboolean Application_signal_name_lost_connect_callback(GApplication* self, void* data)
{
  using namespace Gio;
...
{
  "name-lost",
  (GCallback) &Application_signal_name_lost_connect_callback,
  (GCallback) &Application_signal_name_lost_notify_callback
};


using Application_signal_name_lost_functype = gboolean (*)(GApplication* self);
Application_signal_name_lost_functype Application_signal_name_lost_funcptr;
extern "C" {
static gboolean Application_signal_name_lost_default_callback(GApplication* self)
{
  return Application_signal_name_lost_funcptr( self);
}
} // extern "C"
using Application_local_command_line_vfunc_functype = gboolean (*)(GApplication* self, gchar*** arguments, int* exit_status);
Application_local_command_line_vfunc_functype Application_local_command_line_vfunc_funcptr;
extern "C" {
static gboolean Application_local_command_line_vfunc_c_callback(GApplication* self, gchar*** arguments, int* exit_status)
{
  return Application_local_command_line_vfunc_funcptr( self, arguments, exit_status);
}
} // extern "C"
using Application_before_emit_vfunc_functype = void (*)(GApplication* self, GVariant* platform_data);
Application_before_emit_vfunc_functype Application_before_emit_vfunc_funcptr;
extern "C" {
static void Application_before_emit_vfunc_c_callback(GApplication* self, GVariant* platform_data)
{
  Application_before_emit_vfunc_funcptr( self, platform_data);
}
} // extern "C"
using Application_after_emit_vfunc_functype = void (*)(GApplication* self, GVariant* platform_data);
Application_after_emit_vfunc_functype Application_after_emit_vfunc_funcptr;
extern "C" {
static void Application_after_emit_vfunc_c_callback(GApplication* self, GVariant* platform_data)
{
  Application_after_emit_vfunc_funcptr( self, platform_data);
}
} // extern "C"
using Application_quit_mainloop_vfunc_functype = void (*)(GApplication* self);
Application_quit_mainloop_vfunc_functype Application_quit_mainloop_vfunc_funcptr;
extern "C" {
static void Application_quit_mainloop_vfunc_c_callback(GApplication* self)
{
  Application_quit_mainloop_vfunc_funcptr( self);
}
} // extern "C"
using Application_run_mainloop_vfunc_functype = void (*)(GApplication* self);
Application_run_mainloop_vfunc_functype Application_run_mainloop_vfunc_funcptr;
extern "C" {
static void Application_run_mainloop_vfunc_c_callback(GApplication* self)
{
  Application_run_mainloop_vfunc_funcptr( self);
}
} // extern "C"
using Application_dbus_register_vfunc_functype = gboolean (*)(GApplication* self, GDBusConnection* connection, const gchar* object_path, GError** error);
Application_dbus_register_vfunc_functype Application_dbus_register_vfunc_funcptr;
extern "C" {
static gboolean Application_dbus_register_vfunc_c_callback(GApplication* self, GDBusConnection* connection, const gchar* object_path, GError** error)
{
  return Application_dbus_register_vfunc_funcptr( self, connection, object_path, error);
}
} // extern "C"
using Application_dbus_unregister_vfunc_functype = void (*)(GApplication* self, GDBusConnection* connection, const gchar* object_path);
Application_dbus_unregister_vfunc_functype Application_dbus_unregister_vfunc_funcptr;
extern "C" {
static void Application_dbus_unregister_vfunc_c_callback(GApplication* self, GDBusConnection* connection, const gchar* object_path)
{
  Application_dbus_unregister_vfunc_funcptr( self, connection, object_path);
}
} // extern "C"
} // anonymous namespace
...
void Application_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->local_command_line = &Application_local_command_line_vfunc_c_callback;
  Application_local_command_line_vfunc_funcptr = &local_command_line_vfunc_callback;
  klass->before_emit = &Application_before_emit_vfunc_c_callback;
  Application_before_emit_vfunc_funcptr = &before_emit_vfunc_callback;
  klass->after_emit = &Application_after_emit_vfunc_c_callback;
  Application_after_emit_vfunc_funcptr = &after_emit_vfunc_callback;
  klass->quit_mainloop = &Application_quit_mainloop_vfunc_c_callback;
  Application_quit_mainloop_vfunc_funcptr = &quit_mainloop_vfunc_callback;
  klass->run_mainloop = &Application_run_mainloop_vfunc_c_callback;
  Application_run_mainloop_vfunc_funcptr = &run_mainloop_vfunc_callback;
  klass->dbus_register = &Application_dbus_register_vfunc_c_callback;
  Application_dbus_register_vfunc_funcptr = &dbus_register_vfunc_callback;
  klass->dbus_unregister = &Application_dbus_unregister_vfunc_c_callback;
  Application_dbus_unregister_vfunc_funcptr = &dbus_unregister_vfunc_callback;

  klass->startup = &Application_signal_startup_default_callback;
  Application_signal_startup_funcptr = &startup_callback;
  klass->shutdown = &Application_signal_shutdown_default_callback;
  Application_signal_shutdown_funcptr = &shutdown_callback;
  klass->activate = &Application_signal_activate_default_callback;
  Application_signal_activate_funcptr = &activate_callback;
  klass->command_line = &Application_signal_command_line_default_callback;
  Application_signal_command_line_funcptr = &command_line_callback;
  klass->handle_local_options = &Application_signal_handle_local_options_default_callback;
  Application_signal_handle_local_options_funcptr = &handle_local_options_callback;
  klass->name_lost = &Application_signal_name_lost_default_callback;
  Application_signal_name_lost_funcptr = &name_lost_callback;
...
Glib::ustring Application::get_version() const
{
  return Glib::convert_const_gchar_ptr_to_ustring(g_application_get_version(const_cast<GApplication*>(gobj())));
}

void Application::set_version(const Glib::ustring& version)
{
  g_application_set_version(gobj(), version.c_str());
}
...
Glib::PropertyProxy< Glib::ustring > Application::property_version() 
{
  return Glib::PropertyProxy< Glib::ustring >(this, "version");
}

Glib::PropertyProxy_ReadOnly< Glib::ustring > Application::property_version() const
{
