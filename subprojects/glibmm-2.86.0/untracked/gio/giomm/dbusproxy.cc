...
extern "C" {
static void Proxy_signal_properties_changed_connect_callback(GDBusProxy* self, GVariant* p0,const gchar*const* p1,void* data)
{
...
static const Glib::SignalProxyInfo Proxy_signal_properties_changed_info =
{
  ...
  (GCallback) &Proxy_signal_properties_changed_connect_callback,
  (GCallback) &Proxy_signal_properties_changed_connect_callback
};


using Proxy_signal_g_properties_changed_functype = void (*)(GDBusProxy* self, GVariant* p0, const gchar*const* p1);
Proxy_signal_g_properties_changed_functype Proxy_signal_g_properties_changed_funcptr;
extern "C" {
static void Proxy_signal_g_properties_changed_default_callback(GDBusProxy* self, GVariant* p0, const gchar*const* p1)
{
  Proxy_signal_g_properties_changed_funcptr( self, p0, p1);
}
} // extern "C"


extern "C" {
static void Proxy_signal_signal_connect_callback(GDBusProxy* self, const gchar* p0,const gchar* p1,GVariant* p2,void* data)
{
  using namespace Gio::DBus;
...
{
  "g-signal",
  (GCallback) &Proxy_signal_signal_connect_callback,
  (GCallback) &Proxy_signal_signal_connect_callback
};


using Proxy_signal_g_signal_functype = void (*)(GDBusProxy* self, const gchar* p0, const gchar* p1, GVariant* p2);
Proxy_signal_g_signal_functype Proxy_signal_g_signal_funcptr;
extern "C" {
static void Proxy_signal_g_signal_default_callback(GDBusProxy* self, const gchar* p0, const gchar* p1, GVariant* p2)
{
  Proxy_signal_g_signal_funcptr( self, p0, p1, p2);
}
} // extern "C"
} // anonymous namespace
...
void Proxy_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->g_properties_changed = &Proxy_signal_g_properties_changed_default_callback;
  Proxy_signal_g_properties_changed_funcptr = &g_properties_changed_callback;
  klass->g_signal = &Proxy_signal_g_signal_default_callback;
  Proxy_signal_g_signal_funcptr = &g_signal_callback;
}
...
void Proxy::call(const Glib::ustring& method_name, const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable, const Glib::VariantContainerBase& parameters, int timeout_msec, CallFlags flags)
{
  ...
  g_dbus_proxy_call(gobj(), method_name.c_str(), const_cast<GVariant*>((parameters).gobj()), static_cast<GDBusCallFlags>(flags), timeout_msec, const_cast<GCancellable*>(Glib::unwrap(cancellable)), &giomm_SignalProxy_async_callback, slot_copy);
}
...
void Proxy::call(const Glib::ustring& method_name, const SlotAsyncReady& slot, const Glib::VariantContainerBase& parameters, int timeout_msec, CallFlags flags)
{
  ...
  g_dbus_proxy_call(gobj(), method_name.c_str(), const_cast<GVariant*>((parameters).gobj()), static_cast<GDBusCallFlags>(flags), timeout_msec, nullptr, &giomm_SignalProxy_async_callback, slot_copy);
}
...
void Proxy::call(const Glib::ustring& method_name, const Glib::VariantContainerBase& parameters, const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable, const Glib::RefPtr<UnixFDList>& fd_list, int timeout_msec, CallFlags flags)
{
  ...
  g_dbus_proxy_call_with_unix_fd_list(gobj(), method_name.c_str(), const_cast<GVariant*>((parameters).gobj()), static_cast<GDBusCallFlags>(flags), timeout_msec, Glib::unwrap(fd_list), const_cast<GCancellable*>(Glib::unwrap(cancellable)), &giomm_SignalProxy_async_callback, slot_copy);
}
#endif // G_OS_UNIX
...
void Proxy::call(const Glib::ustring& method_name, const Glib::VariantContainerBase& parameters, const SlotAsyncReady& slot, const Glib::RefPtr<UnixFDList>& fd_list, int timeout_msec, CallFlags flags)
{
  ...
  g_dbus_proxy_call_with_unix_fd_list(gobj(), method_name.c_str(), const_cast<GVariant*>((parameters).gobj()), static_cast<GDBusCallFlags>(flags), timeout_msec, Glib::unwrap(fd_list), nullptr, &giomm_SignalProxy_async_callback, slot_copy);
}
#endif // G_OS_UNIX
