...
extern "C" {
static gboolean ThreadedSocketService_signal_run_connect_callback(GThreadedSocketService* self, GSocketConnection* p0,GObject* p1,void* data)
{
  using namespace Gio;
...
{
  "run",
  (GCallback) &ThreadedSocketService_signal_run_connect_callback,
  (GCallback) &ThreadedSocketService_signal_run_notify_callback
};


using ThreadedSocketService_signal_run_functype = gboolean (*)(GThreadedSocketService* self, GSocketConnection* p0, GObject* p1);
ThreadedSocketService_signal_run_functype ThreadedSocketService_signal_run_funcptr;
extern "C" {
static gboolean ThreadedSocketService_signal_run_default_callback(GThreadedSocketService* self, GSocketConnection* p0, GObject* p1)
{
  return ThreadedSocketService_signal_run_funcptr( self, p0, p1);
}
} // extern "C"
} // anonymous namespace
...
void ThreadedSocketService_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->run = &ThreadedSocketService_signal_run_default_callback;
  ThreadedSocketService_signal_run_funcptr = &run_callback;
}
