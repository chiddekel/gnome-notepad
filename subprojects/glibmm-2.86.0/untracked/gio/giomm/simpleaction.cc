...
extern "C" {
static void SimpleAction_signal_activate_connect_callback(GSimpleAction* self, GVariant* p0,void* data)
{
  using namespace Gio;
...
{
  "activate",
  (GCallback) &SimpleAction_signal_activate_connect_callback,
  (GCallback) &SimpleAction_signal_activate_connect_callback
};


extern "C" {
static void SimpleAction_signal_change_state_connect_callback(GSimpleAction* self, GVariant* p0,void* data)
{
  using namespace Gio;
  using SlotType = sigc::slot<void(const Glib::VariantBase&)>;
...
{
  "change-state",
  (GCallback) &SimpleAction_signal_change_state_connect_callback,
  (GCallback) &SimpleAction_signal_change_state_connect_callback
};
