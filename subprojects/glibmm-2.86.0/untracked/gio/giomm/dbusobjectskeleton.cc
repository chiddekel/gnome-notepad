...
extern "C" {
static gboolean ObjectSkeleton_signal_authorize_method_connect_callback(GDBusObjectSkeleton* self, GDBusInterfaceSkeleton* p0,GDBusMethodInvocation* p1,void* data)
{
...
{
  "authorize-method",
  (GCallback) &ObjectSkeleton_signal_authorize_method_connect_callback,
  (GCallback) &ObjectSkeleton_signal_authorize_method_notify_callback
};


using ObjectSkeleton_signal_authorize_method_functype = gboolean (*)(GDBusObjectSkeleton* self, GDBusInterfaceSkeleton* p0, GDBusMethodInvocation* p1);
ObjectSkeleton_signal_authorize_method_functype ObjectSkeleton_signal_authorize_method_funcptr;
extern "C" {
static gboolean ObjectSkeleton_signal_authorize_method_default_callback(GDBusObjectSkeleton* self, GDBusInterfaceSkeleton* p0, GDBusMethodInvocation* p1)
{
  return ObjectSkeleton_signal_authorize_method_funcptr( self, p0, p1);
}
} // extern "C"
} // anonymous namespace
...
void ObjectSkeleton_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->authorize_method = &ObjectSkeleton_signal_authorize_method_default_callback;
  ObjectSkeleton_signal_authorize_method_funcptr = &authorize_method_callback;
}
