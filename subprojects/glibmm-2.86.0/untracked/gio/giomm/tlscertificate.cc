...
namespace
{
using TlsCertificate_verify_vfunc_functype = GTlsCertificateFlags (*)(GTlsCertificate* self, GSocketConnectable* identity, GTlsCertificate* trusted_ca);
TlsCertificate_verify_vfunc_functype TlsCertificate_verify_vfunc_funcptr;
extern "C" {
static GTlsCertificateFlags TlsCertificate_verify_vfunc_c_callback(GTlsCertificate* self, GSocketConnectable* identity, GTlsCertificate* trusted_ca)
{
  return TlsCertificate_verify_vfunc_funcptr( self, identity, trusted_ca);
}
} // extern "C"
} // anonymous namespace
...
void TlsCertificate_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->verify = &TlsCertificate_verify_vfunc_c_callback;
  TlsCertificate_verify_vfunc_funcptr = &verify_vfunc_callback;
