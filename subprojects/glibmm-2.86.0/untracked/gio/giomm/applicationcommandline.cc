...
{
  g_application_command_line_print_literal(gobj(), message.c_str());
}

void ApplicationCommandLine::printerr(const Glib::ustring& message)
{
  g_application_command_line_printerr_literal(gobj(), message.c_str());
}
...
void ApplicationCommandLine::done()
{
  g_application_command_line_done(gobj());
}
