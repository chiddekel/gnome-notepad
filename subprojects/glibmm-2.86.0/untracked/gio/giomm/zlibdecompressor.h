...
public:
   ...
   * @return A new Gio::ZlibDecompressor.
   */
  ...
  /** Gets the Gio::ZlibDecompressor::property_file_info() property.
   * 
   * @newin{2,26}
   * 
   * @return File info from the gzip header, if available.
   */
   ...
   * 
   * This will be <tt>nullptr</tt> if the header was not yet fully processed, is not
   * present at all, or the compressor’s Gio::ZlibDecompressor::property_format()
