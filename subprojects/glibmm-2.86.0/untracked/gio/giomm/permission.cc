...
namespace
{
using Permission_acquire_vfunc_functype = gboolean (*)(GPermission* self, GCancellable* cancellable, GError** error);
Permission_acquire_vfunc_functype Permission_acquire_vfunc_funcptr;
extern "C" {
static gboolean Permission_acquire_vfunc_c_callback(GPermission* self, GCancellable* cancellable, GError** error)
{
  return Permission_acquire_vfunc_funcptr( self, cancellable, error);
}
} // extern "C"
using Permission_acquire_async_vfunc_functype = void (*)(GPermission* self, GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data);
Permission_acquire_async_vfunc_functype Permission_acquire_async_vfunc_funcptr;
extern "C" {
static void Permission_acquire_async_vfunc_c_callback(GPermission* self, GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
  Permission_acquire_async_vfunc_funcptr( self, cancellable, callback, user_data);
}
} // extern "C"
using Permission_acquire_finish_vfunc_functype = gboolean (*)(GPermission* self, GAsyncResult* result, GError** error);
Permission_acquire_finish_vfunc_functype Permission_acquire_finish_vfunc_funcptr;
extern "C" {
static gboolean Permission_acquire_finish_vfunc_c_callback(GPermission* self, GAsyncResult* result, GError** error)
{
  return Permission_acquire_finish_vfunc_funcptr( self, result, error);
}
} // extern "C"
using Permission_release_vfunc_functype = gboolean (*)(GPermission* self, GCancellable* cancellable, GError** error);
Permission_release_vfunc_functype Permission_release_vfunc_funcptr;
extern "C" {
static gboolean Permission_release_vfunc_c_callback(GPermission* self, GCancellable* cancellable, GError** error)
{
  return Permission_release_vfunc_funcptr( self, cancellable, error);
}
} // extern "C"
using Permission_release_async_vfunc_functype = void (*)(GPermission* self, GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data);
Permission_release_async_vfunc_functype Permission_release_async_vfunc_funcptr;
extern "C" {
static void Permission_release_async_vfunc_c_callback(GPermission* self, GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
  Permission_release_async_vfunc_funcptr( self, cancellable, callback, user_data);
}
} // extern "C"
using Permission_release_finish_vfunc_functype = gboolean (*)(GPermission* self, GAsyncResult* result, GError** error);
Permission_release_finish_vfunc_functype Permission_release_finish_vfunc_funcptr;
extern "C" {
static gboolean Permission_release_finish_vfunc_c_callback(GPermission* self, GAsyncResult* result, GError** error)
{
  return Permission_release_finish_vfunc_funcptr( self, result, error);
}
} // extern "C"
} // anonymous namespace
...
void Permission_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->acquire = &Permission_acquire_vfunc_c_callback;
  Permission_acquire_vfunc_funcptr = &acquire_vfunc_callback;
  klass->acquire_async = &Permission_acquire_async_vfunc_c_callback;
  Permission_acquire_async_vfunc_funcptr = &acquire_async_vfunc_callback;
  klass->acquire_finish = &Permission_acquire_finish_vfunc_c_callback;
  Permission_acquire_finish_vfunc_funcptr = &acquire_finish_vfunc_callback;
  klass->release = &Permission_release_vfunc_c_callback;
  Permission_release_vfunc_funcptr = &release_vfunc_callback;
  klass->release_async = &Permission_release_async_vfunc_c_callback;
  Permission_release_async_vfunc_funcptr = &release_async_vfunc_callback;
  klass->release_finish = &Permission_release_finish_vfunc_c_callback;
  Permission_release_finish_vfunc_funcptr = &release_finish_vfunc_callback;
...
void Permission::acquire_async(const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable)
{
  ...
  g_permission_acquire_async(gobj(), const_cast<GCancellable*>(Glib::unwrap(cancellable)), &giomm_SignalProxy_async_callback, slot_copy);
}
...
void Permission::acquire_async(const SlotAsyncReady& slot)
{
  ...
  g_permission_acquire_async(gobj(), nullptr, &giomm_SignalProxy_async_callback, slot_copy);
}
...
void Permission::release_async(const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable)
{
  ...
  g_permission_release_async(gobj(), const_cast<GCancellable*>(Glib::unwrap(cancellable)), &giomm_SignalProxy_async_callback, slot_copy);
}
...
void Permission::release_async(const SlotAsyncReady& slot)
{
  ...
  g_permission_release_async(gobj(), nullptr, &giomm_SignalProxy_async_callback, slot_copy);
}
...
void Gio::Permission::acquire_async_vfunc(const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable) 
{
  ...
  if(base && base->acquire_async)
  {
    (*base->acquire_async)(gobj(),const_cast<GCancellable*>(Glib::unwrap(cancellable)),&giomm_SignalProxy_async_callback,slot_copy);
  }
}
...
void Gio::Permission::release_async_vfunc(const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable) 
{
  ...
  if(base && base->release_async)
  {
    (*base->release_async)(gobj(),const_cast<GCancellable*>(Glib::unwrap(cancellable)),&giomm_SignalProxy_async_callback,slot_copy);
  }
}
