...
using Drive_signal_changed_functype = void (*)(GDrive* self);
Drive_signal_changed_functype Drive_signal_changed_funcptr;
extern "C" {
static void Drive_signal_changed_default_callback(GDrive* self)
{
  Drive_signal_changed_funcptr( self);
}
} // extern "C"
...
using Drive_signal_disconnected_functype = void (*)(GDrive* self);
Drive_signal_disconnected_functype Drive_signal_disconnected_funcptr;
extern "C" {
static void Drive_signal_disconnected_default_callback(GDrive* self)
{
  Drive_signal_disconnected_funcptr( self);
}
} // extern "C"
...
using Drive_signal_eject_button_functype = void (*)(GDrive* self);
Drive_signal_eject_button_functype Drive_signal_eject_button_funcptr;
extern "C" {
static void Drive_signal_eject_button_default_callback(GDrive* self)
{
  Drive_signal_eject_button_funcptr( self);
}
} // extern "C"
...
using Drive_signal_stop_button_functype = void (*)(GDrive* self);
Drive_signal_stop_button_functype Drive_signal_stop_button_funcptr;
extern "C" {
static void Drive_signal_stop_button_default_callback(GDrive* self)
{
  Drive_signal_stop_button_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void Drive_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->changed = &Drive_signal_changed_default_callback;
  Drive_signal_changed_funcptr = &changed_callback;
  klass->disconnected = &Drive_signal_disconnected_default_callback;
  Drive_signal_disconnected_funcptr = &disconnected_callback;
  klass->eject_button = &Drive_signal_eject_button_default_callback;
  Drive_signal_eject_button_funcptr = &eject_button_callback;
  klass->stop_button = &Drive_signal_stop_button_default_callback;
  Drive_signal_stop_button_funcptr = &stop_button_callback;
}
