...
namespace
{
using FileDescriptorBased_get_fd_vfunc_functype = int (*)(GFileDescriptorBased* self);
FileDescriptorBased_get_fd_vfunc_functype FileDescriptorBased_get_fd_vfunc_funcptr;
extern "C" {
static int FileDescriptorBased_get_fd_vfunc_c_callback(GFileDescriptorBased* self)
{
  return FileDescriptorBased_get_fd_vfunc_funcptr( self);
}
} // extern "C"
} // anonymous namespace
...
void FileDescriptorBased_Class::iface_init_function(void* g_iface, void*)
{
  ...
  klass->get_fd = &FileDescriptorBased_get_fd_vfunc_c_callback;
  FileDescriptorBased_get_fd_vfunc_funcptr = &get_fd_vfunc_callback;
