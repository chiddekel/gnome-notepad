...
extern "C" {
static gboolean InterfaceSkeleton_signal_authorize_method_connect_callback(GDBusInterfaceSkeleton* self, GDBusMethodInvocation* p0,void* data)
{
...
{
  "g_authorize_method",
  (GCallback) &InterfaceSkeleton_signal_authorize_method_connect_callback,
  (GCallback) &InterfaceSkeleton_signal_authorize_method_notify_callback
};


using InterfaceSkeleton_signal_g_authorize_method_functype = gboolean (*)(GDBusInterfaceSkeleton* self, GDBusMethodInvocation* p0);
InterfaceSkeleton_signal_g_authorize_method_functype InterfaceSkeleton_signal_g_authorize_method_funcptr;
extern "C" {
static gboolean InterfaceSkeleton_signal_g_authorize_method_default_callback(GDBusInterfaceSkeleton* self, GDBusMethodInvocation* p0)
{
  return InterfaceSkeleton_signal_g_authorize_method_funcptr( self, p0);
}
} // extern "C"
} // anonymous namespace
...
void InterfaceSkeleton_Class::class_init_function(void* g_class, void* class_data)
{
  ...
  klass->g_authorize_method = &InterfaceSkeleton_signal_g_authorize_method_default_callback;
  InterfaceSkeleton_signal_g_authorize_method_funcptr = &g_authorize_method_callback;
}
