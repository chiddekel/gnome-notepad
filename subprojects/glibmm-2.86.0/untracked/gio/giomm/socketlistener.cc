...
extern "C" {
static void SocketListener_signal_event_connect_callback(GSocketListener* self, GSocketListenerEvent p0,GSocket* p1,void* data)
{
  using namespace Gio;
  using SlotType = sigc::slot<void(Event, const Glib::RefPtr<Socket>&)>;

  auto obj = dynamic_cast<SocketListener*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
  ...
  if(obj)
  {
    try
    {
      if(const auto slot = Glib::SignalProxyNormal::data_to_slot(data))
        (*static_cast<SlotType*>(slot))(static_cast<Event>(p0)
, Glib::wrap(p1, true)
);
    }
    catch(...)
...
static const Glib::SignalProxyInfo SocketListener_signal_event_info =
{
  "event",
  (GCallback) &SocketListener_signal_event_connect_callback,
  (GCallback) &SocketListener_signal_event_connect_callback
};
...
// static
GType Glib::Value<Gio::SocketListener::Event>::value_type()
{
...
Glib::SignalProxy<void(Event, const Glib::RefPtr<Socket>&)> SocketListener::signal_event()
{
  return Glib::SignalProxy<void(Event, const Glib::RefPtr<Socket>&) >(this, &SocketListener_signal_event_info);
}
