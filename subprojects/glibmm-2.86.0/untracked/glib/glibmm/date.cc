...
unsigned int Date::get_week_of_year(Date::Weekday first_day_of_week) const
{
  return g_date_get_week_of_year(&gobject_, (GDateWeekday)first_day_of_week);
}
...
// static
guint8 Date::get_weeks_in_year(Date::Year year, Date::Weekday first_day_of_week)
{
  return g_date_get_weeks_in_year(year, (GDateWeekday)first_day_of_week);
}
