...
DateTime DateTime::create_from_local_usec(gint64 usecs)
{
  return Glib::wrap(g_date_time_new_from_unix_local_usec(usecs));
}

DateTime DateTime::create_from_utc_usec(gint64 usecs)
{
  return Glib::wrap(g_date_time_new_from_unix_utc_usec(usecs));
}
...
gint64 DateTime::to_unix_usec() const
{
  return g_date_time_to_unix_usec(const_cast<GDateTime*>(gobj()));
}
